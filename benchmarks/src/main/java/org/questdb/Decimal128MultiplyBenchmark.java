...
public class Decimal128MultiplyBenchmark {
    ...
    @Benchmark
    public void decimal128Multiply128By64() {
        // Test multiplication of 128-bit by 64-bit value
        Decimal128 largeFactor = new Decimal128();
        largeFactor.set(123456789L, 987654321098765432L, 6);

        decimal128Result.copyFrom(largeFactor);
        decimal128Result.multiply(decimal128Factor2);
        decimal128Result.round(6, RoundingMode.HALF_UP);
    }

    @Benchmark
    public void decimal128Multiply64Bit() {
        // Test multiplication of two 64-bit values
        Decimal128 val1 = Decimal128.fromDouble(123456.789, 3);
        Decimal128 val2 = Decimal128.fromDouble(987.654, 3);

        decimal128Result.copyFrom(val1);
        decimal128Result.multiply(val2);
        decimal128Result.round(6, RoundingMode.HALF_UP);
    }
