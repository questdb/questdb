...
public class HashJoinRecordStoreStrategyContext implements HashJoinStoreStrategyContext {
    private final RecordSource<? extends Record> slaveSource;

    public HashJoinRecordStoreStrategyContext(RecordSource<? extends Record> slaveSource) {
    ...
    public RecordMetadata getHashRecordMetadata() {
        return slaveSource.getMetadata();
    }
