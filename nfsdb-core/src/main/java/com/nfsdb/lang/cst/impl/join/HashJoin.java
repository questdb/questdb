...
public class HashJoin extends AbstractImmutableIterator<SplitRecord> implements RecordSource<SplitRecord> {
    ...
    public HashJoin(RecordSource<? extends Record> masterSource, ObjList<String> masterColumns, RandomAccessRecordSource<? extends Record> slaveSource, ObjList<String> slaveColumns) {
