...
| `QwpWebSocketEncoder` | 790 | Encodes table buffers into ILP v4 binary format with gorilla, schema caching, delta symbols. |
...
handleBinaryMessage()
    ...
    |-- QwpStreamingDecoder: decodes ILP v4 binary format
...
| `QwpStreamingDecoder` | 162 | Streaming decoder for ILP v4 messages |
