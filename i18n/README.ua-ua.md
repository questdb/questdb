...
- **Блискавично швидкий прийом**: Від одиничних подій до мільйонів/сек
- **SQL з низькою затримкою**: Розширення часових рядів (ASOF JOIN, SAMPLE BY, LATEST ON)
- **SIMD-прискорене виконання**: Паралельна обробка, швидко працює на скромному обладнанні
- **Багаторівневе зберігання**: WAL → нативне колонкове → Parquet (розділене та упорядковане за часом)

### 🔧 Легкість використання

- **Стандартний SQL**: ANSI SQL з розширеннями часових рядів
- **Протокол Postgres (PGwire)** та **REST API** для широкої сумісності
- **Веб-консоль** для запитів та управління даними
- **Кілька форматів прийому**: InfluxDB Line Protocol, CSV, JSON
- **Схема на льоту**: Додавання нових стовпців під час потокових даних

### 📊 Потужні можливості

- **Матеріалізовані представлення** та **n-вимірні масиви**
- **Фінансові функції** та **аналітика книги замовлень**
- **Геопросторові запити** з підтримкою PostGIS
- **Повнотекстовий пошук** з [Tantivy](https://questdb.com/docs/reference/function/text-search/)
...
- **Дані сенсорів/телеметрії** з високою кардинальністю
- **Панелі реального часу** та моніторинг
- **Аналітика** та машинне навчання на часових рядах
- **Логування** та метрики додатків
