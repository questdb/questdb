...
[English](https://github.com/questdb/questdb) | [简体中文](README.zh-cn.md) | [繁體中文](README.zh-hk.md) | [العربية](README.ar-dz.md) | [Italiano](README.it-it.md) | [Українська](README.ua-ua.md) | [Español](README.es-es.md) | Português | [日本](./README.ja-ja.md) | French |(./README.fr-fr.md)


# QuestDB
QuestDB est une base de données SQL open source hautes performances pour les applications dans
services financiers, IoT, machine learning, DevOps et observabilité. comprend
points de terminaison pour le protocole filaire PostgreSQL, indépendant du schéma à haut débit
ingestion à l'aide du protocole de ligne InfluxDB et d'une API REST pour les requêtes,
importer et exporter.


QuestDB implémente ANSI SQL avec des extensions natives pour le langage orienté temps
ressources. Ces extensions simplifient la corrélation des données de plusieurs
sources à l'aide de jointures relationnelles et chronologiques. QuestDB atteint des sommets
performances d'un modèle de stockage vectoriel massivement parallélisé orienté colonne
exécution, instructions SIMD et diverses techniques à faible latence. Tous les
codebase a été construit à partir de rien en Java et C++, sans dépendances, et
c'est 100% sans ramassage des ordures.
