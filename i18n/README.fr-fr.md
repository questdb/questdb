...
[English](https://github.com/questdb/questdb) | [简体中文](./i18n/README.zh-cn.md) | [繁體中文](./i18n/README.zh-hk.md) | [العربية](./i18n/README.ar-dz.md) | [Italiano](./i18n/README.it-it.md) | [Українська](./i18n/README.ua-ua.md) | [Español](./i18n/README.es-es.md) | [Português](./i18n/README-PT.md) | [日本](./i18n/README.ja-ja.md) | Français | [Deutsch](./i18n/README.de-de.md)

# QuestDB

QuestDB est une base de données de séries chronologiques open source pour l'ingestion à haut débit et
requêtes SQL rapides avec une simplicité opérationnelle. Il prend en charge les schémas indépendants
ingestion à l'aide du protocole de ligne InfluxDB, du protocole filaire PostgreSQL et d'un REST
API pour les importations et les exportations en masse.

QuestDB est bien adapté aux données du marché financier, aux métriques d'application, aux capteurs
données, analyses en temps réel, tableaux de bord et surveillance de l'infrastructure.

QuestDB implémente ANSI SQL avec une sémantique SQL native de séries temporelles. Ces SQL
la sémantique simplifie la corrélation des données provenant de plusieurs sources à l'aide
jointures relationnelles et temporelles. Nous atteignons des performances élevées en adoptant un
modèle de stockage orienté colonne, exécution vectorielle parallélisée, instructions SIMD,
et les techniques à faible latence. L'ensemble de la base de code est construit à partir de zéro dans
Java et C++, sans dépendances et sans récupération de place.

<div align="center">
  <a href="https://demo.questdb.io">
    <img alt="QuestDB Web Console affichant plusieurs instructions SQL et visualisant une requête sous forme de graphique" src="https://raw.githubusercontent.com/questdb/questdb/master/.github/console.png" width="600" />
  </a>
</div>

## Essayez QuestDB

Nous fournissons une [démo en direct](https://demo.questdb.io/) provisionnée avec les dernières
Version de QuestDB et exemples d'ensembles de données :

- 10 ans de trajets en taxi à New York avec 1,6 milliard de files d'attente
- données de trading en direct d'un échange de crypto-monnaie
- géolocalisation de 250 000 navires uniques au fil du temps

## Commencer

### Installer QuestDB

Pour exécuter QuestDB, Docker peut être utilisé pour démarrer rapidement :
...
La [QuestDB downloads page](https://questdb.io/get-questdb/) fournit des
téléchargements pour les binaires et contient des détails pour d'autres installations et déploiements
méthodes.

### Connectez-vous à QuestDB

Vous pouvez interagir avec QuestDB à l'aide des interfaces suivantes :

- [Web Console](https://questdb.io/docs/develop/web-console/) pour interactif
  Éditeur SQL sur le port `9000`
- [InfluxDB line protocol](https://questdb.io/docs/reference/api/influxdb/) pour
  ingestion à haut débit sur le port `9009`
- [REST API](https://questdb.io/docs/reference/api/rest/) sure le port `9000`
- [PostgreSQL wire protocol](https://questdb.io/docs/reference/api/postgres/) sur le
  port `8812`

### Insérer des données

Vous trouverez ci-dessous nos clients officiels de protocole de ligne InfluxDB pour la programmation populaire
langues :
...
## Comment QuestDB se compare aux autres TSDB open source

[Cet article](https://questdb.io/blog/2021/07/05/comparing-questdb-timescaledb-influxdb/)
compare QuestDB à d'autres bases de données de séries chronologiques open source couvrant
fonctionnalité, maturité et performance.

Voici la haute cardinalité
[Time Series Benchmark Suite](https://questdb.io/blog/2021/06/16/high-cardinality-time-series-data-performance/)
résultats en utilisant le cas d'utilisation "cpu uniquement" avec 6 travailleurs sur un AMD Ryzen 3970X :

<div align="center">
  <a href="https://questdb.io/blog/2021/06/16/high-cardinality-time-series-data-performance/">
    <img alt="Un graphique comparant le débit maximal de QuestDB, ClickHouse, TimescaleDB et InfluxDB." src=".github/tsbs-results.png"/>
  </a>
</div>

Le tableau suivant montre le temps d'exécution des requêtes d'un milliard de lignes exécutées sur un
Instance `c5.metal` utilisant 16 des 96 threads disponibles :
...
- [Documentation QuestDB :](https://questdb.io/docs/introduction/) comprendre comment
  pour exécuter et configurer QuestDB.
- [Tutoriels :](https://questdb.io/tutorial/) découvrez ce qui est possible avec QuestDB
  pas à pas.
- [Feuille de route produit :](https://github.com/questdb/questdb/projects) consultez notre
  planifier les prochaines versions.

### ❓ Obtenir de l'aide

- [Community Slack :](https://slack.questdb.io) rejoignez les discussions techniques, demandez
  questions, et rencontrez d'autres utilisateurs !
- [Problèmes GitHub :](https://github.com/questdb/questdb/issues) signaler des bugs ou
  problèmes avec QuestDB.
- [Stack Overflow :](https://stackoverflow.com/questions/tagged/questdb) recherchez
  solutions de dépannage courantes.

### 🚢 Deploy QuestDB

- [AMI AWS](https://questdb.io/docs/guides/aws-official-ami)
- [Plateforme Google Cloud](https://questdb.io/docs/guides/google-cloud-platform)
- [Image Docker officielle](https://questdb.io/docs/get-started/docker)
- [gouttelettes DigitalOcean](https://questdb.io/docs/guides/digitalocean)
- [Graphiques Helm Kubernetes](https://questdb.io/docs/guides/kubernetes)

## Contribuer

Nous sommes toujours heureux d'avoir des contributions au projet, qu'il soit source
code, documentation, rapports de bogues, demandes de fonctionnalités ou commentaires. Pour commencer
avec contribution :

- Jetez un œil aux problèmes GitHub étiquetés
...
- Pour plus de détails sur la création de QuestDB, consultez le
...
de QuestDB et soumettez une demande d'extraction avec vos modifications proposées.

✨ En signe de gratitude, nous envoyons également du **swag QuestDB** à nos
contributeurs. [Réclamez votre butin ici.](https://questdb.io/community)

Un grand merci aux merveilleuses personnes suivantes qui ont contribué à
...
Ce projet respecte la
[tous les contributeurs](https://github.com/all-contributors/all-contributors)
spécification. Les contributions de toute nature sont les bienvenues !
