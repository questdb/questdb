...
<p align="center">
  [English](https://github.com/questdb/questdb) | [简体中文](README.zh-cn.md) | [繁體中文](README.zh-hk.md) | [العربية](README.ar-dz.md) | [Italiano](README.it-it.md) | [Українська](README.ua-ua.md) | [Español](README.es-es.md) | [Português](README.pt.md) | [日本語](README.ja-ja.md) | [Türkçe](README.tr-tr.md) | हिंदी | [Tiếng Việt](README.vi-vn.md)
</p>

# QuestDB

QuestDB एक ओपन-सोर्स टाइम-सीरीज़ डेटाबेस है जो तेज़ SQL क्वेरी, उच्च थ्रूपुट डेटा इनजेशन और परिचालन की सरलता प्रदान करता है।  
पूरी हाई‑परफॉर्मेंस कोडबेस को Java, C++ और Rust में बिना किसी बाहरी निर्भरता और बिना किसी कचरा संग्रह (GC) के बनाया गया है।

हम उच्च प्रदर्शन निम्नलिखित तकनीकों से प्राप्त करते हैं:
- कॉलम-ओरिएंटेड स्टोरेज मॉडल
- समानांतर वेक्टर निष्पादन
- SIMD निर्देश
- कम विलंबता (लो-लेटनसी) तकनीकें

QuestDB, ANSI SQL को मूल टाइम-सीरीज़ SQL एक्सटेंशन के साथ लागू करता है।  
ये एक्सटेंशन विभिन्न स्रोतों से डेटा को रिलेशनल और टाइम-सीरीज़ जॉइन के माध्यम से सहसंबद्ध करना सरल बनाते हैं।

> क्या आप तैयार हैं? [शुरू करें](#शुरू-हो-जाओ)।
...
<div align="center">
  ...
  <p><em>QuestDB वेब कंसोल – डेमो चलाने के लिए क्लिक करें</em></p>
</div>
...
QuestDB निम्नलिखित उपयोग मामलों के लिए उत्कृष्ट है:
- वित्तीय बाजार डेटा
- उच्च कार्डिनैलिटी वाले IoT सेंसर डेटा
- रियल-टाइम डैशबोर्ड्स

मुख्य विशेषताएँ:
- शक्तिशाली, SIMD-ऑप्टिमाइज़्ड टाइम-सीरीज़ एक्सटेंशन के साथ SQL
- InfluxDB लाइन प्रोटोकॉल के माध्यम से उच्च गति पर डेटा इनजेशन
- सीमित हार्डवेयर पर भी उत्कृष्ट प्रदर्शन
- कॉलम-ओरिएंटेड स्टोरेज (नैटिव या [Apache Parquet](https://questdb.io/glossary/apache-parquet/)), जो समय के अनुसार पार्टीशन और ऑर्डर की जाती है
- त्रुटि हैंडलिंग के साथ एक प्रतिक्रियाशील और सहज वेब कंसोल
- [उच्च कार्डिनैलिटी](https://questdb.io/glossary/high-cardinality/) के साथ बेहतरीन प्रदर्शन – [बेंचमार्क देखें](#questdb-performance-vs-other-oss-databases)

टाइम-सीरीज़ डेटाबेस के उपयोग का लाभ:
- डेटा का अनऑर्डर्ड होना (out-of-order) की चिंता नहीं
- डुप्लीकेट्स से मुक्ति
- “एक्सैक्टली वन” सेमांटिक्स की चिंता नहीं
- स्ट्रीमिंग डेटा (कम लेटनसी)
- बड़े पैमाने पर समवर्ती अनुरोध
- वोलैटाइल और “बर्स्टी” डेटा
- डेटा स्ट्रीम करते समय स्कीमा में परिवर्तन की आसानी

## QuestDB आज़माएं – डेमो और डैशबोर्ड

हम एक [लाइव डेमो](https://demo.questdb.io/) प्रदान करते हैं जो नवीनतम QuestDB रिलीज़ और उदाहरण डेटासेट के साथ है:
- **Trips:** 10 वर्षों की NYC टैक्सी यात्राओं के साथ 1.6 बिलियन पंक्तियाँ
- **Trades:** लाइव क्रिप्टो मार्केट डेटा, जिसमें प्रति माह 30M+ पंक्तियाँ होती हैं
- **Pos:** समय के साथ 250k अद्वितीय जहाजों के भौगोलिक स्थान

आप उदाहरण क्वेरी का उपयोग कर सकते हैं या अपनी स्वयं की क्वेरी लिख सकते हैं!

_सार्वजनिक डेमो 1.6 बिलियन पंक्तियों पर क्वेरी करता है और `r6a.12xlarge` इंस्टेंस (48 vCPU और 348GB RAM) का उपयोग करता है।_
...
इसके अलावा, हमारे पास [Grafana](https://questdb.io/docs/third-party-tools/grafana/) का उपयोग करते हुए रियल-टाइम डैशबोर्ड भी हैं:
- [क्रिप्टो ट्रेड्स (रीयल-टाइम):](https://questdb.io/dashboards/crypto/) – OKX पर 20+ परिसंपत्तियों के ट्रेड्स दिखाता है।
- [NYC टैक्सी डेटा:](https://questdb.io/dashboards/taxi/) – 2016 में NYC टैक्सी यात्राओं की रियल-टाइम पुनरावृत्ति।

## QuestDB performance vs. other OSS databases

QuestDB प्रदर्शन बेंचमार्क्स में प्रतिस्पर्धियों से काफी आगे है।

अंतर्निहित विवरण और प्रदर्शन पर गहराई से जानने के लिए, निम्नलिखित ब्लॉग पोस्ट देखें:
...
जैसा कि हमेशा, हम आपको अपने स्वयं के बेंचमार्क चलाने के लिए प्रोत्साहित करते हैं।

<div align="center">
  <img alt="QuestDB, InfluxDB और TimescaleDB की ingestion rate की तुलना करने वाला चार्ट" src=".github/readme-benchmark.png" width="600"/>
</div>
...
QuestDB को चलाने के लिए, जल्दी शुरू करने के लिए [डॉकर](https://www.docker.com/) का उपयोग करें:
...
questdb start   # QuestDB शुरू करने के लिए
questdb stop    # QuestDB रोकने के लिए
```

इसके अलावा, पूर्ण ऑनबोर्डिंग यात्रा शुरू करने के लिए, हमारे संक्षिप्त [Quick Start Guide](https://questdb.io/docs/quick-start/) से शुरुआत करें।

### QuestDB से कनेक्ट करें

आप निम्नलिखित इंटरफेस का उपयोग करके QuestDB के साथ बातचीत कर सकते हैं:

- पोर्ट `9000` पर इंटरैक्टिव SQL संपादक के लिए [वेब कंसोल](https://questdb.io/docs/develop/web-console/)
- पोर्ट `9009` पर उच्च-थ्रूपुट डेटा इनजेशन के लिए [InfluxDB लाइन प्रोटोकॉल](https://questdb.io/docs/reference/api/influxdb/)
...
लोकप्रिय प्रोग्रामिंग भाषाओं के लिए हमारे आधिकारिक QuestDB क्लाइंट:
...
[यह आलेख](https://questdb.io/blog/2021/07/05/comparing-questdb-timescaledb-influxdb/) QuestDB की कार्यक्षमता, परिपक्वता और प्रदर्शन की तुलना अन्य ओपन सोर्स टाइम-सीरीज़ डेटाबेस से करता है।

32 CPUs और 64GB RAM वाले सिस्टम पर, 48 vCPU और 348GB RAM वाले `r6a.12xlarge` इंस्टेंस के साथ उच्च कार्डिनैलिटी के मामले के बेंचमार्क परिणाम निम्नलिखित हैं।
...
- [QuestDB दस्तावेज़ीकरण:](https://questdb.io/docs/introduction/) QuestDB को चलाने और कॉन्फ़िगर करने का तरीका जानें।
- [ट्यूटोरियल:](https://questdb.io/tutorial/) चरण दर चरण सीखें कि QuestDB के साथ क्या संभव है।
- [उत्पाद रोडमैप:](https://github.com/questdb/questdb/projects) आगामी रिलीज़ के लिए हमारी योजना देखें।

### ❓ सहायता प्राप्त करें

- [Community Slack:](https://slack.questdb.io) तकनीकी चर्चाओं में शामिल हों, प्रश्न पूछें और अन्य उपयोगकर्ताओं से मिलें!
- [GitHub Issues:](https://github.com/questdb/questdb/issues) QuestDB से संबंधित बग या समस्याओं की रिपोर्ट करें।
- [Stack Overflow:](https://stackoverflow.com/questions/tagged/questdb) सामान्य समस्या समाधान खोजें।
...
हम प्रोजेक्ट में योगदान का स्वागत करते हैं – चाहे वह स्रोत कोड हो, दस्तावेज़ीकरण, बग रिपोर्ट, फीचर अनुरोध या फीडबैक। योगदान शुरू करने के लिए:

- GitHub पर "[Good first issue](https://github.com/questdb/questdb/issues?q=is%3Aissue+is%3Aopen+label%3A%22Good+first+issue%22)" लेबल वाले मुद्दों पर एक नजर डालें।
- Hacktoberfest के लिए, [लेबल किए गए मुद्दों](https://github.com/questdb/questdb/issues?q=is%3Aissue+is%3Aopen+label%3Ahacktoberfest) को देखें।
- [योगदान मार्गदर्शिका](https://github.com/questdb/questdb/blob/master/CONTRIBUTING.md) पढ़ें।
- QuestDB के निर्माण, पैकेजिंग और इंस्टॉलेशन के विवरण के लिए, [निर्माण निर्देश](https://github.com/questdb/questdb/blob/master/core/README.md) देखें।
- QuestDB का [fork बनाएँ](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) और अपने प्रस्तावित परिवर्तनों के साथ एक pull request सबमिट करें।
- यदि आपको कोई समस्या आती है, तो सहायता के लिए हमारे [पब्लिक Slack](https://slack.questdb.io/) में शामिल हों।

✨ हमारी कृतज्ञता के प्रतीक के रूप में, हम अपने योगदानकर्ताओं को **QuestDB swag** भेजते हैं।  
[यहां अपना swag क्लेम करें](https://questdb.io/community/)

हम QuestDB में योगदान देने वाले निम्नलिखित अद्भुत व्यक्तियों का हार्दिक धन्यवाद करते हैं:  
([इमोजी कुंजी](https://allcontributors.org/docs/en/emoji-key))
...
यह प्रोजेक्ट [all‑contributors](https://github.com/all-contributors/all-contributors) स्पेसिफिकेशन का पालन करता है।  
