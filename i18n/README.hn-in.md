...
QuestDB उच्च थ्रूपुट अंतर्ग्रहण और परिचालन सरलता के साथ तेज़ SQL क्वेरी के लिए एक ओपन-सोर्स टाइम-सीरीज़ डेटाबेस है।

QuestDB वित्तीय बाज़ार डेटा, IoT सेंसर डेटा, विज्ञापन-तकनीक और वास्तविक समय डैशबोर्ड के लिए उपयुक्त है। यह [उच्च कार्डिनैलिटी](https://questdb.io/glossary/high-cardinality/) वाले डेटासेट के लिए चमकता है और इन्फ्लक्सडीबी लाइन प्रोटोकॉल के समर्थन के माध्यम से इन्फ्लक्सडीबी के लिए एक ड्रॉप-इन प्रतिस्थापन है।

QuestDB मूल समय-श्रृंखला SQL एक्सटेंशन के साथ ANSI SQL लागू करता है। ये SQL एक्सटेंशन डेटा को फ़िल्टर करना और डाउनसैंपल करना, या रिलेशनल और टाइम-सीरीज़ जॉइन का उपयोग करके कई स्रोतों से डेटा को सहसंबंधित करना आसान बनाते हैं।

हम कॉलम-ओरिएंटेड स्टोरेज मॉडल, समानांतर वेक्टर निष्पादन, SIMD निर्देश और कम-विलंबता तकनीकों को अपनाकर उच्च प्रदर्शन प्राप्त करते हैं। संपूर्ण कोडबेस जावा, सी++ और [रस्ट](https://questdb.io/blog/leveraging-rust-in-our-high-performance-java-database/) में बिना किसी निर्भरता और शून्य कचरा संग्रहण के बनाया गया है।

QuestDB थोक आयात और निर्यात के लिए InfluxDB लाइन प्रोटोकॉल और REST API का उपयोग करके स्कीमा-अज्ञेयवादी स्ट्रीमिंग अंतर्ग्रहण का समर्थन करता है। क्वेस्टडीबी एसक्यूएल वेब कंसोल एक इंटरैक्टिव एसक्यूएल संपादक है जो सीएसवी आयात की सुविधा प्रदान करता है। अंत में, क्वेस्टडीबी में प्रोग्रामेटिक प्रश्नों के लिए पोस्टग्रेज वायर प्रोटोकॉल भी शामिल है।

QuestDB के साथ एकीकृत होने वाले लोकप्रिय टूल में [Apache Kafka](https://questdb.io/docs/third-party-tools/kafka/questdb-kafka/), [Grafana](https://questdb.io/docs/third-party-tools/grafana/), [Superset](https://questdb.io/docs/third-party-tools/superset/), [Telegraf](https://questdb.io/docs/third-party-tools/telegraf/) और [Apache Flink](https://questdb.io/docs/third-party-tools/flink/) शामिल हैं।

<div align="center">
  <a href="https://demo.questdb.io">
    <img alt="QuestDB Web Console showing a SQL statement and query result" src="../.github/console.png" width="600" />
  </a>
</div>
...
### QuestDB क्लाउड
QuestDB क्लाउड क्वेस्टडीबी का पूरी तरह से प्रबंधित संस्करण है, जिसमें भूमिका-आधारित पहुंच नियंत्रण, क्लाउड-नेटिव प्रतिकृति, संपीड़न, निगरानी और क्लाउड-नेटिव स्नैपशॉट जैसी अतिरिक्त सुविधाएं हैं। $200 क्रेडिट के साथ आरंभ करें।
...
[हमारे बेंचमार्क ब्लॉग पोस्ट](https://questdb.io/blog/2024/02/26/questdb-versus-influxdb/) को देखें जो कार्यक्षमता, परिपक्वता और प्रदर्शन के आधार पर QuestDB और InfluxDB की तुलना करता है।
<div align="center">
...
यह बेंचमार्क मेजबानों की विभिन्न संख्या के लिए अंतर्ग्रहण दर (पंक्तियाँ/सेकंड) को मापता है: कुल 100, 1K, 100K और 10M। होस्ट की संख्या जितनी अधिक होगी, डेटासेट की कार्डिनैलिटी उतनी ही अधिक होगी। होस्ट की संख्या बढ़ने पर भी QuestDB अपनी अंतर्ग्रहण गति को 2.4M पंक्तियों/सेकेंड से ऊपर बनाए रखता है। इसके विपरीत, जैसे-जैसे डेटासेट कार्डिनैलिटी बढ़ती है, इन्फ्लक्सडीबी और टाइमस्केलडीबी का प्रदर्शन प्रभावित होता है, जिससे अंतर्ग्रहण दर में काफी गिरावट आती है।
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/heysagnik"><img src="https://avatars.githubusercontent.com/u/70798495?v=4" width="100px;" alt=""/><br /><sub><b>heysagnik</b></sub></a><br /><a href="https://github.com/questdb/questdb/commits?author=heysagnik" title="Documentation">📖</a></td>
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/1998code"><img src="https://avatars.githubusercontent.com/u/54872601?v=4" width="100px;" alt=""/><br /><sub><b>1998code</b></sub></a><br /><a href="https://github.com/questdb/questdb/commits?author=1998code" title="Documentation">📖</a></td>
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/TheZalRevolt"><img src="https://avatars.githubusercontent.com/u/129967922?v=4" width="100px;" alt=""/><br /><sub><b>TheZalRevolt</b></sub></a><br /><a href="https://github.com/questdb/questdb/commits?author=TheZalRevolt" title="Documentation">📖</a></td>
    </tr>
  </tbody>
</table>
