...
[English](../README.md) | [简体中文](./i18n/README.zh-cn.md) | [繁體中文](./i18n/README.zh-hk.md) | [العربية](./i18n/README.ar-dz.md) | [Italiano](./i18n/README.it-it.md) | [Українська](./i18n/README.ua-ua.md) | [Español](./i18n/README.es-es.md) | [Português](./i18n/README.pt.md) | [日本語](./i18n/README.ja-ja.md) | [Türkçe](./i18n/README.tr-tr.md) | हिंदी

# QuestDB

QuestDB उच्च थ्रूपुट अंतर्ग्रहण और परिचालन सरलता के साथ तेज़ SQL क्वेरी के लिए एक ओपन-सोर्स [टाइम-सीरीज़ डेटाबेस](https://questdb.io/glossary/time-series-database/) है. यह 
...
SIMD निर्देश और कम-विलंबता तकनीकों को अपनाकर उच्च प्रदर्शन प्राप्त करते हैं। संपूर्ण कोडबेस जावा और C++ में शुरू से बनाया गया है, 
...
[QuestDB डाउनलोड पृष्ठ](https://questdb.io/get-questdb/) बायनेरिज़ के लिए सीधे डाउनलोड प्रदान करता है और इसमें अन्य इंस्टॉलेशन 
...
- पोर्ट `9009` पर उच्च-थ्रूपुट अंतर्ग्रहण के लिए [InfluxDB लाइन प्रोटोकॉल](https://questdb.io/docs/reference/api/influxdb/)
...
[यह](https://questdb.io/blog/2021/07/05/comparing-questdb-timescaledb-influxdb/) आलेख कार्यक्षमता, परिपक्वता और प्रदर्शन के
...
करते हुए उच्च-कार्डिनैलिटी [टाइम सीरीज़ बेंचमार्क सूट](https://questdb.io/blog/2021/06/16/high-cardinality-time-series-data-performance/) परिणाम यहां दिए गए हैं:
...
- QuestDB का [एक फ़ोर्क बनाएँ](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) और अपने प्रस्तावित परिवर्तनों के साथ एक पुल अनुरोध सबमिट करें।


✨ अपनी कृतज्ञता के संकेत के रूप में, हम अपने योगदानकर्ताओं को **QuestDB स्वैग** भी भेजते हैं। [यहां अपने स्वैग का दावा करें](https://questdb.io/community)
