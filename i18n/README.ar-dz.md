...
QuestDB هي قاعدة بيانات سلاسل زمنية مفتوحة المصدر توفر **استيعاب البيانات السريع** و**استعلامات SQL ديناميكية منخفضة
الكمون**.

يوفر QuestDB محرك تخزين متعدد الطبقات (WAL → أصلي → Parquet على تخزين الكائنات)، وتم بناء قاعدة البيانات بالكامل من
الصفر باستخدام Java بدون جمع القمامة، C++ و Rust (QuestDB Enterprise).
...
- [البرامج التعليمية:](https://questdb.io/tutorial/) تعلم ما هو ممكن مع QuestDB، خطوة بخطوة
...
- [أنشئ fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) من QuestDB وقدم طلب سحب مع
  التغييرات المقترحة
- عالق؟ انضم إلى [Slack العام](https://slack.questdb.io/) للمساعدة
