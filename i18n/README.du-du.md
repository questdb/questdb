...
[English](https://github.com/questdb/questdb) | [简体中文](./i18n/README.zh-cn.md) | [繁體中文](./i18n/README.zh-hk.md) | [العربية](./i18n/README.ar-dz.md) | [Italiano](./i18n/README.it-it.md) | [Українська](./i18n/README.ua-ua.md) | [Español](./i18n/README.es-es.md) | [Português](./i18n/README-PT.md) | [日本](./i18n/README.ja-ja.md) | [Français](./i18n/README.fr-fr.md) | Deutsch
...
<div align="center">
  <a href="https://demo.questdb.io">
    <img alt="Die QuestDB-Webkonsole zeigt mehrere SQL-Anweisungen und visualisiert eine Abfrage als Diagramm" src="https://raw.githubusercontent.com/questdb/questdb/master/.github/console.png" width="600" />
  </a>
</div>

## Probieren Sie QuestDB aus

Wir stellen eine [Live-Demo](https://demo.questdb.io/) bereit, die mit den neuesten bereitgestellt wird
...
- Geolokalisierung von 250.000 einzigartigen Schiffen im Laufe der Zeit

## Loslegen

### QuestDB installieren

Um QuestDB auszuführen, kann Docker verwendet werden, um schnell loszulegen:

```bash
docker run -p 9000:9000 -p 9009:9009 -p 8812:8812 questdb/questdb
```

macOS-Benutzer können Homebrew verwenden:
...
Sie können mit QuestDB über die folgenden Schnittstellen interagieren:
...
<div align="center">
  <a href="https://questdb.io/blog/2021/06/16/high-cardinality-time-series-data-performance/">
    <img alt="Ein Diagramm, das den maximalen Durchsatz von QuestDB, ClickHouse, TimescaleDB und InfluxDB vergleicht." src=".github/tsbs-results.png"/>
  </a>
</div>
...
- [QuestDB-Dokumentation:](https://questdb.io/docs/introduction/) verstehen, wie
...
- [Community Slack:](https://slack.questdb.io) Nehmen Sie an technischen Diskussionen teil, fragen Sie
...
- [Google Cloud-Plattform](https://questdb.io/docs/guides/google-cloud-platform)
- [Offizielles Docker-Image] (https://questdb.io/docs/get-started/docker)
- [DigitalOcean-Tröpfchen](https://questdb.io/docs/guides/digitalocean)
- [Kubernetes Helm-Diagramme](https://questdb.io/docs/guides/kubernetes)

## Beitragen

Wir freuen uns immer über Beiträge zum Projekt, unabhängig davon, ob es sich um Quellen handelt
Code, Dokumentation, Fehlerberichte, Funktionsanfragen oder Feedback. Zum Einstieg
mit Beitrag:

- Sehen Sie sich die gekennzeichneten GitHub-Probleme an
...
- Einzelheiten zum Erstellen von QuestDB finden Sie in der
...
von QuestDB und senden Sie eine Pull-Anforderung mit Ihren Änderungsvorschlägen.

✨ Als Zeichen unserer Dankbarkeit senden wir auch **QuestDB Swag** an unsere
Mitwirkende. [Holen Sie hier Ihren Swag ab.](https://questdb.io/community)

Ein großer Dank geht an die folgenden wunderbaren Menschen, die dazu beigetragen haben
QuestDB: ([Emoji-Schlüssel](https://allcontributors.org/docs/en/emoji-key)):
...
Dieses Projekt hält sich an die
[alle Mitwirkenden](https://github.com/all-contributors/all-contributors)
Spezifikation. Beiträge jeglicher Art sind willkommen!
