...
#include <jni.h>
/* Header for class com_questdb_net_http_Win32SelectDispatcher */

#ifndef _Included_com_questdb_net_http_Win32SelectDispatcher
#define _Included_com_questdb_net_http_Win32SelectDispatcher
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_questdb_net_http_Win32SelectDispatcher
 * Method:    select
 * Signature: (JJJ)I
 */
