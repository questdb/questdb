...
#include <jni.h>
/* Header for class com_questdb_misc_Zip */

#ifndef _Included_com_questdb_misc_Zip
#define _Included_com_questdb_misc_Zip
#ifdef __cplusplus
extern "C" {
#endif
#undef com_questdb_misc_Zip_gzipHeaderLen
#define com_questdb_misc_Zip_gzipHeaderLen 10L
#undef com_questdb_misc_Zip_GZIP_MAGIC
#define com_questdb_misc_Zip_GZIP_MAGIC 35615L
/*
 * Class:     com_questdb_misc_Zip
 * Method:    crc32
 * Signature: (IJI)I
 */
