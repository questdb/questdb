...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_FILTER_MAX_CUCKOO_KICKS("cairo.filter.max.cuckoo.kicks"),
    CAIRO_FILTER_CAPACITY("cairo.filter.capacity"),
    CAIRO_FILTER_TAG_SIZE("cairo.filter.tag.size"),
    CAIRO_FILTER_BUCKET_SIZE("cairo.filter.bucket.size"),
