...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_SQL_PARALLEL_WORK_STEALING_TASK_THRESHOLD("cairo.sql.parallel.work.stealing.task.threshold"),
    CAIRO_SQL_PARALLEL_WORK_STEALING_NAP_THRESHOLD("cairo.sql.parallel.work.stealing.nap.threshold"),
