...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    HTTP_MIN_WORKER_FIBER_ENABLED("http.min.worker.fiber.enabled"),
    ...
    LINE_TCP_WRITER_WORKER_FIBER_ENABLED("line.tcp.writer.worker.fiber.enabled"),
    ...
    LINE_TCP_IO_WORKER_FIBER_ENABLED("line.tcp.io.worker.fiber.enabled"),
    ...
    WORKER_FIBER_MAX_LIVE("worker.fiber.max.live"),
    WORKER_FIBER_MAX_RETAINED("worker.fiber.max.retained"),
    WORKER_FIBER_MOUNT_BUDGET("worker.fiber.mount.budget"),
