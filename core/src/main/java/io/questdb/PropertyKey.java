...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    TELEMETRY_EVENT_DEDUPLICATION_INTERVAL("telemetry.event.deduplication.interval"),
    TELEMETRY_DB_SIZE_ESTIMATE_TIMEOUT("telemetry.db.size.estimate.timeout"),
    TELEMETRY_WAL_ENABLED("telemetry.wal.enabled"),
    TELEMETRY_WAL_QUEUE_CAPACITY("telemetry.wal.queue.capacity"),
    TELEMETRY_WAL_HIDE_TABLES("telemetry.wal.hide.tables"),
    TELEMETRY_WAL_TABLE_TTL_WEEKS("telemetry.wal.table.ttl.weeks"),
    TELEMETRY_WAL_EVENT_DEDUPLICATION_INTERVAL("telemetry.wal.event.deduplication.interval"),
    TELEMETRY_MAT_VIEW_ENABLED("telemetry.mat.view.enabled"),
    TELEMETRY_MAT_VIEW_QUEUE_CAPACITY("telemetry.mat.view.queue.capacity"),
    TELEMETRY_MAT_VIEW_HIDE_TABLES("telemetry.mat.view.hide.tables"),
    TELEMETRY_MAT_VIEW_TABLE_TTL_WEEKS("telemetry.mat.view.table.ttl.weeks"),
    TELEMETRY_MAT_VIEW_EVENT_DEDUPLICATION_INTERVAL("telemetry.mat.view.event.deduplication.interval"),
