...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    TELEMETRY_WAL_EVENT_THROTTLE_INTERVAL("telemetry.wal.event.throttle.interval"),
    ...
    TELEMETRY_MAT_VIEW_EVENT_THROTTLE_INTERVAL("telemetry.mat.view.event.throttle.interval"),
