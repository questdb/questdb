...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_LIVE_VIEW_CHECKPOINT_BACKFILL_DEFERRAL_ENABLED("cairo.live.view.checkpoint.backfill.deferral.enabled"),
    CAIRO_LIVE_VIEW_CHECKPOINT_BACKFILL_INTERVAL("cairo.live.view.checkpoint.backfill.interval"),
    CAIRO_LIVE_VIEW_CHECKPOINT_BACKFILL_MAX_DURATION("cairo.live.view.checkpoint.backfill.max.duration"),
