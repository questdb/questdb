...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    HTTP_MIN_WORKER_TARGET_UTILIZATION("http.min.worker.target.utilization"),
    HTTP_MIN_WORKER_UTILIZATION_TOLERANCE("http.min.worker.utilization.tolerance"),
    HTTP_MIN_WORKER_MIN_ACTIVE_WORKERS("http.min.worker.min.active.workers"),
    HTTP_MIN_WORKER_EVALUATION_INTERVAL("http.min.worker.evaluation.interval"),
    ...
    HTTP_WORKER_TARGET_UTILIZATION("http.worker.target.utilization"),
    HTTP_WORKER_UTILIZATION_TOLERANCE("http.worker.utilization.tolerance"),
    HTTP_WORKER_MIN_ACTIVE_WORKERS("http.worker.min.active.workers"),
    HTTP_WORKER_EVALUATION_INTERVAL("http.worker.evaluation.interval"),
    ...
    LINE_TCP_WRITER_WORKER_TARGET_UTILIZATION("line.tcp.writer.worker.target.utilization"),
    LINE_TCP_WRITER_WORKER_UTILIZATION_TOLERANCE("line.tcp.writer.worker.utilization.tolerance"),
    LINE_TCP_WRITER_WORKER_MIN_ACTIVE_WORKERS("line.tcp.writer.worker.min.active.workers"),
    LINE_TCP_WRITER_WORKER_EVALUATION_INTERVAL("line.tcp.writer.worker.evaluation.interval"),
    ...
    LINE_TCP_IO_WORKER_TARGET_UTILIZATION("line.tcp.io.worker.target.utilization"),
    LINE_TCP_IO_WORKER_UTILIZATION_TOLERANCE("line.tcp.io.worker.utilization.tolerance"),
    LINE_TCP_IO_WORKER_MIN_ACTIVE_WORKERS("line.tcp.io.worker.min.active.workers"),
    LINE_TCP_IO_WORKER_EVALUATION_INTERVAL("line.tcp.io.worker.evaluation.interval"),
    ...
    PG_WORKER_TARGET_UTILIZATION("pg.worker.target.utilization"),
    PG_WORKER_UTILIZATION_TOLERANCE("pg.worker.utilization.tolerance"),
    PG_WORKER_MIN_ACTIVE_WORKERS("pg.worker.min.active.workers"),
    PG_WORKER_EVALUATION_INTERVAL("pg.worker.evaluation.interval"),
    ...
    SHARED_WORKER_TARGET_UTILIZATION("shared.worker.target.utilization"),
    SHARED_WORKER_UTILIZATION_TOLERANCE("shared.worker.utilization.tolerance"),
    SHARED_WORKER_MIN_ACTIVE_WORKERS("shared.worker.min.active.workers"),
    SHARED_WORKER_EVALUATION_INTERVAL("shared.worker.evaluation.interval"),
    SHARED_NETWORK_WORKER_COUNT("shared.network.worker.count"),
    SHARED_NETWORK_WORKER_AFFINITY("shared.network.worker.affinity"),
    SHARED_NETWORK_WORKER_TARGET_UTILIZATION("shared.network.worker.target.utilization"),
    SHARED_NETWORK_WORKER_UTILIZATION_TOLERANCE("shared.network.worker.utilization.tolerance"),
    SHARED_NETWORK_WORKER_MIN_ACTIVE_WORKERS("shared.network.worker.min.active.workers"),
    SHARED_NETWORK_WORKER_EVALUATION_INTERVAL("shared.network.worker.evaluation.interval"),
    SHARED_QUERY_WORKER_COUNT("shared.query.worker.count"),
    SHARED_QUERY_WORKER_AFFINITY("shared.query.worker.affinity"),
    SHARED_QUERY_WORKER_TARGET_UTILIZATION("shared.query.worker.target.utilization"),
    SHARED_QUERY_WORKER_UTILIZATION_TOLERANCE("shared.query.worker.utilization.tolerance"),
    SHARED_QUERY_WORKER_MIN_ACTIVE_WORKERS("shared.query.worker.min.active.workers"),
    SHARED_QUERY_WORKER_EVALUATION_INTERVAL("shared.query.worker.evaluation.interval"),
    SHARED_WRITE_WORKER_COUNT("shared.write.worker.count"),
    SHARED_WRITE_WORKER_AFFINITY("shared.write.worker.affinity"),
    SHARED_WRITE_WORKER_TARGET_UTILIZATION("shared.write.worker.target.utilization"),
    SHARED_WRITE_WORKER_UTILIZATION_TOLERANCE("shared.write.worker.utilization.tolerance"),
    SHARED_WRITE_WORKER_MIN_ACTIVE_WORKERS("shared.write.worker.min.active.workers"),
    SHARED_WRITE_WORKER_EVALUATION_INTERVAL("shared.write.worker.evaluation.interval"),
    ...
    WAL_APPLY_WORKER_TARGET_UTILIZATION("wal.apply.worker.target.utilization"),
    WAL_APPLY_WORKER_UTILIZATION_TOLERANCE("wal.apply.worker.utilization.tolerance"),
    WAL_APPLY_WORKER_MIN_ACTIVE_WORKERS("wal.apply.worker.min.active.workers"),
    WAL_APPLY_WORKER_EVALUATION_INTERVAL("wal.apply.worker.evaluation.interval"),
    ...
    MAT_VIEW_REFRESH_WORKER_TARGET_UTILIZATION("mat.view.refresh.worker.target.utilization"),
    MAT_VIEW_REFRESH_WORKER_UTILIZATION_TOLERANCE("mat.view.refresh.worker.utilization.tolerance"),
    MAT_VIEW_REFRESH_WORKER_MIN_ACTIVE_WORKERS("mat.view.refresh.worker.min.active.workers"),
    MAT_VIEW_REFRESH_WORKER_EVALUATION_INTERVAL("mat.view.refresh.worker.evaluation.interval"),
