...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    NETWORK_SHARED_WORKER_COUNT("network.shared.worker.count"),
    NETWORK_SHARED_WORKER_AFFINITY("network.shared.worker.affinity"),
    QUERY_SHARED_WORKER_COUNT("query.shared.worker.count"),
    QUERY_SHARED_WORKER_AFFINITY("query.shared.worker.affinity"),
    WRITE_SHARED_WORKER_COUNT("write.shared.worker.count"),
    WRITE_SHARED_WORKER_AFFINITY("write.shared.worker.affinity"),
