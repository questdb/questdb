...
public enum PropertyKey {
    ...
    CAIRO_SQL_PAGE_FRAME_MAX_SIZE("cairo.sql.page.frame.max.size"),
    ...
    CTRL_ENABLED("ctrl.enabled"),
    CTRL_NET_BIND_TO("ctrl.net.bind.to"),
    ...
    REPLICATION_TMP_ROLE("replication.tmp.role"),
