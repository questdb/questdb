...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_WAL_WRITER_IO_URING_ENABLED("cairo.wal.writer.iouring.enabled"),
    ...
    ASYNC_MUNMAP_WORKER_AFFINITY("async.munmap.worker.affinity"),
    ASYNC_MUNMAP_WORKER_HALT_ON_ERROR("async.munmap.worker.haltOnError"),
    ASYNC_MUNMAP_WORKER_NAP_THRESHOLD("async.munmap.worker.nap.threshold"),
    ASYNC_MUNMAP_WORKER_PRIORITY("async.munmap.worker.priority"),
    ASYNC_MUNMAP_WORKER_SLEEP_THRESHOLD("async.munmap.worker.sleep.threshold"),
    ASYNC_MUNMAP_WORKER_SLEEP_TIMEOUT("async.munmap.worker.sleep.timeout"),
    ASYNC_MUNMAP_WORKER_YIELD_THRESHOLD("async.munmap.worker.yield.threshold"),
