...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_SQL_PARALLEL_GROUPBY_TOPK_THRESHOLD("cairo.sql.parallel.groupby.topk.threshold"),
    CAIRO_SQL_PARALLEL_GROUPBY_TOPK_QUEUE_CAPACITY("cairo.sql.parallel.groupby.topk.queue.capacity"),
