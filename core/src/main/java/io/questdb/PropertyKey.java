...
public enum PropertyKey implements ConfigProperty {
    ...
    CAIRO_SQL_FAST_MAP_DISK_SPILL_EXTEND_SEGMENT_SIZE("cairo.sql.fast.map.disk.spill.extend.segment.size"),
    CAIRO_SQL_FAST_MAP_DISK_SPILL_THRESHOLD("cairo.sql.fast.map.disk.spill.threshold"),
    CAIRO_SQL_FAST_MAP_DISK_SPILL_ROOT("cairo.sql.fast.map.disk.spill.root"),
