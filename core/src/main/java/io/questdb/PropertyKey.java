...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_CREATE_MAT_VIEW_RETRY_COUNT("cairo.create.materialized.view.retry.count"),
    ...
    CAIRO_SQL_CREATE_MAT_VIEW_MODEL_POOL_CAPACITY("cairo.sql.create.materialized.view.model.pool.capacity"),
