...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_LIVE_VIEW_CHECKPOINT_ADAPTIVE_CADENCE_ENABLED("cairo.live.view.checkpoint.adaptive.cadence.enabled"),
    ...
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_MAX_CHAINED_BOUNDARIES("cairo.live.view.checkpoint.repair.max.chained.boundaries"),
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_ISOLATED_RUNTIME_ENABLED("cairo.live.view.checkpoint.repair.isolated.runtime.enabled"),
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_PER_SEGMENT_ENABLED("cairo.live.view.checkpoint.repair.per.segment.enabled"),
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_REPLAY_MAX_ROWS("cairo.live.view.checkpoint.repair.replay.max.rows"),
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_KEYED_REPLAY_ENABLED("cairo.live.view.checkpoint.repair.keyed.replay.enabled"),
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_OPEN_SEGMENT_KEYED_REPLAY_ENABLED("cairo.live.view.checkpoint.repair.open.segment.keyed.replay.enabled"),
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_KEYED_SCAN_INDEX_OPEN_ROWS("cairo.live.view.checkpoint.repair.keyed.scan.index.open.rows"),
    ...
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_SEGMENT_YIELD_ENABLED("cairo.live.view.checkpoint.repair.segment.yield.enabled"),
    CAIRO_LIVE_VIEW_CHECKPOINT_REPAIR_SPARSE_PUBLICATION_ENABLED("cairo.live.view.checkpoint.repair.sparse.publication.enabled"),
    ...
    HTTP_WORKER_FIBER_ENABLED("http.worker.fiber.enabled"),
    HTTP_WORKER_FIBER_MAX_LIVE("http.worker.fiber.max.live"),
    HTTP_WORKER_FIBER_MAX_RETAINED("http.worker.fiber.max.retained"),
    HTTP_WORKER_FIBER_MOUNT_BUDGET("http.worker.fiber.mount.budget"),
    ...
    PG_WORKER_FIBER_ENABLED("pg.worker.fiber.enabled"),
    PG_WORKER_FIBER_MAX_LIVE("pg.worker.fiber.max.live"),
    PG_WORKER_FIBER_MAX_RETAINED("pg.worker.fiber.max.retained"),
    PG_WORKER_FIBER_MOUNT_BUDGET("pg.worker.fiber.mount.budget"),
    ...
    SHARED_NETWORK_WORKER_FIBER_ENABLED("shared.network.worker.fiber.enabled"),
    SHARED_NETWORK_WORKER_FIBER_MAX_LIVE("shared.network.worker.fiber.max.live"),
    SHARED_NETWORK_WORKER_FIBER_MAX_RETAINED("shared.network.worker.fiber.max.retained"),
    SHARED_NETWORK_WORKER_FIBER_MOUNT_BUDGET("shared.network.worker.fiber.mount.budget"),
    SHARED_QUERY_WORKER_COUNT("shared.query.worker.count"),
    SHARED_QUERY_WORKER_AFFINITY("shared.query.worker.affinity"),
    SHARED_QUERY_WORKER_FIBER_ENABLED("shared.query.worker.fiber.enabled"),
    SHARED_QUERY_WORKER_FIBER_MAX_LIVE("shared.query.worker.fiber.max.live"),
    SHARED_QUERY_WORKER_FIBER_MAX_RETAINED("shared.query.worker.fiber.max.retained"),
    SHARED_QUERY_WORKER_FIBER_MOUNT_BUDGET("shared.query.worker.fiber.mount.budget"),
    SHARED_WRITE_WORKER_COUNT("shared.write.worker.count"),
    SHARED_WRITE_WORKER_AFFINITY("shared.write.worker.affinity"),
    SHARED_WRITE_WORKER_FIBER_ENABLED("shared.write.worker.fiber.enabled"),
    SHARED_WRITE_WORKER_FIBER_MAX_LIVE("shared.write.worker.fiber.max.live"),
    SHARED_WRITE_WORKER_FIBER_MAX_RETAINED("shared.write.worker.fiber.max.retained"),
    SHARED_WRITE_WORKER_FIBER_MOUNT_BUDGET("shared.write.worker.fiber.mount.budget"),
    ...
    MAT_VIEW_REFRESH_WORKER_FIBER_ENABLED("mat.view.refresh.worker.fiber.enabled"),
    MAT_VIEW_REFRESH_WORKER_FIBER_MAX_LIVE("mat.view.refresh.worker.fiber.max.live"),
    MAT_VIEW_REFRESH_WORKER_FIBER_MAX_RETAINED("mat.view.refresh.worker.fiber.max.retained"),
    MAT_VIEW_REFRESH_WORKER_FIBER_MOUNT_BUDGET("mat.view.refresh.worker.fiber.mount.budget"),
