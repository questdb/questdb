...
public final class TelemetrySystemEvent {
    ...
    // DB size classes: 30 - <10GB, 31 - (10GB,50GB], 32 - (50GB,100GB], 33 - (100GB,500GB], 34 - (500GB,1TB], 35 - (1TB,5TB], 36 - >5TB
    ...
    // Table count classes: 40 - 0-10 tables, 41 - 11-25 tables, 42 - 26-50 tables, 43 - 51-100 tables, 44 - 101-250 tables, 45 - 251+ tables
