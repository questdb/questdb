...
public class PGWireMetrics {
    ...
    public PGWireMetrics(MetricsRegistry metricsRegistry) {
        ...
        this.startedQueriesCounter = metricsRegistry.newCounter("pg_wire_started_queries");
    ...
    public Counter completedQueriesCounter() {
        return completedQueriesCounter;
    }

    public void incQueryCompletedCounter() {
        completedQueriesCounter.inc();
    }

    public void incQueryStartedCounter() {
        startedQueriesCounter.inc();
    }

    public Counter startedQueriesCounter() {
        return startedQueriesCounter;
    }
