 ...
 */
public class IlpV4MessageHeader {
     ...
     */
    public IlpV4MessageHeader setMaxPayloadLength(long maxPayloadLength) {
     ...
     * @throws IlpV4ParseException if header is invalid
     */
     ...
     *
     * @throws IlpV4ParseException if validation fails
     */
    private void validate() throws IlpV4ParseException {
        ...
        if (version != VERSION_1) {
            throw IlpV4ParseException.unsupportedVersion();
        }

        // Validate payload length
        if (payloadLength > maxPayloadLength) {
            throw IlpV4ParseException.payloadTooLarge();
        }
