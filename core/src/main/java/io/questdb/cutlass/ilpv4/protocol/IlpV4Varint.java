...
public final class IlpV4Varint {
     ...
     * @throws IlpV4ParseException if the varint is malformed (too many bytes)
     */
    public static long decode(byte[] buf, int pos) throws IlpV4ParseException {
     ...
     * @return the decoded value
     * @throws IlpV4ParseException if the varint is malformed or buffer underflows
     */
    public static long decode(byte[] buf, int pos, int limit) throws IlpV4ParseException {
        long result = 0;
        int shift = 0;
        int bytesRead = 0;
        byte b;
        ...
        do {
            if (pos >= limit) {
                throw IlpV4ParseException.incompleteVarint();
            }
            if (bytesRead >= MAX_VARINT_BYTES) {
                throw IlpV4ParseException.varintOverflow();
            }
            b = buf[pos++];
     ...
     * @throws IlpV4ParseException if the varint is malformed or buffer underflows
     */
    public static long decode(long address, long limit) throws IlpV4ParseException {
        long result = 0;
        int shift = 0;
        int bytesRead = 0;
        byte b;
     ...
     * @throws IlpV4ParseException if the varint is malformed or buffer underflows
     */
    public static void decode(byte[] buf, int pos, int limit, DecodeResult result) throws IlpV4ParseException {
        long value = 0;
        int shift = 0;
        int bytesRead = 0;
        byte b;
     ...
     * @throws IlpV4ParseException if the varint is malformed or buffer underflows
     */
    public static void decode(long address, long limit, DecodeResult result) throws IlpV4ParseException {
        long value = 0;
        int shift = 0;
        int bytesRead = 0;
        byte b;
