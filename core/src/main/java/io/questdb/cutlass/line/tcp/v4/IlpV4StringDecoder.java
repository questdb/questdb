 ...
 * </pre>
 */
public final class IlpV4StringDecoder implements IlpV4ColumnDecoder {

    public static final IlpV4StringDecoder INSTANCE = new IlpV4StringDecoder();

    private IlpV4StringDecoder() {
    }
