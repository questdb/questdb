...
public class IlpV4Response {
     ...
     * @return OK response
     */
    public static IlpV4Response ok() {
        IlpV4Response response = new IlpV4Response();
        response.statusCode = IlpV4StatusCode.OK;
        return response;
    }
     ...
     */
    public static IlpV4Response error(byte statusCode, String errorMessage) {
        IlpV4Response response = new IlpV4Response();
     ...
     */
    public static IlpV4Response schemaRequired(String tableName) {
        return error(IlpV4StatusCode.SCHEMA_REQUIRED, "schema not found for table: " + tableName);
    }
     ...
     */
    public static IlpV4Response schemaMismatch(String tableName, String columnName) {
        return error(IlpV4StatusCode.SCHEMA_MISMATCH,
     ...
     */
    public static IlpV4Response tableNotFound(String tableName) {
        return error(IlpV4StatusCode.TABLE_NOT_FOUND, "table not found: " + tableName);
    }
     ...
     */
    public static IlpV4Response parseError(String message) {
        return error(IlpV4StatusCode.PARSE_ERROR, message);
    }
     ...
     */
    public static IlpV4Response internalError(String message) {
        return error(IlpV4StatusCode.INTERNAL_ERROR, message);
    }
     ...
     */
    public static IlpV4Response overloaded() {
        return error(IlpV4StatusCode.OVERLOADED, "server overloaded, retry later");
    }
     ...
     */
    public static IlpV4Response partial(ObjList<TableError> errors) {
        IlpV4Response response = new IlpV4Response();
        response.statusCode = IlpV4StatusCode.PARTIAL;
    ...
    public boolean isSuccess() {
        return IlpV4StatusCode.isSuccess(statusCode);
    }
    ...
    public boolean isRetriable() {
        return IlpV4StatusCode.isRetriable(statusCode);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("IlpV4Response{status=").append(IlpV4StatusCode.name(statusCode));
    ...
    public static class TableError {
        ...
        public String toString() {
            return "TableError{index=" + tableIndex +
                    ", code=" + IlpV4StatusCode.name(errorCode) +
