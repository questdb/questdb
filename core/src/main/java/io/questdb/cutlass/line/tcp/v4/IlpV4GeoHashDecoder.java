 ...
 * </ul>
 */
public final class IlpV4GeoHashDecoder implements IlpV4ColumnDecoder {
    ...
    public static final IlpV4GeoHashDecoder INSTANCE = new IlpV4GeoHashDecoder();

    private final IlpV4Varint.DecodeResult decodeResult = new IlpV4Varint.DecodeResult();

    private IlpV4GeoHashDecoder() {
    }
    ...
    public static long encode(long destAddress, long[] values, int precision, boolean[] nulls) {
        ...
        // Write precision
        pos = IlpV4Varint.encode(pos, precision);
