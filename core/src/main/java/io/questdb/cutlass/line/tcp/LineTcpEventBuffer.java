...
public class LineTcpEventBuffer {
    ...
    public long addDecimal(long address, Decimal256 decimal256, int columnType) {
        ...
        Unsafe.putLong(address + Integer.BYTES + Byte.BYTES * 2, decimal256.getHh());
    ...
    public int readDecimal(long address, Decimal256 result) {
        int scale = Unsafe.getByte(address + Integer.BYTES);
        result.of(
                Unsafe.getLong(address + Integer.BYTES + Byte.BYTES),
                Unsafe.getLong(address + Integer.BYTES + Byte.BYTES + Long.BYTES),
                Unsafe.getLong(address + Integer.BYTES + Byte.BYTES + Long.BYTES * 2),
                Unsafe.getLong(address + Integer.BYTES + Byte.BYTES + Long.BYTES * 3),
                scale
        );
