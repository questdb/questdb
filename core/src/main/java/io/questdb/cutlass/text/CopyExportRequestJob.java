...
public class CopyExportRequestJob extends SynchronizedJob implements Closeable {
    ...
    public CopyExportRequestJob(final CairoEngine engine, int workerCount) throws SqlException {
        try {
            ...
            final String statusTableName = configuration.getSystemTableNamePrefix() + "copy_rexport_log";
