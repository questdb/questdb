 ...
 * <b>Usage:</b>
 * <pre>
 * IlpV4StreamingDecoder decoder = new IlpV4StreamingDecoder(schemaCache);
 * try {
 *     IlpV4MessageCursor message = decoder.decode(address, length);
 *     while (message.hasNextTable()) {
 *         IlpV4TableBlockCursor table = message.nextTable();
 ...
 *
 * @see IlpV4MessageCursor
 * @see IlpV4TableBlockCursor
 * @see IlpV4ColumnCursor
 */
public class IlpV4StreamingDecoder implements QuietCloseable {

    private final IlpV4MessageCursor messageCursor = new IlpV4MessageCursor();
    private final IlpV4SchemaCache schemaCache;

    /**
     * Creates a streaming decoder without schema caching.
     */
    public IlpV4StreamingDecoder() {
        this(null);
    }
     ...
     */
    public IlpV4StreamingDecoder(IlpV4SchemaCache schemaCache) {
     ...
     */
    public IlpV4MessageCursor getMessageCursor() {
        return messageCursor;
    }
