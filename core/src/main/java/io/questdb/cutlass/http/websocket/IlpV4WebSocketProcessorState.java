...
package io.questdb.cutlass.http.websocket;
 ...
 * processing status.
 */
public class IlpV4WebSocketProcessorState implements Mutable, QuietCloseable {
    ...
    public IlpV4WebSocketProcessorState(int initialBufferSize) {
