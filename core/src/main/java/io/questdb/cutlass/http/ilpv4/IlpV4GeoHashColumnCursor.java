...
import static io.questdb.cutlass.http.ilpv4.IlpV4Constants.TYPE_GEOHASH;
...
public class IlpV4GeoHashColumnCursor implements IlpV4ColumnCursor {
    ...
    public int of(long dataAddress, int dataLength, int rowCount, boolean nullable,
        ...
        // Validate precision
        if (precision < IlpV4GeoHashDecoder.MIN_BITS || precision > IlpV4GeoHashDecoder.MAX_BITS) {
