...
public class IlpV4BitReader {
     ...
     *
     * @return 0 or 1
     * @throws IlpV4ParseException if no more bits available
     */
    public int readBit() throws IlpV4ParseException {
        if (totalBitsRead >= totalBitsAvailable) {
            throw IlpV4ParseException.bitReadOverflow();
        }
        if (!ensureBits(1)) {
            throw IlpV4ParseException.bitReadOverflow();
        }
     ...
     * @throws IlpV4ParseException if not enough bits available
     */
    public long readBits(int numBits) throws IlpV4ParseException {
        if (numBits <= 0) {
            return 0;
        }
        if (numBits > 64) {
     ...
     * @throws IlpV4ParseException if not enough bits available
     */
    public long readSigned(int numBits) throws IlpV4ParseException {
     ...
     * @throws IlpV4ParseException if not enough bits available
     */
    public void skipBits(int numBits) throws IlpV4ParseException {
        if (totalBitsRead + numBits > totalBitsAvailable) {
            throw IlpV4ParseException.bitReadOverflow();
        }
     ...
     *
     * @throws IlpV4ParseException if alignment fails
     */
    public void alignToByte() throws IlpV4ParseException {
     ...
     * @throws IlpV4ParseException if not enough data
     */
    public int readByte() throws IlpV4ParseException {
     ...
     * @throws IlpV4ParseException if not enough data
     */
    public int readInt() throws IlpV4ParseException {
     ...
     * @throws IlpV4ParseException if not enough data
     */
    public long readLong() throws IlpV4ParseException {
        return readBits(64);
    }
