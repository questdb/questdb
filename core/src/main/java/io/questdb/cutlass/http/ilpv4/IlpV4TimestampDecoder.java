 ...
 * </pre>
 */
public final class IlpV4TimestampDecoder implements IlpV4ColumnDecoder {
    ...
    public static final IlpV4TimestampDecoder INSTANCE = new IlpV4TimestampDecoder();

    private final IlpV4GorillaDecoder gorillaDecoder = new IlpV4GorillaDecoder();

    private IlpV4TimestampDecoder() {
    }
