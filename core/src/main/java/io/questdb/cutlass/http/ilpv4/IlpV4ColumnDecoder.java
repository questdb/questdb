 ...
 * </ul>
 */
public interface IlpV4ColumnDecoder {
     ...
     * @throws IlpV4ParseException if decoding fails
     */
    int decode(long sourceAddress, int sourceLength, int rowCount, boolean nullable, ColumnSink sink) throws IlpV4ParseException;
