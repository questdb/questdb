 ...
 * </pre>
 */
public final class IlpV4FixedWidthDecoder implements IlpV4ColumnDecoder {
     ...
     */
    public IlpV4FixedWidthDecoder(byte typeCode) {
        ...
        if (this.typeCode == TYPE_BOOLEAN) {
            throw new IllegalArgumentException("Use IlpV4BooleanDecoder for BOOLEAN type");
        }
    }
