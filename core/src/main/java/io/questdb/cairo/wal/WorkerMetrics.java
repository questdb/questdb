...
//    }
    ...
    public WorkerMetrics begin(String workerName) {
        return this;
    }
    ...
    public void beginRun(String workerName) {

    }

    public void end(String workerName) {
    ...
    public void endRun(String workerName) {
