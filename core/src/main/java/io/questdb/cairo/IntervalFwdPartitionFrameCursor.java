        ...
        while (intervalsLo < intervalsHi && partitionLo < partitionHi) {
            ...
            if (rowCount > 0) {
                ...
                if (partitionTimestampLo < intervalLo) {
                    ...
                    lo = timestampFinder.findTimestamp(intervalLo - 1, partitionLimit, rowCount - 1, SCAN_DOWN) + 1;
                } else {
                    lo = 0;
                }
                ...
                if (partitionTimestampHi > intervalHi) {
                    hi = timestampFinder.findTimestamp(intervalHi, lo, rowCount - 1, SCAN_DOWN) + 1;
                } else {
                    hi = rowCount;
                }
