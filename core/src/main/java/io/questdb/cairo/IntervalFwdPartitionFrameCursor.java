            ...
            if (rowCount > 0) {
                ...
                if (lo < hi) {
                    ...
                    if (format == PartitionFormat.PARQUET) {
                        PartitionDecoder decoder = reader.getParquetPartitionDecoders(partitionLo);
                        long addr = reader.getParquetAddr(partitionLo);
                        long fileSize = reader.getParquetFileSize(partitionLo);
