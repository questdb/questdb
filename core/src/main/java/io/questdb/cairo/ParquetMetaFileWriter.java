...
public class ParquetMetaFileWriter {
    ...
    public static native void addColumn(long writerPtr, long top, long namePtr, int nameLen, int id, int colType, int flags, int fixedByteLen, int physicalType, int maxRepLevel, int maxDefLevel);
