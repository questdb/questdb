...
public interface ColumnFilterer extends QuietCloseable {
    ...
    void filter(FilesFacade ff, long dataColumnFd, long loRow, long hiRow);

    long getFd();

    long getSequence();

    SkipFilterWriter getWriter();

    boolean isDistressed();

    void refreshSourceAndFilter(long loRow, long hiRow);

    void releaseFilterWriter();
