...
public interface SkipFilterWriter extends SkipFilterReader {
    void commit();

    boolean insert(long key);

    void of(CairoConfiguration configuration, long bucketFd, boolean init, int filterCapacity);

    void of(Path path, CharSequence name, long columnNameTxn, int filterCapacity);
