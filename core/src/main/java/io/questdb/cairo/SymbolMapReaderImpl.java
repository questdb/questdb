...
public class SymbolMapReaderImpl implements Closeable, SymbolMapReader {
    ...
    public void of(
        ...
        try {
            ...
            // Symbol-table de-dup index is BITMAP — metadata + cover params unused. No partition top at table root.
            indexReader.of(configuration, path.trimTo(plen), columnName, columnNameTxn, -1, 0, null, null, 0, 0);
    ...
    public void updateSymbolCount(int symbolCount) {
        ...
        // partition txn does not matter, because symbol is at the root of the table dir (not at partition level)
        indexReader.of(configuration, path, columnNameSink, columnNameTxn, -1, 0, null, null, 0, 0);
    }
