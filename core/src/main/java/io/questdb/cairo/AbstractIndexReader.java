    ...
    public void of(CairoConfiguration configuration, Path path, CharSequence name, long columnNameTxn, long unIndexedNullCount, long partitionTxn) {
        ...
        try {
            ...
            if (keyMemSize < BitmapIndexUtils.KEY_FILE_RESERVED) {
                ...
                throw CairoException.critical().put("Index file too short: ").put(path);
            }
            ...
            if (this.keyMem.getByte(BitmapIndexUtils.KEY_RESERVED_OFFSET_SIGNATURE) != BitmapIndexUtils.SIGNATURE) {
                ...
                throw CairoException.critical().put("Unknown format: ").put(path);
            }
            ...
            while (true) {
                ...
                if (clock.getTicks() > deadline) {
                    ...
                    throw CairoException.critical().put(INDEX_CORRUPT);
                }
