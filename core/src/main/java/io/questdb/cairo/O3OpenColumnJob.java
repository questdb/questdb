...
public class O3OpenColumnJob extends AbstractQueueConsumerJob<O3OpenColumnTask> {
    ...
    private static void appendFixColumn(
        ...
        try {
            ...
            LOG.error().$("append fix error [table=").utf8(tableWriter.getTableToken().getLoggingName())
                    .$(", e=").$(e)
                    .I$();
    ...
    private static void appendMidPartition(
        ...
        if (srcDataTop == -1) {
            try {
                ...
                LOG.error().$("append mid partition error 1 [table=").utf8(tableWriter.getTableToken().getLoggingName())
                        .$(", e=").$(e)
                        .I$();
                freeTs(
                        columnCounter,
        ...
        switch (ColumnType.tagOf(columnType)) {
            ...
            case ColumnType.STRING:
                try {
                    ...
                    LOG.error().$("append mid partition error 2 [table=").utf8(tableWriter.getTableToken().getLoggingName())
                            .$(", e=").$(e)
                            .I$();
            ...
            default:
                try {
                    ...
                    LOG.error().$("append mid partition error 3 [table=").utf8(tableWriter.getTableToken().getLoggingName())
                            .$(", e=").$(e)
                            .I$();
                    O3Utils.close(ff, dstFixFd);
                    O3Utils.close(ff, dstVarFd);
    ...
    private static void appendNewPartition(
        ...
        try {
            ...
            LOG.error().$("append new partition error [table=").utf8(tableWriter.getTableToken().getLoggingName())
                    .$(", e=").$(e)
                    .I$();
    ...
    private static void appendTimestampColumn(
        ...
        try {
            ...
            LOG.error().$("append ts error [table=").utf8(tableWriter.getTableToken().getLoggingName())
                    .$(", e=").$(e)
                    .I$();
            O3Utils.close(ff, dstFixFd);
            freeTs(
    ...
    private static void appendVarColumn(
        ...
        try {
            ...
            LOG.error().$("append var error [table=").utf8(tableWriter.getTableToken().getLoggingName())
                    .$(", e=").$(e)
                    .I$();
    ...
    private static void mergeFixColumn(
        ...
        try {
            ...
            LOG.error().$("merge fix error [table=").utf8(tableWriter.getTableToken().getLoggingName())
                    .$(", e=").$(e)
                    .I$();
    ...
    private static void mergeMidPartition(
        ...
        if (srcDataTop == -1) {
            try {
                ...
                LOG.error().$("merge mid partition error 1 [table=").utf8(tableWriter.getTableToken().getLoggingName())
                        .$(", e=").$(e)
                        .I$();
                freeTs(
                        columnCounter,
        ...
        switch (ColumnType.tagOf(columnType)) {
            ...
            case ColumnType.STRING:
                try {
                    ...
                    LOG.error().$("merge mid partition error 2 [table=").utf8(tableWriter.getTableToken().getLoggingName())
                            .$(", e=").$(e)
                            .I$();
            ...
            default:
                try {
                    ...
                    LOG.error().$("merge mid partition error 3 [table=").utf8(tableWriter.getTableToken().getLoggingName())
                            .$(", e=").$(e)
                            .I$();
                    freeTs(
                            columnCounter,
    ...
    private static void mergeVarColumn(
        ...
        try {
            ...
            LOG.error().$("merge var error [table=").utf8(tableWriter.getTableToken().getLoggingName())
                    .$(", e=").$(e)
                    .I$();
            tableWriter.o3BumpErrorCount();
