...
public class O3OpenColumnJob extends AbstractQueueConsumerJob<O3OpenColumnTask> {
    ...
    private static void appendFixColumn(
        ...
        try {
            ...
            if (dstFixMem == null || dstFixMem.getAppendAddressSize() < dstFixSize) {
                ...
                dstFixAddr = mapRW(ff, Math.abs(dstFixFd), dstFixSize, MemoryTag.MMAP_DEFAULT);
    ...
    private static void appendTimestampColumn(
        ...
        try {
            ...
            if (dstFixMem == null || dstFixMem.getAppendAddressSize() < dstFixSize) {
                ...
                dstFixAddr = mapRW(ff, -dstFixFd, dstFixSize, MemoryTag.MMAP_DEFAULT);
            } else {
                dstFixAddr = dstFixMem.getAppendAddress();
                dstFixOffset = 0;
                dstFixSize = -dstFixSize;
    ...
    private static void appendVarColumn(
        ...
        try {
            ...
            if (dstFixMem == null || dstFixMem.getAppendAddressSize() < dstFixSize || dstVarMem.getAppendAddressSize() < l) {
                ...
                dstFixAddr = mapRW(ff, Math.abs(activeFixFd), dstFixSize, MemoryTag.MMAP_DEFAULT);
                ...
                dstVarAddr = mapRW(ff, Math.abs(activeVarFd), dstVarSize, MemoryTag.MMAP_DEFAULT);
                dstVarAdjust = 0;
            } else {
                dstFixAddr = dstFixMem.getAppendAddress();
        ...
        try {
            ...
            if (srcDataTop > 0) {
                ...
                if (srcDataTop > prefixHi || prefixType == O3_BLOCK_O3) {
                    ...
                    srcDataFixAddr = mapRW(ff, srcFixFd, srcDataFixSize, MemoryTag.MMAP_DEFAULT);
    ...
    private static void mergeVarColumn(
        ...
        try {
            ...
            if (srcDataTop > 0) {
                ...
                if (srcDataTop > prefixHi || prefixType == O3_BLOCK_O3) {
                    ...
                    if (ColumnType.isString(columnType)) {
                        ...
                        srcDataVarAddr = mapRW(ff, srcVarFd, srcDataVarSize, MemoryTag.MMAP_DEFAULT);
                    ...
                    srcDataVarAddr = mapRO(ff, srcVarFd, srcDataVarSize, MemoryTag.MMAP_DEFAULT);
                }
            } else {
            ...
            dstVarAddr = mapRW(ff, dstVarFd, dstVarSize, MemoryTag.MMAP_DEFAULT);
