...
public class ReaderPool extends AbstractPool implements ResourcePool<TableReader> {
    ...
    public static class R extends TableReader {
        ...
        public R(ReaderPool pool, Entry entry, int index, CharSequence systemTableName, MessageBus messageBus) {
            super(pool.getConfiguration(), systemTableName, messageBus);
            this.pool = pool;
            this.entry = entry;
            this.index = index;
        }
