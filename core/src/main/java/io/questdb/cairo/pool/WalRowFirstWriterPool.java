...
public class WalRowFirstWriterPool extends AbstractMultiTenantPool<WalRowFirstWriterPool.Tenant> {

    private final CairoEngine engine;

    public WalRowFirstWriterPool(CairoConfiguration configuration, CairoEngine engine) {
    ...
    protected byte getListenerSrc() {
        return PoolListener.SRC_WAL_ROW_FIRST_WRITER;
    }
    ...
    public static class Tenant extends WalRowFirstWriter implements PoolTenant<Tenant> {
