...
/**
 * Operational counters for the Parquet decode-buffer cache layer.
 * Spills and restores fire only when the cold-tier disk-spill path is enabled
 * (see {@link PageFrameMemoryPool}); under default configuration both stay at
 * zero.
 */
