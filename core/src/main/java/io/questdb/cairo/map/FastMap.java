...
public class FastMap implements Map {
    ...
    FastMap(int pageSize,
        ...
        this.kStart = kPos = Unsafe.malloc(this.capacity = pageSize, MemoryTag.NATIVE_DEFAULT);
    ...
    public final void close() {
        ...
        if (kStart != 0) {
            Unsafe.free(kStart, capacity, MemoryTag.NATIVE_DEFAULT);
            kStart = 0;
        }
    }
    ...
    private void resize(int size) {
        if (nResizes < maxResizes) {
            ...
            long kAddress = Unsafe.realloc(this.kStart, this.capacity, kCapacity, MemoryTag.NATIVE_DEFAULT);
