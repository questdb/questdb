...
final class FastMapValue implements MapValue {
    ...
    public void putUuid(int index, long msb, long lsb) {
        Unsafe.getUnsafe().putLong(address0(index), msb);
        Unsafe.getUnsafe().putLong(address0(index) + Long.BYTES, lsb);
    }
