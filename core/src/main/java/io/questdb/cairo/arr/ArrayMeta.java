...
public class ArrayMeta {  // TODO(amunra): Rename to `ArrayMetaUtils`.
    ...
    public static int calcRequiredValuesByteSize(int type, int elementsCount) {
        ...
        return elementsCount << (ColumnType.decodeArrayElementTypePrecision(type) - 3);
    }
     ...
     * vector returned by {@link ArrayViewImpl#getValues()}.</p>
     */
     ...
     * <p>If they are, the data can be iterated in order simply by accessing the {@link ArrayViewImpl#getValues()} vec.</p>
     */
