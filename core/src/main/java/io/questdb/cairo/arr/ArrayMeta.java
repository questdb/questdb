...
public class ArrayMeta {  // TODO(amunra): Rename to `ArrayMetaUtils`.
     ...
     * vector returned by {@link DirectFlyweightArrayView#getValues()}.</p>
     */
     ...
     * <p>If they are, the data can be iterated in order simply by accessing the {@link DirectFlyweightArrayView#getValues()} vec.</p>
     */
