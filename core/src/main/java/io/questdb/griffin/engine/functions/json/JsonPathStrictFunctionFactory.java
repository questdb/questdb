...
public class JsonPathStrictFunctionFactory implements FunctionFactory {
    private static final String FUNCTION_NAME = "json_path_strict";
    ...
    public Function newInstance(
        ...
        return new JsonPathVarcharFunc(FUNCTION_NAME, json, path, pointer, maxSize, true);
    }
}
