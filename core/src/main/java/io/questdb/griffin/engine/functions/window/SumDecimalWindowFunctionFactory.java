...
public class SumDecimalWindowFunctionFactory extends AbstractWindowFunctionFactory {
    ...
    public Function newInstance(
        ...
        if (tag == ColumnType.DECIMAL8) {
            ...
            return newInstanceDecimal8(position, args, configuration, sqlExecutionContext, d8OutputType, argPos);
        }
        if (tag == ColumnType.DECIMAL16) {
            ...
            return newInstanceDecimal16(position, args, configuration, sqlExecutionContext, d16OutputType, argPos);
        }
        ...
        if (tag == ColumnType.DECIMAL256) {
            int d256OutputType = argType;
            return newInstanceDecimal256(position, args, configuration, sqlExecutionContext, d256OutputType, argPos);
        }
    ...
    static class Decimal64SumOverCurrentRowFunction extends BaseWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal64SumOverPartitionFunction extends BasePartitionedWindowFunction implements WindowDecimal128Function {
    ...
    public static class Decimal64SumOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal128Function {
    ...
    public static class Decimal64SumOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal64SumOverRangeFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal128Function {
    ...
    static class Decimal64SumOverRowsFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal128Function {
    ...
    static class Decimal64SumOverUnboundedPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal64SumOverUnboundedRowsFrameFunction extends BaseWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal64SumOverWholeResultSetFunction extends BaseWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal8SumOverCurrentRowFunction extends BaseWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal8SumOverPartitionFunction extends BasePartitionedWindowFunction implements WindowDecimal64Function {
        ...
        public void computeNext(Record record) {
            ...
            mv.putLong(0, acc);
            mv.putBool(1, wasNull);
            value = wasNull ? Decimals.DECIMAL64_NULL : acc;
        }
    ...
    public static class Decimal8SumOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal64Function {
    ...
    public static class Decimal8SumOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal8SumOverRangeFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal64Function {
    ...
    static class Decimal8SumOverRowsFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal64Function {
    ...
    static class Decimal8SumOverUnboundedPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal8SumOverUnboundedRowsFrameFunction extends BaseWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal8SumOverWholeResultSetFunction extends BaseWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal256SumOverCurrentRowFunction extends BaseWindowFunction implements WindowDecimal256Function {

        private final Decimal256 scratch = new Decimal256();
        private final int type;
        private final Decimal256 value = new Decimal256();

        Decimal256SumOverCurrentRowFunction(Function arg, int type) {
            super(arg);
            this.type = type;
        }
    ...
    static class Decimal256SumOverPartitionFunction extends BasePartitionedWindowFunction implements WindowDecimal256Function {
    ...
    public static class Decimal256SumOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal256Function {
    ...
    public static class Decimal256SumOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal256Function {
    ...
    static class Decimal256SumOverRangeFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal256Function {
    ...
    static class Decimal256SumOverRowsFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal256Function {
    ...
    static class Decimal256SumOverUnboundedPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal256Function {
    ...
    static class Decimal256SumOverUnboundedRowsFrameFunction extends BaseWindowFunction implements WindowDecimal256Function {
    ...
    static class Decimal256SumOverWholeResultSetFunction extends BaseWindowFunction implements WindowDecimal256Function {
    ...
    static class Decimal128SumOverCurrentRowFunction extends BaseWindowFunction implements WindowDecimal256Function {

        private final Decimal128 scratch = new Decimal128();
        private final int type;
        private final Decimal256 value = new Decimal256();

        Decimal128SumOverCurrentRowFunction(Function arg, int type) {
            super(arg);
            this.type = type;
        }
    ...
    static class Decimal128SumOverPartitionFunction extends BasePartitionedWindowFunction implements WindowDecimal256Function {
    ...
    public static class Decimal128SumOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal256Function {
    ...
    public static class Decimal128SumOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal256Function {
    ...
    static class Decimal128SumOverRangeFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal256Function {
    ...
    static class Decimal128SumOverRowsFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal256Function {
    ...
    static class Decimal128SumOverUnboundedPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal256Function {
    ...
    static class Decimal128SumOverUnboundedRowsFrameFunction extends BaseWindowFunction implements WindowDecimal256Function {
    ...
    static class Decimal128SumOverWholeResultSetFunction extends BaseWindowFunction implements WindowDecimal256Function {
        ...
        if (partitionByRecord != null) {
            if (framingMode == WindowExpression.FRAMING_RANGE) {
                ...
                if (rowsLo == Long.MIN_VALUE && rowsHi == 0) {
                    ...
                    return new Decimal128SumOverCurrentRowFunction(arg, outputType);
                } else if (rowsLo == Long.MIN_VALUE && rowsHi == Long.MAX_VALUE) {
                    Map map = MapFactory.createUnorderedMap(configuration, partitionByKeyTypes, SUM_DECIMAL128_TYPES);
                    return new Decimal128SumOverPartitionFunction(map, partitionByRecord, partitionBySink, arg, outputType, argPos);
                } else {
        ...
        if (partitionByRecord != null) {
            if (framingMode == WindowExpression.FRAMING_RANGE) {
                ...
                if (rowsLo == Long.MIN_VALUE && rowsHi == 0) {
                    ...
                    return new Decimal256SumOverCurrentRowFunction(arg, outputType);
                } else if (rowsLo == Long.MIN_VALUE && rowsHi == Long.MAX_VALUE) {
                    Map map = MapFactory.createUnorderedMap(configuration, partitionByKeyTypes, SUM_DECIMAL128_TYPES);
                    return new Decimal256SumOverPartitionFunction(map, partitionByRecord, partitionBySink, arg, outputType, argPos);
                } else {
    ...
    static class Decimal32SumOverCurrentRowFunction extends BaseWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal32SumOverPartitionFunction extends BasePartitionedWindowFunction implements WindowDecimal128Function {
    ...
    public static class Decimal32SumOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal128Function {
    ...
    public static class Decimal32SumOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal32SumOverRangeFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal128Function {
    ...
    static class Decimal32SumOverRowsFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal128Function {
    ...
    static class Decimal32SumOverUnboundedPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal32SumOverUnboundedRowsFrameFunction extends BaseWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal32SumOverWholeResultSetFunction extends BaseWindowFunction implements WindowDecimal128Function {
    ...
    static class Decimal16SumOverCurrentRowFunction extends BaseWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal16SumOverPartitionFunction extends BasePartitionedWindowFunction implements WindowDecimal64Function {
    ...
    public static class Decimal16SumOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal64Function {
    ...
    public static class Decimal16SumOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal16SumOverRangeFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal64Function {
    ...
    static class Decimal16SumOverRowsFrameFunction extends BaseWindowFunction implements Reopenable, WindowDecimal64Function {
    ...
    static class Decimal16SumOverUnboundedPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal16SumOverUnboundedRowsFrameFunction extends BaseWindowFunction implements WindowDecimal64Function {
    ...
    static class Decimal16SumOverWholeResultSetFunction extends BaseWindowFunction implements WindowDecimal64Function {
