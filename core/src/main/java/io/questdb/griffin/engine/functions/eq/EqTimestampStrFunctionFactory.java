...
//
//        public EqTimestampStrConstantFunction(int position, Function left, CharSequence right) throws SqlException, NumericException {
//            super(position);
//            this.left = left;
//            micros = parseFloorPartialDate(right);
//        }
//
//        @Override
//        public boolean getBool(Record rec) {
//            return negated != (left.getTimestamp(rec) == micros);
//        }
//
//        @Override
...
//            intervals.clear();
//            try {
//                parseFloorPartialDate(timestampAsString, right);
...
//    }
//
//    private static void (CharSequence seq, LongList out, int position) throws SqlException {
//
//    }
//}
