 ...
 */
class GtDoubleCursorFunction extends AbstractScalarCursorFunction {
    private final int cursorTag;
    private double value;

    GtDoubleCursorFunction(RecordCursorFactory factory, Function leftFunc, Function rightFunc, int cursorTag, int rightPos) {
    ...
    protected void donateValueTo(AbstractScalarCursorFunction that) {
        ((GtDoubleCursorFunction) that).value = value;
    }
