...
public class CharIndexZeroStartFunctionFactory implements FunctionFactory {

    private static final IntConstant NOT_FOUND = new IntConstant(0);
    private static final IntConstant DEFAULT_START = new IntConstant(1);
    ...
    public Function newInstance(
        ...
        return new CharIndexFunctionFactory.Func(substrFunc, strFunc, DEFAULT_START);
    }
}
