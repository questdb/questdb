...
public class MaxUInt32GroupByFunction extends UInt32Function implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private int valueIndex;

    public MaxUInt32GroupByFunction(@NotNull Function arg) {
        this.arg = arg;
    }
    ...
    public void merge(MapValue destValue, MapValue srcValue) {
        final long srcMax = srcValue.getLong(valueIndex);
        final long destMax = destValue.getLong(valueIndex);
        if (srcMax != Numbers.LONG_NULL && (srcMax > destMax || destMax == Numbers.LONG_NULL)) {
