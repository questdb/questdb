...
public class EarliestByAllFilteredRecordCursorFactory extends AbstractTreeSetRecordCursorFactory {
    private Function filter;

    public EarliestByAllFilteredRecordCursorFactory(
        ...
        try {
            ...
            if (filter == null) {
                ...
                cursor = new EarliestByAllFilteredRecordCursor(configuration, metadata, map, rows, recordSink, filter);
            }
        } catch (Throwable th) {
            close();
            throw th;
    ...
    public void toPlan(PlanSink sink) {
        sink.type("EarliestByAllFiltered");
        sink.child(cursor);
