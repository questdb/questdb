...
public class ToTimezoneStartTimestampFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "to_timezone_start(δS)";
    }
    ...
    private static class Func extends TimestampFunction implements BinaryFunction {
        ...
        public Func(Function intervalFunc, Function timezone) {
        ...
        public long getTimestamp(Record rec) {
            ...
            long timestampValue = intervalFunc.getInterval(rec).getLo();
            try {
