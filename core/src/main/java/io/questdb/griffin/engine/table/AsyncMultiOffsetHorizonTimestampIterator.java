 ...
 */
public class AsyncMultiOffsetHorizonTimestampIterator implements AsyncHorizonTimestampIterator {
    ...
    public AsyncMultiOffsetHorizonTimestampIterator(LongList offsets) {
