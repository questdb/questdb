...
public class SumDoubleVectorAggregateFunction extends DoubleFunction implements VectorAggregateFunction {
    ...
    public SumDoubleVectorAggregateFunction(int keyKind, int columnIndex, @SuppressWarnings("unused") int timestampIndex, int workerCount) {
    ...
    public void initRosti(long pRosti) {
        ...
        Unsafe.putDouble(Rosti.getInitialValueSlot(pRosti, this.valueOffset + 1), 0);
    }
