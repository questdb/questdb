...
public class RPadStrVarcharFunctionFactory implements FunctionFactory {
    ...
    public static class RPadVarcharFunc extends VarcharFunction implements TernaryFunction {
        ...
        public Utf8Sequence getVarcharA(final Record rec) {
            return rPadVarchar(strFunc.getVarcharA(rec), lenFunc.getInt(rec), fillTextFunc.getVarcharA(rec), sink);
        }
        ...
        public Utf8Sequence getVarcharB(final Record rec) {
            return rPadVarchar(strFunc.getVarcharA(rec), lenFunc.getInt(rec), fillTextFunc.getVarcharA(rec), sinkB);
        }
