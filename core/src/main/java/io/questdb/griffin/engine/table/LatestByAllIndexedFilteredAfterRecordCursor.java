...
class LatestByAllIndexedFilteredAfterRecordCursor extends LatestByAllIndexedRecordCursor {
    protected final Function filter; // where clause is applied after latest by

    public LatestByAllIndexedFilteredAfterRecordCursor(
            int columnIndex,
