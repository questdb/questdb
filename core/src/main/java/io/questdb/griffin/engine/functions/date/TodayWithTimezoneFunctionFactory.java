...
public class TodayWithTimezoneFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(int position, ObjList<Function> args, IntList argPositions, CairoConfiguration configuration, SqlExecutionContext sqlExecutionContext) {
        return new TodayWithTimezoneFunction(args.getQuick(0), sqlExecutionContext);
    }

    private static class TodayWithTimezoneFunction extends IntervalFunction implements Function {
        private final Interval interval = new Interval();
        private final Function timezone;
        private SqlExecutionContext context;

        public TodayWithTimezoneFunction(Function timezone, SqlExecutionContext context) {
