...
public class MultiApproxPercentileDoublePackedGroupByFunction extends ArrayFunction implements UnaryFunction, GroupByFunction {
    ...
    public MultiApproxPercentileDoublePackedGroupByFunction(Function exprFunc, Function percentileFunc, int precision, int percentilesPos) {
