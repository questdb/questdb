...
public class FirstValueDecimalWindowFunctionFactory extends AbstractWindowFunctionFactory {
    ...
    protected static final ArrayColumnTypes FIRST_VALUE_DECIMAL128_TYPES;
    protected static final ArrayColumnTypes FIRST_VALUE_DECIMAL16_TYPES;
    protected static final ArrayColumnTypes FIRST_VALUE_DECIMAL256_TYPES;
    protected static final ArrayColumnTypes FIRST_VALUE_DECIMAL32_TYPES;
    protected static final ArrayColumnTypes FIRST_VALUE_DECIMAL64_TYPES;
    protected static final ArrayColumnTypes FIRST_VALUE_DECIMAL8_TYPES;
    ...
    static class Decimal64FirstNotNullOverUnboundedPartitionRowsFrameFunction extends Decimal64FirstValueOverUnboundedPartitionRowsFrameFunction {
        ...
        public Decimal64FirstNotNullOverUnboundedPartitionRowsFrameFunction(Map map, VirtualRecord partitionByRecord, RecordSink partitionBySink, Function arg, int type) {
            super(map, partitionByRecord, partitionBySink, arg, type);
        }
    ...
    static class Decimal64FirstValueOverRowsFrameFunction extends BaseWindowFunction implements Reopenable {
        ...
        public void computeNext(Record record) {
            ...
            if (count == 0 && frameIncludesCurrentValue) {
                ...
                firstValue = buffer.getLong((long) (loIdx + bufferSize - count) % bufferSize * Long.BYTES);
            } else {
                firstValue = Decimals.DECIMAL64_NULL;
            }
    ...
    static class Decimal8FirstNotNullOverUnboundedPartitionRowsFrameFunction extends Decimal8FirstValueOverUnboundedPartitionRowsFrameFunction {
        ...
        public Decimal8FirstNotNullOverUnboundedPartitionRowsFrameFunction(Map map, VirtualRecord partitionByRecord, RecordSink partitionBySink, Function arg, int type) {
            super(map, partitionByRecord, partitionBySink, arg, type);
        }
    ...
    static class Decimal8FirstValueOverRowsFrameFunction extends BaseWindowFunction implements Reopenable {
        ...
        public void computeNext(Record record) {
            ...
            if (count == 0 && frameIncludesCurrentValue) {
                ...
                firstValue = buffer.getByte((long) (loIdx + bufferSize - count) % bufferSize * Byte.BYTES);
            } else {
                firstValue = Decimals.DECIMAL8_NULL;
            }
    ...
    static class Decimal16FirstNotNullOverUnboundedPartitionRowsFrameFunction extends Decimal16FirstValueOverUnboundedPartitionRowsFrameFunction {
        ...
        public Decimal16FirstNotNullOverUnboundedPartitionRowsFrameFunction(Map map, VirtualRecord partitionByRecord, RecordSink partitionBySink, Function arg, int type) {
            super(map, partitionByRecord, partitionBySink, arg, type);
        }
    ...
    static class Decimal16FirstValueOverRowsFrameFunction extends BaseWindowFunction implements Reopenable {
        ...
        public void computeNext(Record record) {
            ...
            if (count == 0 && frameIncludesCurrentValue) {
                ...
                firstValue = buffer.getShort((long) (loIdx + bufferSize - count) % bufferSize * Short.BYTES);
            } else {
                firstValue = Decimals.DECIMAL16_NULL;
            }
    ...
    static class Decimal32FirstNotNullOverUnboundedPartitionRowsFrameFunction extends Decimal32FirstValueOverUnboundedPartitionRowsFrameFunction {
        ...
        public Decimal32FirstNotNullOverUnboundedPartitionRowsFrameFunction(Map map, VirtualRecord partitionByRecord, RecordSink partitionBySink, Function arg, int type) {
            super(map, partitionByRecord, partitionBySink, arg, type);
        }
    ...
    static class Decimal32FirstValueOverRowsFrameFunction extends BaseWindowFunction implements Reopenable {
        ...
        public void computeNext(Record record) {
            ...
            if (count == 0 && frameIncludesCurrentValue) {
                ...
                firstValue = buffer.getInt((long) (loIdx + bufferSize - count) % bufferSize * Integer.BYTES);
            } else {
                firstValue = Decimals.DECIMAL32_NULL;
            }
    ...
    public static class Decimal128FirstNotNullOverPartitionRowsFrameFunction extends Decimal128FirstValueOverPartitionRowsFrameFunction {
        ...
        public void computeNext(Record record) {
            ...
            if (value.isNew()) {
                ...
                value.putLong(1, startOffset);
                for (int i = 0; i < bufferSize; i++) {
                    memory.putDecimal128(startOffset + (long) i * 16L, Decimals.DECIMAL128_HI_NULL, Decimals.DECIMAL128_LO_NULL);
                }
            } else {
                loIdx = value.getLong(0);
                startOffset = value.getLong(1);
            ...
            if (!frameLoBounded) {
                ...
                memory.getDecimal128(startOffset + loIdx * 16L, tmp);
                if (firstNotNullIdx != -1 && !tmp.isNull()) {
                    firstNotNullIdx = -1;
                }
                if (firstNotNullIdx != -1) {
                    memory.getDecimal128(startOffset + firstNotNullIdx * 16L, firstValue);
                } else {
                    boolean find = false;
                    for (int i = 0; i < frameSize; i++) {
                        memory.getDecimal128(startOffset + (loIdx + i) % bufferSize * 16L, tmp);
                        if (!tmp.isNull()) {
                            find = true;
                            firstNotNullIdx = (loIdx + i) % bufferSize;
    ...
    public static class Decimal128FirstNotNullOverRowsFrameFunction extends Decimal128FirstValueOverRowsFrameFunction implements Reopenable {
        ...
        public void computeNext(Record record) {
            ...
            if (!frameLoBounded) {
                ...
                buffer.getDecimal128((long) loIdx * 16L, scratchAlt);
                if (firstNotNullIdx != -1 && !scratchAlt.isNull()) {
                    firstNotNullIdx = -1;
                }
                if (firstNotNullIdx != -1) {
                    buffer.getDecimal128(firstNotNullIdx * 16L, firstValue);
                } else {
                    boolean find = false;
                    for (int i = 0; i < frameSize; i++) {
                        buffer.getDecimal128((long) (loIdx + i) % bufferSize * 16L, scratchAlt);
    ...
    static class Decimal128FirstNotNullOverUnboundedPartitionRowsFrameFunction extends Decimal128FirstValueOverUnboundedPartitionRowsFrameFunction {
        ...
        public Decimal128FirstNotNullOverUnboundedPartitionRowsFrameFunction(Map map, VirtualRecord partitionByRecord, RecordSink partitionBySink, Function arg, int type) {
            super(map, partitionByRecord, partitionBySink, arg, type);
        }
    ...
    public static class Decimal128FirstValueOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction {
        ...
        public void computeNext(Record record) {
            ...
            if (value.isNew()) {
                ...
                count = value.getLong(2);
                if (!frameLoBounded && count == bufferSize) {
                    memory.getDecimal128(startOffset + loIdx * 16L, firstValue);
                    return;
                }
            }
            ...
            if (count == 0 && frameIncludesCurrentValue) {
                ...
                memory.getDecimal128(startOffset + (loIdx + bufferSize - count) % bufferSize * 16L, firstValue);
            } else {
                firstValue.ofRawNull();
            }
    ...
    static class Decimal128FirstValueOverRowsFrameFunction extends BaseWindowFunction implements Reopenable {
        ...
        public void computeNext(Record record) {
            arg.getDecimal128(record, scratch);
            if (!frameLoBounded && count == bufferSize) {
                buffer.getDecimal128((long) loIdx * 16L, firstValue);
                return;
            }
            ...
            if (count == 0 && frameIncludesCurrentValue) {
                ...
                buffer.getDecimal128((long) (loIdx + bufferSize - count) % bufferSize * 16L, firstValue);
            } else {
                firstValue.ofRawNull();
            }
        ...
        private void initBuffer() {
            for (int i = 0; i < bufferSize; i++) {
                buffer.putDecimal128((long) i * 16L, Decimals.DECIMAL128_HI_NULL, Decimals.DECIMAL128_LO_NULL);
            }
        }
    }
    ...
    static class Decimal128FirstValueOverUnboundedPartitionRowsFrameFunction extends BasePartitionedWindowFunction {
        ...
        public Decimal128FirstValueOverUnboundedPartitionRowsFrameFunction(Map map, VirtualRecord partitionByRecord, RecordSink partitionBySink, Function arg, int type) {
            super(map, partitionByRecord, partitionBySink, arg);
            this.type = type;
        }
    ...
    public static class Decimal256FirstNotNullOverPartitionRowsFrameFunction extends Decimal256FirstValueOverPartitionRowsFrameFunction {
        ...
        public void computeNext(Record record) {
            ...
            if (value.isNew()) {
                ...
                value.putLong(1, startOffset);
                for (int i = 0; i < bufferSize; i++) {
                    memory.putDecimal256(startOffset + (long) i * 32L,
            ...
            if (!frameLoBounded) {
                ...
                memory.getDecimal256(startOffset + loIdx * 32L, scratchAlt);
                if (firstNotNullIdx != -1 && !scratchAlt.isNull()) {
                    firstNotNullIdx = -1;
                }
                if (firstNotNullIdx != -1) {
                    memory.getDecimal256(startOffset + firstNotNullIdx * 32L, firstValue);
                } else {
                    boolean find = false;
                    for (int i = 0; i < frameSize; i++) {
                        memory.getDecimal256(startOffset + (loIdx + i) % bufferSize * 32L, scratchAlt);
                        if (!scratchAlt.isNull()) {
                            find = true;
                            firstNotNullIdx = (loIdx + i) % bufferSize;
    ...
    public static class Decimal256FirstNotNullOverRowsFrameFunction extends Decimal256FirstValueOverRowsFrameFunction implements Reopenable {
        ...
        public void computeNext(Record record) {
            ...
            if (!frameLoBounded) {
                ...
                buffer.getDecimal256((long) loIdx * 32L, scratchAlt);
                if (firstNotNullIdx != -1 && !scratchAlt.isNull()) {
                    firstNotNullIdx = -1;
                }
                if (firstNotNullIdx != -1) {
                    buffer.getDecimal256(firstNotNullIdx * 32L, firstValue);
                } else {
                    boolean find = false;
                    for (int i = 0; i < frameSize; i++) {
                        buffer.getDecimal256((long) (loIdx + i) % bufferSize * 32L, scratchAlt);
                        if (!scratchAlt.isNull()) {
                            find = true;
                            firstNotNullIdx = (loIdx + i) % bufferSize;
                            firstValue.copyRaw(scratchAlt);
    ...
    static class Decimal256FirstNotNullOverUnboundedPartitionRowsFrameFunction extends Decimal256FirstValueOverUnboundedPartitionRowsFrameFunction {
        ...
        public Decimal256FirstNotNullOverUnboundedPartitionRowsFrameFunction(Map map, VirtualRecord partitionByRecord, RecordSink partitionBySink, Function arg, int type) {
            super(map, partitionByRecord, partitionBySink, arg, type);
        }
    ...
    public static class Decimal256FirstValueOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction {
        ...
        public void computeNext(Record record) {
            ...
            if (value.isNew()) {
                ...
                count = value.getLong(2);
                if (!frameLoBounded && count == bufferSize) {
                    memory.getDecimal256(startOffset + loIdx * 32L, firstValue);
                    return;
                }
            }
            ...
            if (count == 0 && frameIncludesCurrentValue) {
                ...
                memory.getDecimal256(startOffset + (loIdx + bufferSize - count) % bufferSize * 32L, firstValue);
            } else {
                firstValue.ofRawNull();
            }
    ...
    static class Decimal256FirstValueOverRowsFrameFunction extends BaseWindowFunction implements Reopenable {
        ...
        public void computeNext(Record record) {
            arg.getDecimal256(record, scratch);
            if (!frameLoBounded && count == bufferSize) {
                buffer.getDecimal256((long) loIdx * 32L, firstValue);
                return;
            }
            ...
            if (count == 0 && frameIncludesCurrentValue) {
                ...
                buffer.getDecimal256((long) (loIdx + bufferSize - count) % bufferSize * 32L, firstValue);
            } else {
                firstValue.ofRawNull();
            }
        ...
        private void initBuffer() {
            for (int i = 0; i < bufferSize; i++) {
                buffer.putDecimal256((long) i * 32L,
                        Decimals.DECIMAL256_HH_NULL, Decimals.DECIMAL256_HL_NULL,
                        Decimals.DECIMAL256_LH_NULL, Decimals.DECIMAL256_LL_NULL);
            }
        }
    ...
    static class Decimal256FirstValueOverUnboundedPartitionRowsFrameFunction extends BasePartitionedWindowFunction {
        ...
        public Decimal256FirstValueOverUnboundedPartitionRowsFrameFunction(Map map, VirtualRecord partitionByRecord, RecordSink partitionBySink, Function arg, int type) {
            super(map, partitionByRecord, partitionBySink, arg);
            this.type = type;
        }
