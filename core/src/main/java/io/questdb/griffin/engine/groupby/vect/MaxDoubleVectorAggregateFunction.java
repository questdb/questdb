...
public class MaxDoubleVectorAggregateFunction extends DoubleFunction implements VectorAggregateFunction {
    ...
    public Function deepClone() {
        return new MaxDoubleVectorAggregateFunction(columnIndex, keyValueFunc, distinctFunc);
    }

    private MaxDoubleVectorAggregateFunction(int columnIndex, KeyValueFunc keyValueFunc, DistinctFunc distinctFunc) {
        this.columnIndex = columnIndex;
