...
public class AvgUInt16VectorAggregateFunction extends DoubleFunction implements VectorAggregateFunction {
    ...
    public AvgUInt16VectorAggregateFunction(int keyKind, int columnIndex, int timestampIndex, int workerCount) {
    ...
    public void aggregate(long address, long frameRowCount, int workerId) {
        ...
        // Vect.sumShort() uses signed summation which is incorrect for unsigned values,
