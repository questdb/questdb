...
public class MinUInt32VectorAggregateFunction extends UInt32Function implements VectorAggregateFunction {
    ...
    public MinUInt32VectorAggregateFunction(int keyKind, int columnIndex, int timestampIndex, int workerCount) {
        ...
        if (keyKind == GKK_MICRO_HOUR_INT) {
            ...
            this.keyValueBitmapFunc = Rosti::keyedMicroHourMinUInt32BitmapNull;
            ...
            this.keyValueBitmapFunc = Rosti::keyedNanoHourMinUInt32BitmapNull;
        } else {
            this.distinctFunc = Rosti::keyedIntDistinct;
            this.keyValueFunc = Rosti::keyedIntMinInt;
            this.keyValueBitmapFunc = Rosti::keyedIntMinUInt32BitmapNull;
        }
    }
    ...
    public void aggregate(long address, long frameRowCount, int workerId) {
        ...
        // Vect.minInt() uses signed comparison which is incorrect for unsigned values,
    ...
    public void aggregate(long address, long bitmapAddr, long bitOffset, long frameRowCount, int workerId) {
        if (address != 0) {
            if (bitmapAddr != 0) {
                final long value = Vect.minUInt32BitmapNull(address, bitmapAddr, bitOffset, frameRowCount);
