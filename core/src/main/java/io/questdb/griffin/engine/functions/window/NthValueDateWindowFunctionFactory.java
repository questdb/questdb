...
public class NthValueDateWindowFunctionFactory extends AbstractWindowFunctionFactory {
    ...
    private static final String SIGNATURE = NAME + "(ML)";
    ...
    static class NthValueOverCurrentRowFunction extends BaseWindowFunction implements WindowDateFunction {
        ...
        public void computeNext(Record record) {
            value = n == 1 ? arg.getDate(record) : Numbers.LONG_NULL;
        }
    ...
    static class NthValueOverPartitionFunction extends BasePartitionedWindowFunction implements WindowDateFunction {
        ...
        public void pass1(Record record, long recordOffset, WindowSPI spi) {
            ...
            if (value.isNew()) {
                if (n == 1) {
                    value.putLong(0, arg.getDate(record));
                } else {
    ...
    // Removable cumulative aggregation with date & value stored in resizable ring buffers
    public static class NthValueOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowDateFunction {
        ...
        public void computeNext(Record record) {
            ...
            if (mapValue.isNew()) {
                ...
                if (frameLoBounded) {
                    ...
                    // previously-ineligible row whose date is now at least minDiff behind.
                    for (long i = frameSize; i < size; i++) {
                        long idx = (firstIdx + i) % capacity;
                        long ts = memory.getLong(startOffset + idx * RECORD_SIZE);
    ...
    public static class NthValueOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowDateFunction {
    ...
    public static class NthValueOverPartitionRowsFrameUnboundedFunction extends BasePartitionedWindowFunction implements WindowDateFunction {
    ...
    public static class NthValueOverRangeFrameFunction extends BaseWindowFunction implements Reopenable, WindowDateFunction {
        protected static final int RECORD_SIZE = 2 * Long.BYTES;
        protected final boolean frameIncludesCurrentValue;
        protected final boolean frameLoBounded;
        protected final LongList freeList = new LongList();
    ...
    // Removable cumulative aggregation.
    public static class NthValueOverRowsFrameFunction extends BaseWindowFunction implements Reopenable, WindowDateFunction {
    ...
    public static class NthValueOverRowsFrameUnboundedFunction extends BaseWindowFunction implements Reopenable, WindowDateFunction {
        protected final int bufferSize;
        protected final int n;
    ...
    static class NthValueOverUnboundedPartitionFrameFunction extends BasePartitionedWindowFunction implements WindowDateFunction {
    ...
    public static class NthValueOverUnboundedRowsFrameFunction extends BaseWindowFunction implements WindowDateFunction {
        protected final int n;
    ...
    public static class NthValueOverWholeResultSetFunction extends BaseWindowFunction implements WindowDateFunction {
        protected final int n;
        protected long count;
        protected boolean isFound;
        protected long value = Numbers.LONG_NULL;
    ...
    static {
        ...
        NTH_VALUE_COLUMN_TYPES.add(ColumnType.DATE);
