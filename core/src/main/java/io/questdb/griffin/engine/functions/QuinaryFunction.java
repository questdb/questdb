...
public interface QuinaryFunction extends Function {
    ...
    default void init(SymbolTableSource symbolTableSource, SqlExecutionContext executionContext) throws SqlException {
        ...
        getFunc4().init(symbolTableSource, executionContext);
    }
    ...
    default boolean isRuntimeConstant() {
        ...
        final boolean erc = getFunc4().isRuntimeConstant();
        ...
        final boolean ec = getFunc4().isConstant();

        return (ac || arc) && (bc || brc) && (cc || crc) && (dc || drc) && (ec || erc) && (arc || brc || crc || drc || erc);
    }
