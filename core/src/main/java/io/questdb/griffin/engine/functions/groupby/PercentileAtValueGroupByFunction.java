...
public class PercentileAtValueGroupByFunction extends DoubleFunction implements GroupByFunction, TernaryFunction {
    private final Function left;
    private final Function center;
    private final Function right;
    private Histogram histogram;

    public PercentileAtValueGroupByFunction(Function left, Function center, Function right) {
        this.left = left;
        this.center = center;
        this.right = right;
    }
    ...
    public double getDouble(Record rec) {
        ...
        return histogram.getPercentileAtOrBelowValue(center.getLong(rec));
    }
