...
class AvgDecimal64Rescale128GroupByFunction extends Decimal128Function implements GroupByFunction, UnaryFunction {
    ...
    public AvgDecimal64Rescale128GroupByFunction(@NotNull Function arg, int position, int targetType) {
        super(targetType);
        this.arg = arg;
