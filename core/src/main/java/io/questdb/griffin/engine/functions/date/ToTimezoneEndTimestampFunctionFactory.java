...
public class ToTimezoneEndTimestampFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "to_timezone_end(δS)";
    }
    ...
    private static class Func extends TimestampFunction implements BinaryFunction {
        ...
        public long getTimestamp(Record rec) {
            long timestampValue = intervalFunc.getInterval(rec).getHi();
            try {
