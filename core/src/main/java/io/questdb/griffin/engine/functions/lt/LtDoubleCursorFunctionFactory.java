...
public class LtDoubleCursorFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(
        ...
        switch (ColumnType.tagOf(metadataType)) {
            ...
            case ColumnType.NULL:
                return new LtDoubleCursorFunc(factory, arg0, args.getQuick(1), ColumnType.tagOf(metadataType));
            default:
    ...
    private static class LtDoubleCursorFunc extends NegatableBooleanFunction implements BinaryFunction {
        ...
        public LtDoubleCursorFunc(RecordCursorFactory factory, Function leftFunc, Function rightFunc, int cursorColumnTypeTag) {
