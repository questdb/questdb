 ...
 */
public class LtDoubleCursorFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(
        ...
        switch (ColumnType.tagOf(metadataType)) {
            ...
            case ColumnType.NULL:
                return new LtDoubleCursorFunc(factory, arg0, args.getQuick(1), ColumnType.tagOf(metadataType), argPositions.getQuick(1));
            default:
                throw SqlException.$(argPositions.getQuick(1), "cannot compare DOUBLE and ").put(ColumnType.nameOf(metadataType));
        }
    }

    private static class LtDoubleCursorFunc extends NegatableBooleanFunction implements BinaryFunction {
        ...
        public LtDoubleCursorFunc(RecordCursorFactory factory, Function leftFunc, Function rightFunc, int cursorColumnTypeTag, int rightPos) {
        ...
        public void offerStateTo(Function that) {
            if (that instanceof LtDoubleCursorFunc thatF) {
                thatF.value = value;
