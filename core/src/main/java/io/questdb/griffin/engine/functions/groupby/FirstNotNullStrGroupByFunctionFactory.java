...
public class FirstNotNullStrGroupByFunctionFactory implements FunctionFactory {
    ...
    /**
     * Wraps {@link FirstNotNullDirectStrGroupByFunction} and {@link FirstNotNullStrGroupByFunction} depending
    ...
    public class Func extends StrFunction implements GroupByFunction, UnaryFunction {
        ...
        private void initDelegate(boolean directStrSupported) {
            ...
            if (directStrSupported && arg.supportsDirectStr()) {
                delegate = new FirstNotNullDirectStrGroupByFunction(arg);
            } else {
                delegate = new FirstNotNullStrGroupByFunction(arg);
            }
        }
    }
}
