...
public class CountLongVectorAggregateFunction extends AbstractCountVectorAggregateFunction {
    ...
    public Function deepClone() {
        return new CountLongVectorAggregateFunction(keyValueFunc, distinctFunc, getColumnIndex());
    }

    private CountLongVectorAggregateFunction(KeyValueFunc keyValueFunc, DistinctFunc distinctFunc, int columnIndex) {
        super(columnIndex);
