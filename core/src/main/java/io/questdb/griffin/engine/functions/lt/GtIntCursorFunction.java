 ...
 */
class GtIntCursorFunction extends AbstractScalarCursorFunction {
    private final int cursorTag;
    private int value;

    GtIntCursorFunction(RecordCursorFactory factory, Function leftFunc, Function rightFunc, int cursorTag, int rightPos) {
    ...
    protected void donateValueTo(AbstractScalarCursorFunction that) {
        ((GtIntCursorFunction) that).value = value;
    }
