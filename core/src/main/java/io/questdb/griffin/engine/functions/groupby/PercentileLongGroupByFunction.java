...
public class PercentileLongGroupByFunction extends LongFunction implements UnaryFunction, GroupByFunction {
    ...
    public PercentileLongGroupByFunction(@NotNull CairoConfiguration configuration, @NotNull Function arg, @NotNull Function percentileFunc) {
        this.arg = arg;
