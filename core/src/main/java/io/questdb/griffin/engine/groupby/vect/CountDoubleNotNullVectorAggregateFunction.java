 ...
 */
public class CountDoubleNotNullVectorAggregateFunction extends CountDoubleVectorAggregateFunction {

    public CountDoubleNotNullVectorAggregateFunction(int keyKind, int columnIndex, int timestampIndex, int workerCount) {
