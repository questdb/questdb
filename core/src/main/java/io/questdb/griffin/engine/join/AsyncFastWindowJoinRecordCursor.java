...
class AsyncFastWindowJoinRecordCursor implements NoRandomAccessRecordCursor {
    ...
    private PageFrameSequence<AsyncFastWindowJoinAtom> masterFrameSequence;
    private TablePageFrameCursor slaveFrameCursor;
    private long valueSizeBytes;

    public AsyncFastWindowJoinRecordCursor(
    ...
    void of(
            PageFrameSequence<AsyncFastWindowJoinAtom> masterFrameSequence,
        ...
        final AsyncFastWindowJoinAtom atom = masterFrameSequence.getAtom();
