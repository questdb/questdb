...
public class MaxIntVectorAggregateFunction extends IntFunction implements VectorAggregateFunction {
    ...
    public Function deepClone() {
        return new MaxIntVectorAggregateFunction(columnIndex, keyValueFunc, distinctFunc);
    }

    private MaxIntVectorAggregateFunction(int columnIndex, KeyValueFunc keyValueFunc, DistinctFunc distinctFunc) {
        this.columnIndex = columnIndex;
