...
public class ToTimezoneTimestampFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(
        ...
        if (timezoneFunc.isConstant()) {
            return getTimestampFunction(argPositions, timestampFunc, timezoneFunc, 1);
    ...
    private static class RuntimeConstFunc extends TimestampFunction implements BinaryFunction {
        ...
        public RuntimeConstFunc(Function timestampFunc, Function timezoneFunc, int timezonePosition) {
            this.timestampFunc = timestampFunc;
            this.timezoneFunc = timezoneFunc;
        ...
        public void init(SymbolTableSource symbolTableSource, SqlExecutionContext executionContext) throws SqlException {
            ...
            if (tz == null) {
                throw SqlException.$(timezonePosition, "timezone must not be null");
            }
            ...
            if (l == Long.MIN_VALUE) {
                try {
                    ...
                    throw SqlException.$(timezonePosition, "invalid timezone: ").put(tz);
                }
            } else {
