...
class EarliestByValuesIndexedRecordCursor extends AbstractPageFrameRecordCursor {
    ...
    public EarliestByValuesIndexedRecordCursor(
    ...
    // LatestByValuesIndexedRecordCursor, which has the same dead pair.
    @Override
