 ...
 */
class LtLongCursorFunction extends AbstractScalarCursorFunction {
    private final int cursorTag;
    private long value;

    LtLongCursorFunction(RecordCursorFactory factory, Function leftFunc, Function rightFunc, int cursorTag, int rightPos) {
    ...
    protected void donateValueTo(AbstractScalarCursorFunction that) {
        ((LtLongCursorFunction) that).value = value;
    }
