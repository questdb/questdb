...
public class AvgUInt32VectorAggregateFunction extends DoubleFunction implements VectorAggregateFunction {
    ...
    public AvgUInt32VectorAggregateFunction(int keyKind, int columnIndex, int timestampIndex, int workerCount) {
    ...
    public void aggregate(long address, long frameRowCount, int workerId) {
        ...
        // Vect.sumInt() uses signed summation which is incorrect for unsigned values,
