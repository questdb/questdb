...
class AvgDecimal16Rescale64GroupByFunction extends Decimal64Function implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private final Decimal64 decimal64A = new Decimal64();
    private final int position;
    private int valueIndex;

    public AvgDecimal16Rescale64GroupByFunction(@NotNull Function arg, int position, int targetType) {
        super(targetType);
        this.arg = arg;
