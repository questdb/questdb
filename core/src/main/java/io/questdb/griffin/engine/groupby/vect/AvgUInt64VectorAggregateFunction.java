...
public class AvgUInt64VectorAggregateFunction extends DoubleFunction implements VectorAggregateFunction {
    ...
    public AvgUInt64VectorAggregateFunction(int keyKind, int columnIndex, int timestampIndex, int workerCount) {
    ...
    public void aggregate(long address, long frameRowCount, int workerId) {
        ...
        // Vect.sumLong() uses signed summation which is incorrect for unsigned values,
