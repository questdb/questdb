...
public class SingleShotVwapDoubleGroupByFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(int position, ObjList<Function> args, IntList argPositions, CairoConfiguration configuration, SqlExecutionContext sqlExecutionContext) {
        return new SingleShotVwapDoubleGroupByFunction(args.getQuick(0), args.getQuick(1));
    }

    private static class SingleShotVwapDoubleGroupByFunction extends DoubleFunction implements GroupByFunction, BinaryFunction {
        private final Function priceFunction;
        private final Function volumeFunction;
        private int valueIndex;

        public SingleShotVwapDoubleGroupByFunction(@NotNull Function arg0, @NotNull Function arg1) {
