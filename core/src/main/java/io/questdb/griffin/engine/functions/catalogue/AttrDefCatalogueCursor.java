...
class AttrDefCatalogueCursor implements NoRandomAccessRecordCursor {

    static final RecordMetadata METADATA;
    private static final AttrDefCatalogueRecord record = new AttrDefCatalogueRecord();
    ...
    private static class AttrDefCatalogueRecord implements Record {
    }
