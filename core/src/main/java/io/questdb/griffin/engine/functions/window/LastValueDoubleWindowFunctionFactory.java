...
public class LastValueDoubleWindowFunctionFactory extends AbstractWindowFunctionFactory {
    ...
    static class LastValueOverPartitionFunction extends BasePartitionedDoubleWindowFunction {
    ...
    public static class LastValueOverPartitionRangeFrameFunction extends BasePartitionedDoubleWindowFunction {
    ...
    public static class LastValueOverPartitionRowsFrameFunction extends BasePartitionedDoubleWindowFunction {
    ...
    public static class LastValueOverRangeFrameFunction extends BaseDoubleWindowFunction implements Reopenable {
        protected static final int RECORD_SIZE = Long.BYTES + Double.BYTES;
    ...
    // Removable cumulative aggregation.
    public static class LastValueOverRowsFrameFunction extends BaseDoubleWindowFunction implements Reopenable {
    ...
    public static class LastValueOverWholeResultSetFunction extends BaseDoubleWindowFunction {
