...
public class FirstStrGroupByFunctionFactory implements FunctionFactory {
    ...
    /**
     * Wraps {@link FirstDirectStrGroupByFunction} and {@link FirstStrGroupByFunction} depending
    ...
    public class Func extends StrFunction implements GroupByFunction, UnaryFunction {
        ...
        private void initDelegate(boolean directStrSupported) {
            ...
            if (directStrSupported && arg.supportsDirectStr()) {
                delegate = new FirstDirectStrGroupByFunction(arg);
            } else {
                delegate = new FirstStrGroupByFunction(arg);
            }
        }
    }
}
