...
public class NthValueLongWindowFunctionFactory extends AbstractWindowFunctionFactory {
    ...
    static class NthValueOverPartitionFunction extends BasePartitionedWindowFunction implements WindowLongFunction {
        ...
        public void pass2(Record record, long recordOffset, WindowSPI spi) {
            ...
            assert value != null;
            Unsafe.getUnsafe().putLong(spi.getAddress(recordOffset, columnIndex), value.getLong(0));
        }
    ...
    public static class NthValueOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowLongFunction {
        ...
        public void pass1(Record record, long recordOffset, WindowSPI spi) {
            computeNext(record);
            Unsafe.getUnsafe().putLong(spi.getAddress(recordOffset, columnIndex), nthValue);
        }
    ...
    static {
        ...
        NTH_VALUE_COLUMN_TYPES.add(ColumnType.LONG);
