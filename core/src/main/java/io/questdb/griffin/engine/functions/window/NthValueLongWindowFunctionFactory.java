 ...
 */
public class NthValueLongWindowFunctionFactory extends AbstractWindowFunctionFactory {
    ...
    static class NthValueOverCurrentRowFunction extends BaseWindowFunction implements WindowLongFunction {
        ...
        public void computeNext(Record record) {
            value = n == 1 ? arg.getLong(record) : Numbers.LONG_NULL;
        }
    ...
    static class NthValueOverPartitionFunction extends BasePartitionedWindowFunction implements WindowLongFunction {
        ...
        public void pass1(Record record, long recordOffset, WindowSPI spi) {
            ...
            if (value.isNew()) {
                if (n == 1) {
                    value.putLong(0, arg.getLong(record));
                } else {
    ...
    public static class NthValueOverPartitionRangeFrameFunction extends BasePartitionedWindowFunction implements WindowLongFunction {
        ...
        // compactPartitionMap (slabs of tombstoned partitions). expandRingBuffer
            ...
            try {
                ...
                while (cursor.hasNext()) {
                    ...
                    if (srcValue.getByte(tombstoneValueIndex) == 1) {
                        ...
                        // expandRingBuffer can reuse it on a future grow. Slot
                        // 3 is the per-partition capacity (bounded RANGE rings
                        // grow on demand); slot 1 is the start offset.
    ...
    public static class NthValueOverPartitionRowsFrameFunction extends BasePartitionedWindowFunction implements WindowLongFunction {
    ...
    public static class NthValueOverPartitionRowsFrameUnboundedFunction extends BasePartitionedWindowFunction implements WindowLongFunction {
    ...
    public static class NthValueOverRangeFrameFunction extends BaseWindowFunction implements Reopenable, WindowLongFunction {
        protected static final int RECORD_SIZE = 2 * Long.BYTES;
        protected final boolean frameIncludesCurrentValue;
        protected final boolean frameLoBounded;
        protected final LongList freeList = new LongList();
    ...
    // Removable cumulative aggregation.
    public static class NthValueOverRowsFrameFunction extends BaseWindowFunction implements Reopenable, WindowLongFunction {
    ...
    public static class NthValueOverRowsFrameUnboundedFunction extends BaseWindowFunction implements Reopenable, WindowLongFunction {
        protected final int bufferSize;
        protected final int n;
    ...
    static class NthValueOverUnboundedPartitionFrameFunction extends BasePartitionedWindowFunction implements WindowLongFunction {
    ...
    public static class NthValueOverUnboundedRowsFrameFunction extends BaseWindowFunction implements WindowLongFunction {
        protected final int n;
    ...
    public static class NthValueOverWholeResultSetFunction extends BaseWindowFunction implements WindowLongFunction {
        protected final int n;
        protected long count;
        protected boolean isFound;
        protected long value = Numbers.LONG_NULL;
    ...
    static {
        ...
        NTH_VALUE_COLUMN_TYPES.add(ColumnType.LONG); // captured value
        NTH_VALUE_COLUMN_TYPES.add(ColumnType.LONG); // row count within partition

        NTH_VALUE_COLUMN_TYPES_LV = new ArrayColumnTypes();
        NTH_VALUE_COLUMN_TYPES_LV.add(ColumnType.LONG); // captured value
