...
public class MaxDateVectorAggregateFunction extends DateFunction implements VectorAggregateFunction {
    ...
    public Function deepClone() {
        return new MaxDateVectorAggregateFunction(columnIndex, keyValueFunc, distinctFunc);
    }

    private MaxDateVectorAggregateFunction(int columnIndex, KeyValueFunc keyValueFunc, DistinctFunc distinctFunc) {
        this.columnIndex = columnIndex;
