...
public class TimestampIntervalConstant extends StrFunction implements ConstantFunction {
    public static final StrConstant NULL = new StrConstant(0, null);

    private final String value;
    private final int length;

    public TimestampIntervalConstant(int position, CharSequence value) {
        super(position);
        if (value == null) {
            this.value = null;
