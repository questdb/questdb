 ...
 * {@link io.questdb.griffin.engine.join.IntHashJoinBuild}'s payload references. The {@code +1} bias
 * reserves zero for an empty slot, distinguishing this encoding from the aligned pairs above.
 * Tests can pin its unsigned and sentinel boundaries without allocating a 16GB heap.
 */
