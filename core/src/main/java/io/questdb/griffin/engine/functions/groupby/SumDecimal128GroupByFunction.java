        ...
        if (!srcOverflow && !destOverflow) {
            ...
            if (!destNull && !srcNull) {
                ...
                try {
                    ...
                    decimal256A.addSameScaleNoMaxValueCheck(0, 0, decimal128A.getHigh(), decimal128A.getLow());
                    decimal256A.addSameScaleNoMaxValueCheck(0, 0, decimal128B.getHigh(), decimal128B.getLow());
