...
public class ApproxVarSampleGroupByFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "approx_var_samp(D)";
    }
    ...
    public Function newInstance(int position, ObjList<Function> args, IntList argPositions, CairoConfiguration configuration, SqlExecutionContext sqlExecutionContext) {
        return new ApproxVarSampleGroupByFunction(args.getQuick(0));
    }

    public static class ApproxVarSampleGroupByFunction extends AbstractStdDevGroupByFunction {

        public ApproxVarSampleGroupByFunction(@NotNull Function arg) {
            super(arg);
        }
