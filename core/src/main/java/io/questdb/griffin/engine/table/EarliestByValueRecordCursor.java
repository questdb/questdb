...
class EarliestByValueRecordCursor extends AbstractLatestByValueRecordCursor {

    public EarliestByValueRecordCursor(
    ...
    private void findRecord() {
        ...
        while ((frame = frameCursor.next()) != null) {
            ...
            final long rowCount = partitionHi - partitionLo;
