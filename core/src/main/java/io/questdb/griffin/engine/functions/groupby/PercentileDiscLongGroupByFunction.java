...
public class PercentileDiscLongGroupByFunction extends LongFunction implements UnaryFunction, GroupByFunction {
    private final Function arg;
    private final GroupByLongList listA;
    private final GroupByLongList listB;
    private final Function percentileFunc;
    private final int percentilePos;
    private int valueIndex;

    public PercentileDiscLongGroupByFunction(@NotNull CairoConfiguration configuration, @NotNull Function arg, @NotNull Function percentileFunc, int percentilePos) {
        this.arg = arg;
        this.percentileFunc = percentileFunc;
        int initialCapacity = 4;
        listA = new GroupByLongList(initialCapacity, LONG_NULL);
        listB = new GroupByLongList(initialCapacity, LONG_NULL);
