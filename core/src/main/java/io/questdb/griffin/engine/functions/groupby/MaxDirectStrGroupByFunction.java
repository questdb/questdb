...
public class MaxDirectStrGroupByFunction extends StrFunction implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private final DirectString viewA = new DirectString();
    private final DirectString viewB = new DirectString();
    private int valueIndex;

    public MaxDirectStrGroupByFunction(@NotNull Function arg) {
        this.arg = arg;
    }
