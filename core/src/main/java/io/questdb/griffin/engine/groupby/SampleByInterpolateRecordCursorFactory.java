...
public class SampleByInterpolateRecordCursorFactory extends AbstractRecordCursorFactory {
    ...
    public SampleByInterpolateRecordCursorFactory(
        ...
        try {
            ...
            this.mapSink = RecordSinkFactory.getInstance(asm, base.getMetadata(), listColumnFilter, configuration.isCopierChunkedEnabled());
            entityColumnFilter.of(keyTypes.getColumnCount());
            this.mapSink2 = RecordSinkFactory.getInstance(asm, keyTypes, entityColumnFilter, configuration.isCopierChunkedEnabled());
