...
public class JsonPathIntFunctionFactory implements FunctionFactory {
    private static final String FUNCTION_NAME = "json_path_int";
    ...
    public Function newInstance(int position, ObjList<Function> args, IntList argPositions, CairoConfiguration configuration, SqlExecutionContext sqlExecutionContext) throws SqlException {
        ...
        return new JsonConstPathPrimitiveFunc(ColumnType.INT, FUNCTION_NAME, json, path, pointer, false);
    }
}
