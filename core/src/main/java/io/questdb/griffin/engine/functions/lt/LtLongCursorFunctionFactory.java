 ...
 */
public class LtLongCursorFunctionFactory extends AbstractLongCursorFunctionFactory {
    ...
    protected Function newLongFunc(RecordCursorFactory factory, Function leftFunc, Function rightFunc, int cursorTag, int rightPos) {
        return new LtLongCursorFunction(factory, leftFunc, rightFunc, cursorTag, rightPos);
    }
}
