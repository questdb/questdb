...
public class LagLongFunctionFactory extends AbstractWindowFunctionFactory {
    ...
    public Function newInstance(
        ...
        return LeadLagWindowFunctionFactoryHelper.newInstance(
                ...
                sqlExecutionContext,
                (defaultValue) -> {
                    if (!(defaultValue instanceof LongFunction || defaultValue instanceof ByteFunction
                            || defaultValue instanceof CharFunction || defaultValue instanceof ShortFunction
                            || defaultValue instanceof IntFunction || defaultValue instanceof DoubleFunction
