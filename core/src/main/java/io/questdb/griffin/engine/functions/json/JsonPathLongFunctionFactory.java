...
public class JsonPathLongFunctionFactory implements FunctionFactory {
    private static final String FUNCTION_NAME = "json_path_long";
    ...
    public Function newInstance(int position, ObjList<Function> args, IntList argPositions, CairoConfiguration configuration, SqlExecutionContext sqlExecutionContext) throws SqlException {
        ...
        return new JsonConstPathPrimitiveFunc(ColumnType.LONG, FUNCTION_NAME, json, path, pointer, false);
    }
}
