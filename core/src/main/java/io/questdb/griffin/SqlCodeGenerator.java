...
public class SqlCodeGenerator implements Mutable, Closeable {
    ...
    private RecordCursorFactory generateFill(QueryModel model, RecordCursorFactory groupByFactory, SqlExecutionContext executionContext, IntList fillKeyColumnPositions) throws SqlException {
        // locate fill
