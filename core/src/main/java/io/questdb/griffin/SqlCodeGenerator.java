...
public class SqlCodeGenerator implements Mutable, Closeable {
    ...
    private static final int[][] UNION_CAST_MATRIX = new int[][]{
            ...
            {11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, -1, -1, -1, -1, 11, 11, 11, 11, 11, 11, 11, 25, 11, 11, 11, 11, 11, 11, 11, 11}, // 11 = STRING
            ...
            {11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 25, 11, 11, -1, -1, -1, -1, 11, 11, 11, 11, 11, 11, 11, 25, 26, 11, 11, 11, 11, 11, 11, 25}, // 25 = IPv4
    ...
    public static int getUnionCastType(int typeA, int typeB) {
        ...
        final boolean aIsArray = tagA == ColumnType.ND_ARRAY;
        final boolean bIsArray = tagB == ColumnType.ND_ARRAY;
        if (aIsArray && bIsArray) {
            return ColumnType.getNdArrayCommonWideningType(typeA, typeB);
            ...
            final int promotedArrayType = ColumnType.buildNdArrayTypeFromScalar(otherType);
            if (promotedArrayType == -1) {
                return ColumnType.VARCHAR;  // stringify, as last resort.
            }
            return ColumnType.getNdArrayCommonWideningType(arrayType, promotedArrayType);
        }
    ...
    private static int castToType(int typeA, int typeB) {
        return (typeA == typeB && typeA != ColumnType.SYMBOL) ? typeA
                ...
                // As a special (possibly undesirable) case, A union between IPv4 and STRING results in an IPv4 col
                : ((typeA == ColumnType.IPv4) && (typeB == ColumnType.STRING)) ? ColumnType.IPv4
                : ((typeB == ColumnType.IPv4) && (typeA == ColumnType.STRING)) ? ColumnType.IPv4
