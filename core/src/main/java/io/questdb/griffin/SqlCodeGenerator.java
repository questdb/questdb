...
public class SqlCodeGenerator implements Mutable, Closeable {
     ...
     * in a set operation (UNION etc.), providing the desired output type. It is
     * {@link #expectedUnionCastMatrix()}, computed once from {@link ColumnType#commonWideningType}
     * over every tag pair; {@code TypeRelationGoldenTest.testUnionCastType} pins the result.
     * The matrix doesn't cover generic types (e.g. geohash) since they have a more complex structure.
     */
    private static final int[][] UNION_CAST_MATRIX = expectedUnionCastMatrix();
