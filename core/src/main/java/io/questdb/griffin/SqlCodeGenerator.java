...
public class SqlCodeGenerator implements Mutable, Closeable {
    ...
    private static long tolerance(QueryModel slaveModel, int leftTimestamp, int rightTimestampType) throws SqlException {
        ...
        if (tolerance != null) {
            ...
            switch (unit) {
                case 'n':
                    toleranceInterval = TimestampSamplerFactory.parseInterval(tolerance.token, k, tolerance.position, "tolerance", Long.MAX_VALUE, unit);
            ...
            long maxValue = Long.MAX_VALUE / multiplier;// not sure
