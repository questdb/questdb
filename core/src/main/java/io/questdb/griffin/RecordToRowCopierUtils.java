...
public class RecordToRowCopierUtils {
    ...
    public static void transferVarcharToDecimalCol(TableWriter.Row row, int col, Utf8Sequence seq) {
        row.putDecimalStr(col, seq != null ? seq.asAsciiCharSequence() : null);
    }
    ...
    private static RecordToRowCopier generateChunkedCopier(
        ...
        int transferVarcharToDecimalCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferVarcharToDecimalCol", "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/str/Utf8Sequence;)V");
                ...
                switch (fromColumnTypeTag) {
                    ...
                    case ColumnType.VARCHAR:
                        switch (toColumnTypeTag) {
                            ...
                            case ColumnType.DECIMAL256:
                                asm.invokeInterface(rGetVarchar);
                                asm.invokeStatic(transferVarcharToDecimalCol);
                                break;
                            default:
                                assert false;
                        }
