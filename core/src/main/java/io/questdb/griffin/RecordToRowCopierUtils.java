...
public class RecordToRowCopierUtils {
    ...
    // - aload: 1-2 bytes, iconst: 1-3 bytes, invokeInterface: 5 bytes,
    // invokeStatic: 3 bytes
    // Simple column copy: aload(3) + iconst + aload(2) + iconst + invokeInterface +
    // invokeInterface = ~16 bytes
    ...
    // Creates data type converter. If the generated bytecode exceeds the method
    // size limit,
    // falls back to a loop-based implementation to avoid JVM optimization cliffs.
    // When chunkedEnabled is true and size exceeds limit, uses chunked bytecode
    // generation.
    public static RecordToRowCopier generateCopier(
            BytecodeAssembler asm,
            @Transient ColumnTypes fromTypes,
        ...
        switch (copierType) {
            ...
            case COPIER_TYPE_CHUNKED:
                RecordToRowCopier chunked = generateChunkedCopier(asm, fromTypes, toMetadata, toColumnFilter,
                        methodSizeLimit);
                if (chunked != null) {
                    return chunked;
                }
                // Fall through to looping if chunked fails
                LOG.info().$("forced chunked copier generation failed, falling back to looping copier [columnCount=")
                        .$(toColumnFilter.getColumnCount()).I$();
        ...
        if (configuration.isCopierChunkedEnabled()) {
            RecordToRowCopier chunkedCopier = generateChunkedCopier(asm, fromTypes, toMetadata, toColumnFilter,
                    methodSizeLimit);
            if (chunkedCopier != null) {
                return chunkedCopier;
            }
            // Fall through to loop if chunking failed
            LOG.info().$("chunked copier generation failed, falling back to looping copier [columnCount=")
                    .$(toColumnFilter.getColumnCount())
    ...
    public static void transferByteToDecimal(TableWriter.Row row, int col, byte value, Decimal256 decimal256,
            int toType) {
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferDecimal128(TableWriter.Row row, int col, Decimal256 decimal256, int fromType, int toType,
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferDecimal16(TableWriter.Row row, int col, Decimal256 decimal256, int fromType, int toType,
            short value) {
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferDecimal256(TableWriter.Row row, int col, Decimal256 decimal256, int fromType,
            int toType) {
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferDecimal32(TableWriter.Row row, int col, Decimal256 decimal256, int fromType, int toType,
            int value) {
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferDecimal64(TableWriter.Row row, int col, Decimal256 decimal256, int fromType, int toType,
            long value) {
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferDecimal8(TableWriter.Row row, int col, Decimal256 decimal256, int fromType, int toType,
            byte value) {
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferIntToDecimal(TableWriter.Row row, int col, int value, Decimal256 decimal256,
            int toType) {
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferLongToDecimal(TableWriter.Row row, int col, long value, Decimal256 decimal256,
            int toType) {
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void transferShortToDecimal(TableWriter.Row row, int col, short value, Decimal256 decimal256,
            int toType) {
        decimal256.ofLong(value, 0);
    ...
    @SuppressWarnings("unused")
    // Called from dynamically generated bytecode
    public static void validateArrayDimensionsAndTransferCol(TableWriter.Row row, int col, DoubleArrayParser parser,
            CharSequence str, int expectedType) {
        if (str == null) {
            return;
        }
    ...
    @SuppressWarnings("unused")
    public static void validateArrayDimensionsAndTransferCol(TableWriter.Row row, int col, DoubleArrayParser parser,
            Utf8Sequence vch, int expectedType) {
        if (vch == null) {
            return;
        }
     ...
     * Returns a list where consecutive pairs [boundaries.get(i),
     * boundaries.get(i+1))
     ...
     * This should be kept in sync with the actual bytecode generation in
     * generateSingleMethodCopier.
     */
    private static int estimateColumnBytecodeSize(int fromType, int toType) {
        ...
        // Complex types need more bytecode due to extra method calls and stack
        // manipulation
        switch (fromTag) {
        ...
        switch (toTag) {
            ...
            case ColumnType.DECIMAL256:
                ...
                break;
            // ARRAY target type needs parser field access: aload(0) + getfield + extra
            // stack setup
    ...
    private static RecordToRowCopier generateChunkedCopier(
        ...
        int sGetDecimal128 = asm.poolInterfaceMethod(SqlExecutionContext.class, "getDecimal128",
                "()Lio/questdb/std/Decimal128;");
        int sGetDecimal256 = asm.poolInterfaceMethod(SqlExecutionContext.class, "getDecimal256",
                "()Lio/questdb/std/Decimal256;");
        ...
        int wPutLong256Utf8 = asm.poolInterfaceMethod(TableWriter.Row.class, "putLong256Utf8",
                "(ILio/questdb/std/str/DirectUtf8Sequence;)V");
        ...
        int wPutUuidUtf8 = asm.poolInterfaceMethod(TableWriter.Row.class, "putUuidUtf8",
                "(ILio/questdb/std/str/Utf8Sequence;)V");
        ...
        int wPutGeoVarchar = asm.poolInterfaceMethod(TableWriter.Row.class, "putGeoVarchar",
                "(ILio/questdb/std/str/Utf8Sequence;)V");
        int wPutVarchar = asm.poolInterfaceMethod(TableWriter.Row.class, "putVarchar",
                "(ILio/questdb/std/str/Utf8Sequence;)V");
        int wPutArray = asm.poolInterfaceMethod(TableWriter.Row.class, "putArray",
                "(ILio/questdb/cairo/arr/ArrayView;)V");
        int wPutDecimalStr = asm.poolInterfaceMethod(TableWriter.Row.class, "putDecimalStr",
        ...
        int implicitCastStrAsFloat = asm.poolMethod(SqlUtil.class, "implicitCastStrAsFloat",
                "(Ljava/lang/CharSequence;)F");
        int implicitCastStrAsDouble = asm.poolMethod(SqlUtil.class, "implicitCastStrAsDouble",
                "(Ljava/lang/CharSequence;)D");
        int implicitCastStrAsByte = asm.poolMethod(SqlUtil.class, "implicitCastStrAsByte",
                "(Ljava/lang/CharSequence;)B");
        int implicitCastStrAsShort = asm.poolMethod(SqlUtil.class, "implicitCastStrAsShort",
                "(Ljava/lang/CharSequence;)S");
        int implicitCastStrAsChar = asm.poolMethod(SqlUtil.class, "implicitCastStrAsChar",
        ...
        int implicitCastStrAsIPv4 = asm.poolMethod(SqlUtil.class, "implicitCastStrAsIPv4",
                "(Ljava/lang/CharSequence;)I");
        int implicitCastUtf8StrAsIPv4 = asm.poolMethod(SqlUtil.class, "implicitCastStrAsIPv4",
                "(Lio/questdb/std/str/Utf8Sequence;)I");
        int implicitCastStrAsLong = asm.poolMethod(SqlUtil.class, "implicitCastStrAsLong",
                "(Ljava/lang/CharSequence;)J");
        int implicitCastStrAsLong256 = asm.poolMethod(SqlUtil.class, "implicitCastStrAsLong256",
                "(Ljava/lang/CharSequence;)Lio/questdb/griffin/engine/functions/constants/Long256Constant;");
        int implicitCastStrAsDate = asm.poolMethod(SqlUtil.class, "implicitCastStrAsDate",
                "(Ljava/lang/CharSequence;)J");
        int implicitCastStrAsTimestamp = asm.poolInterfaceMethod(TimestampDriver.class, "implicitCast",
                "(Ljava/lang/CharSequence;)J");
        ...
        int transferByteToStrCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferByteToStrCol",
                "(Lio/questdb/cairo/TableWriter$Row;IB)V");
        int transferShortToStrCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferShortToStrCol",
                "(Lio/questdb/cairo/TableWriter$Row;IS)V");
        int transferIntToStrCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferIntToStrCol",
                "(Lio/questdb/cairo/TableWriter$Row;II)V");
        int transferLongToStrCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferLongToStrCol",
                "(Lio/questdb/cairo/TableWriter$Row;IJ)V");
        int transferFloatToStrCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferFloatToStrCol",
                "(Lio/questdb/cairo/TableWriter$Row;IF)V");
        int transferDoubleToStrCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferDoubleToStrCol",
                "(Lio/questdb/cairo/TableWriter$Row;ID)V");

        int transferByteToVarcharCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferByteToVarcharCol",
                "(Lio/questdb/cairo/TableWriter$Row;IB)V");
        int transferShortToVarcharCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferShortToVarcharCol",
                "(Lio/questdb/cairo/TableWriter$Row;IS)V");
        int transferIntToVarcharCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferIntToVarcharCol",
                "(Lio/questdb/cairo/TableWriter$Row;II)V");
        int transferLongToVarcharCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferLongToVarcharCol",
                "(Lio/questdb/cairo/TableWriter$Row;IJ)V");
        int transferFloatToVarcharCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferFloatToVarcharCol",
                "(Lio/questdb/cairo/TableWriter$Row;IF)V");
        int transferDoubleToVarcharCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferDoubleToVarcharCol",
                "(Lio/questdb/cairo/TableWriter$Row;ID)V");
        ...
        int implicitCastVarcharAsLong = asm.poolMethod(SqlUtil.class, "implicitCastVarcharAsLong",
                "(Lio/questdb/std/str/Utf8Sequence;)J");
        int implicitCastVarcharAsShort = asm.poolMethod(SqlUtil.class, "implicitCastVarcharAsShort",
                "(Lio/questdb/std/str/Utf8Sequence;)S");
        int implicitCastVarcharAsInt = asm.poolMethod(SqlUtil.class, "implicitCastVarcharAsInt",
                "(Lio/questdb/std/str/Utf8Sequence;)I");
        int implicitCastVarcharAsByte = asm.poolMethod(SqlUtil.class, "implicitCastVarcharAsByte",
                "(Lio/questdb/std/str/Utf8Sequence;)B");
        int implicitCastVarcharAsChar = asm.poolMethod(SqlUtil.class, "implicitCastVarcharAsChar",
                "(Lio/questdb/std/str/Utf8Sequence;)C");
        int implicitCastVarcharAsFloat = asm.poolMethod(SqlUtil.class, "implicitCastVarcharAsFloat",
                "(Lio/questdb/std/str/Utf8Sequence;)F");
        int implicitCastVarcharAsDouble = asm.poolMethod(SqlUtil.class, "implicitCastVarcharAsDouble",
                "(Lio/questdb/std/str/Utf8Sequence;)D");
        ...
        int transferUuidToStrCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferUuidToStrCol",
                "(Lio/questdb/cairo/TableWriter$Row;IJJ)V");
        int transferUuidToVarcharCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferUuidToVarcharCol",
                "(Lio/questdb/cairo/TableWriter$Row;IJJ)V");
        int transferVarcharToStrCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferVarcharToStrCol",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/str/Utf8Sequence;)V");
        int transferVarcharToSymbolCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferVarcharToSymbolCol",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/str/Utf8Sequence;)V");
        int implicitCastVarcharAsTimestamp = asm.poolInterfaceMethod(TimestampDriver.class, "implicitCastVarchar",
                "(Lio/questdb/std/str/Utf8Sequence;)J");
        int transferVarcharToDateCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferVarcharToDateCol",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/str/Utf8Sequence;)V");
        int transferStrToVarcharCol = asm.poolMethod(RecordToRowCopierUtils.class, "transferStrToVarcharCol",
                "(Lio/questdb/cairo/TableWriter$Row;ILjava/lang/CharSequence;)V");
        int getTimestampDriverRef = asm.poolMethod(ColumnType.class, "getTimestampDriver",
                "(I)Lio/questdb/cairo/TimestampDriver;");
        int validateArrayDimensionsAndTransferColString = asm.poolMethod(RecordToRowCopierUtils.class,
                "validateArrayDimensionsAndTransferCol",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/cairo/arr/DoubleArrayParser;Ljava/lang/CharSequence;I)V");
        int validateArrayDimensionsAndTransferColVarchar = asm.poolMethod(RecordToRowCopierUtils.class,
                "validateArrayDimensionsAndTransferCol",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/cairo/arr/DoubleArrayParser;Lio/questdb/std/str/Utf8Sequence;I)V");
        int transferDecimal8 = asm.poolMethod(RecordToRowCopierUtils.class, "transferDecimal8",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/Decimal256;IIB)V");
        int transferDecimal16 = asm.poolMethod(RecordToRowCopierUtils.class, "transferDecimal16",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/Decimal256;IIS)V");
        int transferDecimal32 = asm.poolMethod(RecordToRowCopierUtils.class, "transferDecimal32",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/Decimal256;III)V");
        int transferDecimal64 = asm.poolMethod(RecordToRowCopierUtils.class, "transferDecimal64",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/Decimal256;IIJ)V");
        int transferDecimal128 = asm.poolMethod(RecordToRowCopierUtils.class, "transferDecimal128",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/Decimal256;IILio/questdb/std/Decimal128;)V");
        int transferDecimal256 = asm.poolMethod(RecordToRowCopierUtils.class, "transferDecimal256",
                "(Lio/questdb/cairo/TableWriter$Row;ILio/questdb/std/Decimal256;II)V");
        int transferByteToDecimal = asm.poolMethod(RecordToRowCopierUtils.class, "transferByteToDecimal",
                "(Lio/questdb/cairo/TableWriter$Row;IBLio/questdb/std/Decimal256;I)V");
        int transferShortToDecimal = asm.poolMethod(RecordToRowCopierUtils.class, "transferShortToDecimal",
                "(Lio/questdb/cairo/TableWriter$Row;ISLio/questdb/std/Decimal256;I)V");
        int transferIntToDecimal = asm.poolMethod(RecordToRowCopierUtils.class, "transferIntToDecimal",
                "(Lio/questdb/cairo/TableWriter$Row;IILio/questdb/std/Decimal256;I)V");
        int transferLongToDecimal = asm.poolMethod(RecordToRowCopierUtils.class, "transferLongToDecimal",
                "(Lio/questdb/cairo/TableWriter$Row;IJLio/questdb/std/Decimal256;I)V");
        ...
        int copySigIndex = asm.poolUtf8(
                "(Lio/questdb/griffin/SqlExecutionContext;Lio/questdb/cairo/sql/Record;Lio/questdb/cairo/TableWriter$Row;)V");
        ...
        for (int i = 0; i < numChunks; i++) {
            ...
            subMethodRefIndices[i] = asm.poolMethod(thisClassIndex,
                    asm.poolNameAndType(subMethodNameIndices[i], copySigIndex));
        }
                ...
                switch (fromColumnTypeTag) {
                    case ColumnType.INT:
                        ...
                        switch (toColumnTypeTag) {
                            ...
                            case ColumnType.VARCHAR:
                                asm.invokeStatic(transferIntToVarcharCol);
                                break;
                            case ColumnType.STRING:
                                asm.invokeStatic(transferIntToStrCol);
                                break;
                            default:
                    ...
                    case ColumnType.BYTE:
                        ...
                        switch (toColumnTypeTag) {
                            ...
                            case ColumnType.DOUBLE:
                                ...
                                break;
                            case ColumnType.VARCHAR:
                                asm.invokeStatic(transferByteToVarcharCol);
                                break;
                            case ColumnType.STRING:
                                asm.invokeStatic(transferByteToStrCol);
                                break;
                            default:
                                if (ColumnType.isDecimalType(toColumnTypeTag)) {
                                    asm.aload(1);
                    ...
                    case ColumnType.SHORT:
                        ...
                        switch (toColumnTypeTag) {
                            ...
                            case ColumnType.DOUBLE:
                                ...
                                break;
                            case ColumnType.VARCHAR:
                                asm.invokeStatic(transferShortToVarcharCol);
                                break;
                            case ColumnType.STRING:
                                asm.invokeStatic(transferShortToStrCol);
                                break;
                            default:
                                if (ColumnType.isDecimalType(toColumnTypeTag)) {
                                    asm.aload(1);
                    ...
                    case ColumnType.FLOAT:
                        ...
                        switch (toColumnTypeTag) {
                            ...
                            case ColumnType.DOUBLE:
                                ...
                                break;
                            case ColumnType.VARCHAR:
                                asm.invokeStatic(transferFloatToVarcharCol);
                                break;
                            case ColumnType.STRING:
                                asm.invokeStatic(transferFloatToStrCol);
                                break;
                            default:
                                assert false;
                                break;
                    ...
                    case ColumnType.DOUBLE:
                        ...
                        switch (toColumnTypeTag) {
                            ...
                            case ColumnType.DOUBLE:
                                ...
                                break;
                            case ColumnType.VARCHAR:
                                asm.invokeStatic(transferDoubleToVarcharCol);
                                break;
                            case ColumnType.STRING:
                                asm.invokeStatic(transferDoubleToStrCol);
                                break;
                            default:
                                assert false;
                                break;
                    ...
                    case ColumnType.GEOBYTE:
                        ...
                        if (fromColumnType != toColumnType
                                && (fromColumnType != ColumnType.NULL && fromColumnType != ColumnType.GEOBYTE)) {
                            asm.i2l();
                            asm.ldc(fromColumnType_0 + i * 2);
                            asm.ldc(toColumnType_0 + i * 2);
                    ...
                    case ColumnType.GEOSHORT:
                        ...
                        if (ColumnType.tagOf(toColumnType) == ColumnType.GEOBYTE) {
                            ...
                            asm.invokeInterface(wPutByte, 2);
                                ...
                                && fromColumnType != ColumnType.GEOSHORT) {
                            asm.i2l();
                            asm.ldc(fromColumnType_0 + i * 2);
                            asm.ldc(toColumnType_0 + i * 2);
                            asm.invokeStatic(implicitCastGeoHashAsGeoHash);
                    ...
                    case ColumnType.GEOINT:
                        ...
                        switch (ColumnType.tagOf(toColumnType)) {
                            ...
                            case ColumnType.GEOINT:
                                if (fromColumnType != toColumnType && fromColumnType != ColumnType.NULL
                                        && fromColumnType != ColumnType.GEOINT) {
                                    asm.i2l();
                                    asm.ldc(fromColumnType_0 + i * 2);
                                    asm.ldc(toColumnType_0 + i * 2);
                                    asm.invokeStatic(implicitCastGeoHashAsGeoHash);
                    ...
                    case ColumnType.GEOLONG:
                        ...
                        switch (ColumnType.tagOf(toColumnType)) {
                            ...
                            case ColumnType.GEOLONG:
                                if (fromColumnType != toColumnType && fromColumnType != ColumnType.NULL
                                        && fromColumnType != ColumnType.GEOLONG) {
                                    asm.ldc(fromColumnType_0 + i * 2);
                                    asm.ldc(toColumnType_0 + i * 2);
                                    asm.invokeStatic(implicitCastGeoHashAsGeoHash);
                                }
    ...
    private static RecordToRowCopier generateSingleMethodCopier(
        ...
        // in case of Geo Hashes column type can overflow short and asm.iconst() will
        // not provide
        // the correct value.
        int n = toColumnFilter.getColumnCount();
        ...
        // if we have to do implicit cast from STRING to ARRAYs then we need to create a
        // parser
        // the parser is instantiated in a constructor and stored in a field.
        // if parser is not required then we do not define and field and use just
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (toColumnTypeTag == ColumnType.DATE && fromColumnTypeTag == ColumnType.TIMESTAMP) { // Timestamp -> Date
                timestampTypeRef = fromColumnType_0 + 2 * i;
            } else if (toColumnTypeTag == ColumnType.TIMESTAMP && (fromColumnTypeTag == ColumnType.DATE || // Date ->
                                                                                                           // Timestamp
                    fromColumnTypeTag == ColumnType.VARCHAR || fromColumnTypeTag == ColumnType.STRING || // Varchar ->
                                                                                                         // Timestamp or
                                                                                                         // String ->
                                                                                                         // Timestamp
                    (fromColumnTypeTag == ColumnType.TIMESTAMP && fromColumnType != toColumnType))) { // Timestamp ->
                                                                                                      // Timestamp
                timestampTypeRef = toColumnType_0 + 2 * i;
            }
            ...
            switch (fromColumnTypeTag) {
                ...
                case ColumnType.STRING: // from
                    ...
                    // would have to do expensive checks to decide which conversion would be
                    // required
                    switch (toColumnTypeTag) {
                        case ColumnType.ARRAY:
                            // Initial stack: [rowWriter, toColumnIndex, parser, record, fromColumnIndex]
                ...
                case ColumnType.UUID: // from
                    switch (ColumnType.tagOf(toColumnType)) {
                        ...
                        case ColumnType.UUID:
                            ...
                            // invokeInterface consumes the entire stack. Including the RowWriter as invoke
                            // interface receives "this" as the first argument
                        ...
                        case ColumnType.STRING:
                            ...
                            // There is one major difference: `SqlUtil.implicitCastUuidAsStr()` returns
                            // `false` to indicate
                            // that the UUID value represents null. In this case we won't call the writer
                            // and let null value
                            // to be written by TableWriter/WalWriter NullSetters. However, generating
                            // branches via asm is
                            // complicated as JVM requires jump targets to have stack maps, etc. This would
                            // complicate things
                            // so we rely on an auxiliary method `transferUuidToStrCol()` to do branching
                            // job and javac generates
                            // the stack maps.
                    ...
                    break;
                case ColumnType.ARRAY:
                    // we are going to assume (and prior validation is required) that the array is
                    // of the same type
                    // as in dimensions and element type. The actual validation is not a
                    // responsibility of this code
                ...
                case ColumnType.DECIMAL256:
                    ...
                    break;
                default:
                    // we don't need to do anything for null as null is already written by
                    // TableWriter/WalWriter NullSetters
    ...
    private static boolean isArrayParserRequired(ColumnTypes fromTypes, RecordMetadata toMetadata,
            ColumnFilter toColumnFilter, int n) {
        for (int i = 0; i < n; i++) {
    ...
    public static void transferByteToStrCol(TableWriter.Row row, int col, byte value) {
        StringSink sink = Misc.getThreadLocalSink();
        sink.put(value);
        row.putStr(col, sink);
    }

    public static void transferShortToStrCol(TableWriter.Row row, int col, short value) {
        StringSink sink = Misc.getThreadLocalSink();
        sink.put(value);
        row.putStr(col, sink);
    }

    public static void transferIntToStrCol(TableWriter.Row row, int col, int value) {
        StringSink sink = Misc.getThreadLocalSink();
        sink.put(value);
        row.putStr(col, sink);
    }

    public static void transferLongToStrCol(TableWriter.Row row, int col, long value) {
        StringSink sink = Misc.getThreadLocalSink();
        sink.put(value);
        row.putStr(col, sink);
    }

    public static void transferFloatToStrCol(TableWriter.Row row, int col, float value) {
        StringSink sink = Misc.getThreadLocalSink();
        sink.put(value);
        row.putStr(col, sink);
    }

    public static void transferDoubleToStrCol(TableWriter.Row row, int col, double value) {
        StringSink sink = Misc.getThreadLocalSink();
        sink.put(value);
        row.putStr(col, sink);
    }

    public static void transferByteToVarcharCol(TableWriter.Row row, int col, byte value) {
        Utf8StringSink sink = Misc.getThreadLocalUtf8Sink();
        sink.put(value);
        row.putVarchar(col, sink);
    }

    public static void transferShortToVarcharCol(TableWriter.Row row, int col, short value) {
        Utf8StringSink sink = Misc.getThreadLocalUtf8Sink();
        sink.put(value);
        row.putVarchar(col, sink);
    }

    public static void transferIntToVarcharCol(TableWriter.Row row, int col, int value) {
        Utf8StringSink sink = Misc.getThreadLocalUtf8Sink();
        sink.put(value);
        row.putVarchar(col, sink);
    }

    public static void transferLongToVarcharCol(TableWriter.Row row, int col, long value) {
        Utf8StringSink sink = Misc.getThreadLocalUtf8Sink();
        sink.put(value);
        row.putVarchar(col, sink);
    }

    public static void transferFloatToVarcharCol(TableWriter.Row row, int col, float value) {
        Utf8StringSink sink = Misc.getThreadLocalUtf8Sink();
        sink.put(value);
        row.putVarchar(col, sink);
    }

    public static void transferDoubleToVarcharCol(TableWriter.Row row, int col, double value) {
        Utf8StringSink sink = Misc.getThreadLocalUtf8Sink();
        sink.put(value);
        row.putVarchar(col, sink);
    }
