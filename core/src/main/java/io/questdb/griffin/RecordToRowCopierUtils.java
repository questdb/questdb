...
public class RecordToRowCopierUtils {
    ...
    public static void transferVarcharToStrCol(TableWriter.Row row, int col, Utf8Sequence seq) {
        ...
        // whole statement. Row.putStrUtf8() would reject it, which is right only for client
        // writes. transferVarcharToSymbolCol() below resolves the same way.
        row.putStr(col, Utf8s.utf8ToUtf16OrView(seq, Misc.getThreadLocalSink()));
    }
