...
public class SqlKeywords {
    ...
    public static boolean isOrdinalityKeyword(CharSequence tok) {
        return tok.length() == 10
                && (tok.charAt(0) | 32) == 'o'
                && (tok.charAt(1) | 32) == 'r'
                && (tok.charAt(2) | 32) == 'd'
    ...
    public static boolean isReplicaKeyword(CharSequence tok) {
        return tok.length() == 7
                && (tok.charAt(0) | 32) == 'r'
                && (tok.charAt(1) | 32) == 'e'
                && (tok.charAt(2) | 32) == 'p'
    ...
    public static boolean isUnnestKeyword(CharSequence tok) {
        return tok.length() == 6
                && (tok.charAt(0) | 32) == 'u'
                && (tok.charAt(1) | 32) == 'n'
                && (tok.charAt(2) | 32) == 'n'
