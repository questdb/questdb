...
/**
 * A SQL execution lease whose owner can survive between executable Fiber segments.
 * Implementations retain lifetime resources while unmounted, but must not retain an
 * active admission permit or a running dispatch grant. Mount may therefore wait for
...
public interface SqlExecutionLease extends QuietCloseable {
    ...
    default @Nullable CharSequence getResourceGroupName() {
        return null;
    }
