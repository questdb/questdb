...
public class QueryModel implements IQueryModel {
    ...
    public QueryModel deepClone(
        ...
        if (nestedModel != null) {
            dst.setNestedModel(((QueryModel) nestedModel).deepClone(queryModelPool, queryColumnPool, expressionNodePool, windowExpressionPool));
        ...
        for (int i = 1, n = joinModels.size(); i < n; i++) {
            QueryModel dstJm = ((QueryModel) joinModels.getQuick(i)).deepClone(queryModelPool, queryColumnPool, expressionNodePool, windowExpressionPool);
        ...
        if (unionModel != null) {
            dst.setUnionModel(((QueryModel) unionModel).deepClone(queryModelPool, queryColumnPool, expressionNodePool, windowExpressionPool));
        }
