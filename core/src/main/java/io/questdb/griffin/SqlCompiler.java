        ...
        while (lexer.hasNext()) {
            ...
            for (int retries = 0; recompileStale; retries++) {
                try {
                    ...
                    CompiledQuery current = null;
                    CharSequence currentQuery = null;
    ...
    private ExecutionModel compileExecutionModel0(SqlExecutionContext executionContext, ExecutionModel model) throws SqlException {
        switch (model.getModelType()) {
            ...
            case ExecutionModel.INSERT: {
                ...
                executionContext.getSecurityContext().authorizeInsert(tableToken, insertModel.getColumnNameList()); //HERE
                return insertModel;
            }
