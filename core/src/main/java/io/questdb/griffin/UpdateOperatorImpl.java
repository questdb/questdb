    ...
    private void openColumns(ObjList<? extends MemoryCM> columns, int partitionIndex, boolean forWrite) {
        ...
        try {
            ...
            for (int i = 0, n = updateColumnIndexes.size(); i < n; i++) {
                ...
                boolean isFiltered = metadata.isColumnFiltered(columnIndex);
                ...
                if (forWrite) {
                    ...
                    if (rowCount > 0) {
                        ...
                        purgingOperator.add(columnIndex, columnName, columnType, isIndexed, existingVersion, partitionTimestamp, partitionNameTxn, isFiltered);
                    }
                }
