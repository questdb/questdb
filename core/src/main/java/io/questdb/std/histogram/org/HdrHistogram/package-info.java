 ...
 * <pre>
 * <code>
 *  org.HdrHistogram.Histogram histogram = new org.HdrHistogram.Histogram(3600000000L, 3);
 * .
 * .
 * .
 * // Repeatedly record measured latencies:
 * histogram. org.HdrHistogram.AbstractHistogram#recordValue(long) recordValue(latency);
 * .
 * .
 * .
 * // Report histogram percentiles, expressed in msec units:
 * histogram.org.HdrHistogram.AbstractHistogram#outputPercentileDistribution(java.io.PrintStream, Double) outputPercentileDistribution(histogramLog, 1000.0);
 * </code>
 * </pre>
 ...
 * The HdrHistogram package includes multiple implementations of the org.HdrHistogram.AbstractHistogram class:
 * <ul>
 *  <li>  org.HdrHistogram.Histogram, which is the commonly used Histogram form and tracks value counts
 * in <b><code>long</code></b> fields. </li>
 *  <li>org.HdrHistogram.IntCountsHistogram and org.HdrHistogram.ShortCountsHistogram, which track value counts
 ...
 * being tracked).</li>
 *  <li>org.HdrHistogram.AtomicHistogram, org.HdrHistogram.ConcurrentHistogram
 *  and  org.HdrHistogram.SynchronizedHistogram</li>
 * </ul>
 * <p>
 ...
 * In the interest of keeping value recording cost to a minimum, the commonly used org.HdrHistogram.Histogram
 * class and it's org.HdrHistogram.IntCountsHistogram and org.HdrHistogram.ShortCountsHistogram
 ...
 * synchronize and/or order their access, or use the org.HdrHistogram.ConcurrentHistogram,
 * { org.HdrHistogram.AtomicHistogram}, or { org.HdrHistogram.SynchronizedHistogram} variants.
 * <p>
 ...
 * reporting operations are needed, consider using the {org.HdrHistogram.Recorder} and
 * {org.HdrHistogram.SingleWriterRecorder} variants that were specifically designed for that purpose.
 ...
 * non-synchronized histograms or {org.HdrHistogram.SingleWriterRecorder}s, and using a summary/reporting
 ...
 * each possible value level. The iteration mechanisms all provide { org.HdrHistogram.HistogramIterationValue}
 * data points along the histogram's iterated data set, and are available via the following methods:
 * <ul>
 *     <li>{org.HdrHistogram.AbstractHistogram#percentiles percentiles} :
 *     An { java.lang.Iterable}{@literal <}{ org.HdrHistogram.HistogramIterationValue}{@literal >} through the
 *     histogram using a { org.HdrHistogram.PercentileIterator} </li>
 *     <li>{ org.HdrHistogram.AbstractHistogram#linearBucketValues linearBucketValues} :
 *     An { java.lang.Iterable}{@literal <}{ org.HdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a { org.HdrHistogram.LinearIterator} </li>
 *     <li>{ org.HdrHistogram.AbstractHistogram#logarithmicBucketValues logarithmicBucketValues} :
 *     An { java.lang.Iterable}{@literal <}{ org.HdrHistogram.HistogramIterationValue}{@literal >}
 *     through the histogram using a { org.HdrHistogram.LogarithmicIterator} </li>
 *     <li>{ org.HdrHistogram.AbstractHistogram#recordedValues recordedValues} :
 *     An { java.lang.Iterable}{@literal <}{ org.HdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a { org.HdrHistogram.RecordedValuesIterator} </li>
 *     <li>{ org.HdrHistogram.AbstractHistogram#allValues allValues} :
 *     An { java.lang.Iterable}{@literal <}{ org.HdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a { org.HdrHistogram.AllValuesIterator} </li>
 * </ul>
 * <p>
 ...
 * { org.HdrHistogram.AbstractHistogram#recordValue(long) recordValue()} method.
 * <p>
 * Histogram variants also provide an auto-correcting
 * { org.HdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * { org.HdrHistogram.AbstractHistogram#recordValue(long) recordValue()}
 * and with
 * { org.HdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * methods
 * { org.HdrHistogram.AbstractHistogram#copyCorrectedForCoordinatedOmission(long) copyCorrectedForCoordinatedOmission()}
 * and
 * { org.HdrHistogram.AbstractHistogram#addWhileCorrectingForCoordinatedOmission(AbstractHistogram, long) addWhileCorrectingForCoordinatedOmission()}.
 ...
 * { org.HdrHistogram.AbstractHistogram} and their related supporting classes). HdrHistogram supports floating
 * point value recording and reporting with a similar set of classes, including the
 * { org.HdrHistogram.DoubleHistogram}, { org.HdrHistogram.ConcurrentDoubleHistogram} and
 * { org.HdrHistogram.SynchronizedDoubleHistogram} histogram classes. Support for floating point value
 * iteration is provided with { org.HdrHistogram.DoubleHistogramIterationValue} and related iterator classes (
 * { org.HdrHistogram.DoubleLinearIterator}, { org.HdrHistogram.DoubleLogarithmicIterator},
 * { org.HdrHistogram.DoublePercentileIterator}, { org.HdrHistogram.DoubleRecordedValuesIterator},
 * { org.HdrHistogram.DoubleAllValuesIterator}). Support for interval recording is provided with
 * { org.HdrHistogram.DoubleRecorder} and
 ...
 * that the histogram can cover is (optionally) specified. E.g. When a { org.HdrHistogram.DoubleHistogram}
 ...
 * { org.HdrHistogram.AbstractHistogram#getEstimatedFootprintInBytes() getEstimatedFootprintInBytes()} method.
 */
