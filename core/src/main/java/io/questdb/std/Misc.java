...
public final class Misc {
    ...
    private static final FiberLocal<Decimal128> tlDecimal128 = new FiberLocal<>(Decimal128::new);
    private static final FiberLocal<Decimal256> tlDecimal256 = new FiberLocal<>(Decimal256::new);
    private static final FiberLocal<StringSink> tlSink = new FiberLocal<>(StringSink::new);
    private static final FiberLocal<Utf8StringSink> tlUtf8Sink = new FiberLocal<>(Utf8StringSink::new);
    private static final FiberLocal<Utf8SinkPool> tlUtf8SinkPool = new FiberLocal<>(Utf8SinkPool::new);
