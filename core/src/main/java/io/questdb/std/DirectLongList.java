...
public class DirectLongList implements Mutable, Closeable {
    ...
    public DirectLongList(long capacity) {
        ...
        this.address = Unsafe.malloc(this.capacity, MemoryTag.NATIVE_DEFAULT);
    ...
    private void extendBytes(long capacity) {
        ...
        long address = Unsafe.realloc(this.address, oldCapacity, capacity, MemoryTag.NATIVE_DEFAULT);
