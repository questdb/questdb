...
public class KqueueFileWatcher extends FileWatcher {
    ...
    public KqueueFileWatcher(Utf8Sequence filePath, FileEventCallback callback) {
        ...
        try {
            ...
            this.readEndFd = Files.createUniqueFd((int) (fds >>> 32), "[read_end]");
            this.writeEndFd = Files.createUniqueFd((int) fds, "[write_end]");
            ...
            kq = Files.createUniqueFd(KqueueAccessor.kqueue(), "[kqueue2]");
            if (kq < 0) {
