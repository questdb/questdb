...
public class WorkerPoolConfigurationWrapper implements WorkerPoolConfiguration {
    private final WorkerPoolConfiguration delegate;

    protected WorkerPoolConfigurationWrapper() {
        delegate = null;
    }
    ...
    protected WorkerPoolConfiguration getDelegate() {
        return delegate;
    }
}
