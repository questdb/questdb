...
public class PropServerConfiguration implements ServerConfiguration {
    ...
    public PropServerConfiguration(
        ...
        try (Path path = new Path()) {
            ...
            this.o3LastPartitionMaxSplits = Math.max(1, getInt(properties, env, PropertyKey.CAIRO_O3_LAST_PARTITION_MAX_SPLITS, 1));

            // 1TB to disable by default
            this.o3PartitionSplitMinSize = getLongSize(properties, env, PropertyKey.CAIRO_O3_PARTITION_SPLIT_MIN_SIZE, 1024L * 1024L);
