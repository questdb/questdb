...
package com.nfsdb.ql.ops.minus;
...
public class MinusIntOperator extends AbstractBinaryOperator {

    public final static MinusIntOperator FACTORY = new MinusIntOperator();

    private MinusIntOperator() {
