...
public class IntervalRecordSource2 extends AbstractCombinedRecordSource {
    ...
    public IntervalRecordSource2(RecordSource delegate, ObjList<Interval> intervals) {
    ...
    public void toSink(CharSink sink) {
        ...
        sink.putQuoted("interval").put(':').put(intervals);
        sink.put('}');
    }
}
