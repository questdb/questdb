...
public final class LastDoubleAggregator extends AbstractUnaryAggregator {
    ...
    public static final VirtualColumnFactory<Function> FACTORY = (position, configuration) -> new LastDoubleAggregator(position);

    private LastDoubleAggregator(int position) {
