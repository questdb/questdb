...
public final class CountDoubleAggregator extends AbstractUnaryAggregator {
    ...
    public static final VirtualColumnFactory<Function> FACTORY = (position, configuration) -> new CountDoubleAggregator(position);

    private CountDoubleAggregator(int position) {
