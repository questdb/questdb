...
public class MinusDoubleOperator extends AbstractBinaryOperator {
    ...
    public final static VirtualColumnFactory<Function> FACTORY = (position, configuration) -> new MinusDoubleOperator(position);

    private MinusDoubleOperator(int position) {
