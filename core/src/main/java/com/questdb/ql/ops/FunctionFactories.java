...
public final class FunctionFactories {
    ...
    static {
        ...
        unSigAgg("avg", ColumnType.DOUBLE, StableAvgAggregator.FACTORY);
        unSigAgg("avg", ColumnType.INT, StableAvgAggregator.FACTORY);
        unSigAgg("avg", ColumnType.LONG, StableAvgAggregator.FACTORY);
        unSigAgg("avg", ColumnType.FLOAT, StableAvgAggregator.FACTORY);
