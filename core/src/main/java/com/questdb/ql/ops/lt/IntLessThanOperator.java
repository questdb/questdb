...
public class IntLessThanOperator extends AbstractBinaryOperator {
    ...
    public final static VirtualColumnFactory<Function> FACTORY = (position, configuration) -> new IntLessThanOperator(position);

    private IntLessThanOperator(int position) {
