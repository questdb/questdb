...
public final class FirstIntAggregator extends AbstractUnaryAggregator {
    ...
    public static final VirtualColumnFactory<Function> FACTORY = (position, configuration) -> new FirstIntAggregator(position);

    private FirstIntAggregator(int position) {
