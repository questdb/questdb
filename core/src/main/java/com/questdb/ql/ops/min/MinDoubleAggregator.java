...
public final class MinDoubleAggregator extends AbstractUnaryAggregator {
    ...
    public static final VirtualColumnFactory<Function> FACTORY = (position, configuration) -> new MinDoubleAggregator(position);

    private MinDoubleAggregator(int position) {
