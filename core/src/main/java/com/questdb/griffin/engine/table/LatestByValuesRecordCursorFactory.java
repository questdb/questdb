...
public class LatestByValuesRecordCursorFactory extends AbstractRecordCursorFactory {
    private final DataFrameCursorFactory dataFrameCursorFactory;
    private final LatestByValuesRecordCursor cursor;
    ...
    public LatestByValuesRecordCursorFactory(
