...
import com.questdb.griffin.common.*;
import com.questdb.griffin.engine.FunctionFactories;
    ...
    private VirtualColumn lookupColumn(ExprNode node) throws ParserException {
        ...
        try {
            ...
            switch (metadata.getColumnQuick(index).getType()) {
                ...
                default:
                    throw ParserException.$(node.position, "Not yet supported type");
            }
        } catch (NoSuchColumnException e) {
            throw ParserException.invalidColumn(node.position, column);
        }
    }
