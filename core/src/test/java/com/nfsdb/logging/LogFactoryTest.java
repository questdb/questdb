...
public class LogFactoryTest {
    ...
    public void testPackageHierarchy() throws Exception {
        ...
        try (LogFactory factory = new LogFactory()) {
            ...
            factory.add(new LogWriterConfig("com.nfsdb.collections", LogLevel.LOG_LEVEL_INFO, new LogWriterFactory() {
                @Override
                public LogWriter createLogWriter(RingQueue<LogRecordSink> ring, Sequence seq, int level) {
                    LogFileWriter w = new LogFileWriter(ring, seq, level);
            ...
            Log logger = factory.create("com.nfsdb.collections.X");
    ...
    public void testSetProperties() throws Exception {
        ...
        Files.writeStringToFile(conf, "writers=file\n" +
                "recordLength=4096\n" +
                "queueDepth=1024\n" +
                "w.file.class=com.nfsdb.logging.LogFileWriter\n" +
