...
public class CommitLagRetentionTest extends AbstractGriffinTest {
    ...
    public void testRenameColumn() throws Exception {
        assertMemoryLeak(() -> {
            ...
            compileAlterTable("alter table my_table rename column x to y", sqlExecutionContext);
            assertCommitLagValues();
        });
    }
    ...
    public void testAddColumn() throws Exception {
        assertMemoryLeak(() -> {
            createTable();
            assertCommitLagValues();
            compileAlterTable("alter table my_table add column y symbol", sqlExecutionContext);
            assertCommitLagValues();
        });
    }
    ...
    public void testDropColumn() throws Exception {
        assertMemoryLeak(() -> {
            createTable();
            assertCommitLagValues();
            compileAlterTable("alter table my_table drop column x", sqlExecutionContext);
            assertCommitLagValues();
        });
    }
    ...
    public void testAddIndexToEmptyTable() throws Exception {
        assertMemoryLeak(() -> {
            createTable();
            assertCommitLagValues();
            compileAlterTable("alter TABLE my_table ALTER COLUMN s ADD INDEX", sqlExecutionContext);
            assertCommitLagValues();
        });
    }
    ...
    public void testDropPartition() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertCommitLagValues();
            compileAlterTable("alter TABLE my_table DROP PARTITION LIST '1970-01-01'", sqlExecutionContext);
            assertCommitLagValues();
        });
    }
