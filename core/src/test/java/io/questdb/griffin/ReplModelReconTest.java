        ...
        assertMemoryLeak(() -> {
            ...
            compiler.compile(
                    "create table top as (" +
                            ...
                            " rnd_symbol(4,4,4,2) ik," +
                            " rnd_long() j," +
                            " cast(to_timestamp('2018-01-09', 'yyyy-MM-dd') + 30000*10000 + ((x-1)/4) * 1000000L + (4-(x-1)%4)*80009  as timestamp) ts," +
                            " rnd_byte(2,50) l," +
                            " rnd_bin(10, 20, 2) m," +
                            " rnd_str(5,16,2) n," +
                            " rnd_long256() o" +
            ...
            compiler.compile("insert batch 20000 commitLag 3d into x select * from top", sqlExecutionContext);
