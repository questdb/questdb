...
public class RoundDownDoubleFunctionFactoryConstTest extends AbstractGriffinTest {
    ...
    public void testLargeNegScale() throws SqlException {
        assertQuery(
                "rounddown\n" +
                        "NaN\n",
                "select rounddown(14.778, -16) from long_sequence(1)",
                null,
                true
        );
    }
    ...
    public void testNegScaleHigherThanNumber() throws SqlException {
        assertQuery(
                "rounddown\n" +
                        "0.000000000000\n",
                "select rounddown(-14.778, -5) from long_sequence(1)",
                null,
                true
        );
    }
    ...
    public void testNegScaleNegValue() throws SqlException {
        assertQuery(
                "rounddown\n" +
                        "-10.000000000000\n",
                "select rounddown(-14.778, -1) from long_sequence(1)",
                null,
                true
        );
    }
    ...
    public void testPosScaleHigherThanNumber() throws SqlException {
        assertQuery(
                "rounddown\n" +
                        "-14.778000000000\n",
                "select rounddown(-14.778, 7) from long_sequence(1)",
                null,
                true
        );
    }
    ...
    public void testPosScaleNegValue() throws SqlException {
        assertQuery(
                "rounddown\n" +
                        "-100.900000000000\n",
                "select rounddown(-100.9999, 1) from long_sequence(1)",
                null,
                true
        );
    }
    ...
    public void testPosScalePosValue() throws SqlException {
        assertQuery(
                "rounddown\n" +
                        "100.000000000000\n",
                "select rounddown(100.01, 1) from long_sequence(1)",
                null,
                true
        );
    }
