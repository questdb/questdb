...
public class NullConstantTest {
    ...
    public void testConstant() {
        ...
        Assert.assertTrue(constant.isNull());
        ...
        Assert.assertTrue(constant.isUndefined());
    ...
    public void testGetStrWithIndex() {
        new NullConstant().getStr(null, 0);
    }

    @Test(expected = UnsupportedOperationException.class)
    public void testGetStrLenWithIndex() {
        new NullConstant().getStrLen(null, 0);
    }

    @Test(expected = UnsupportedOperationException.class)
    public void testGetStrBWithIndex() {
        new NullConstant().getStrB(null, 0);
    }

    @Test(expected = UnsupportedOperationException.class)
    public void testGetStrWithSinkAndIndex() {
        new NullConstant().getStr(null, null, 0);
    }

    @Test(expected = UnsupportedOperationException.class)
    public void testGetRecordCursorFactory() {
        new NullConstant().getRecordCursorFactory();
    }
}