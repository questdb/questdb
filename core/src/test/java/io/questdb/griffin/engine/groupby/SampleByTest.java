...
public class SampleByTest extends AbstractGriffinTest {
    ...
    public void testIndexSampleByIndexNoTimestampColSelected() throws Exception {
        ...
        assertMemoryLeak(() -> {
            compileAlterTable("alter table xx drop column s", sqlExecutionContext);
            compileAlterTable("alter table xx add s SYMBOL INDEX", sqlExecutionContext);
        });
    ...
    public void testIndexSampleWithColumnTops() throws Exception {
        assertMemoryLeak(() -> {
            ...
            compileAlterTable("alter table xx add i1 int", sqlExecutionContext);
            compileAlterTable("alter table xx add c1 char", sqlExecutionContext);
            compileAlterTable("alter table xx add l1 long", sqlExecutionContext);
            ...
            compileAlterTable("alter table xx add f1 float", sqlExecutionContext);
            compileAlterTable("alter table xx add d1 double", sqlExecutionContext);
            compileAlterTable("alter table xx add s1 symbol", sqlExecutionContext);
            compileAlterTable("alter table xx add ss1 short", sqlExecutionContext);
            compileAlterTable("alter table xx add b1 byte", sqlExecutionContext);
            compileAlterTable("alter table xx add t1 timestamp", sqlExecutionContext);
            compileAlterTable("alter table xx add dt date", sqlExecutionContext);
        });
    ...
    public void testIndexSampleWithColumnTopsGeo() throws Exception {
        assertMemoryLeak(() -> {
            ...
            compileAlterTable("alter table xx add t1 timestamp", sqlExecutionContext);
            compileAlterTable("alter table xx add dt date", sqlExecutionContext);
            compileAlterTable("alter table xx add ge1 geohash(3b)", sqlExecutionContext);
            compileAlterTable("alter table xx add ge2 geohash(2c)", sqlExecutionContext);
            compileAlterTable("alter table xx add ge4 geohash(5c)", sqlExecutionContext);
            compileAlterTable("alter table xx add ge8 geohash(9c)", sqlExecutionContext);
        });
    ...
    public void testSampleFillValueAllTypes() throws Exception {
        assertQuery(
                "b\tlast\tlast1\tlast2\tlast3\tlast4\tlast5\tk\n" +
                        "\t62.76954028373309\t70.94359993934631\t1125169127\t-12348\t8\t6600081143067978388\t1970-01-03T00:00:00.000000Z\n" +
                        "CPSW\t0.35983672154330515\t76.75672769546509\t113506296\t27809\t9\t-8889930662239044040\t1970-01-03T00:00:00.000000Z\n" +
                        ...
                        "\t80.01121139739173\t92.05003380775452\t235358133\t-9039\t5\t6473208488991371747\t1970-01-03T06:00:00.000000Z\n" +
                        ...
                        "\t97.03060808244088\t91.01417064666748\t1794809330\t10028\t4\t-5512653573876168745\t1970-01-03T09:00:00.000000Z\n" +
                        ...
                        "\t89.40917126581896\t94.41658854484558\t2124174232\t2508\t9\t-7103100524321179064\t1970-01-03T12:00:00.000000Z\n" +
                        ...
                        "HYRX\t24.008362859107102\t76.57837271690369\t2111250190\t-13252\t8\t7973684666911773753\t1970-01-03T12:00:00.000000Z\n" +
                        "\t26.369335635512837\t56.994444131851196\t2011884585\t9054\t10\t-5315599072928175674\t1970-01-03T15:00:00.000000Z\n" +
                        ...
                        "HYRX\t2.6836863013701473\t10.643041133880615\t502711083\t-8221\t9\t-7709579215942154242\t1970-01-03T15:00:00.000000Z\n" +
                        "\t42.74704286353759\t33.74707102775574\t684778036\t11524\t6\t7574443524652611981\t1970-01-03T18:00:00.000000Z\n" +
