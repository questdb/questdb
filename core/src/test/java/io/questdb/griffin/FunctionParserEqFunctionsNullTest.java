...
public class FunctionParserEqFunctionsNullTest extends BaseFunctionFactoryTest {
    ...
    private static final int[] EQUIVALENT_NULL_TYPES_BYTE_SHORT = {
            ColumnType.BYTE,
            ColumnType.SHORT,
    };
    ...
    @Test
    public void testEqFunctionResolutionNullArgsForByteNShort() throws SqlException {
        functions.addAll(Arrays.asList(EQ_FUNCS));
        FunctionParser functionParser = createFunctionParser();
        for (int col0Type : EQUIVALENT_NULL_TYPES_BYTE_SHORT) {
            for (int col1Type : EQUIVALENT_NULL_TYPES_BYTE_SHORT) {
