...
public class AlterTableAlterSymbolColumnCacheFlagTest extends AbstractGriffinTest {
    ...
    public void testAlterSymbolCacheFlagToTrueCheckOpenReaderWithCursor() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            compiler.compile("insert into x values (1, 'GBP')\"", sqlExecutionContext);
            compiler.compile("insert into x values (2, 'CHF')\"", sqlExecutionContext);
            compiler.compile("insert into x values (3, 'GBP')\"", sqlExecutionContext);
            compiler.compile("insert into x values (4, 'JPY')\"", sqlExecutionContext);
            compiler.compile("insert into x values (5, 'USD')\"", sqlExecutionContext);
            compiler.compile("insert into x values (6, 'GBP')\"", sqlExecutionContext);
            compiler.compile("insert into x values (7, 'GBP')\"", sqlExecutionContext);
            compiler.compile("insert into x values (8, 'GBP')\"", sqlExecutionContext);
            compiler.compile("insert into x values (9, 'GBP')\"", sqlExecutionContext);
        });
