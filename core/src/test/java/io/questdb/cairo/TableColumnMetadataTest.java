...
public class TableColumnMetadataTest {
    ...
    public void testHasIndex() {
        TableColumnMetadata metadata = new TableColumnMetadata("x", 1, ColumnType.INT, true, 0, true, null);
    ...
    public void testNoIndex() {
        TableColumnMetadata metadata = new TableColumnMetadata("x", 1, ColumnType.INT, false, 0, false, null);
        Assert.assertEquals(0, metadata.getIndexValueBlockCapacity());
