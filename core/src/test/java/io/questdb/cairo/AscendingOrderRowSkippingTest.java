...
/**
 * This class tests row skipping (in ascending order) optimizations for tables with designated timestamps,
 * both un- and partitioned .
 */
public class AscendingOrderRowSkippingTest extends AbstractGriffinTest {
