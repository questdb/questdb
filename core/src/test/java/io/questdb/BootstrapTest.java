...
public class BootstrapTest {
    ...
    public void testBadArgs() {
        ...
        assertFail("does not exist/conf/server.conf (No such file or directory)", "-d", "does not exist");
    }

    @Test
    public void testConfigFolderDoesNotExist() {
        assertFail("/dbRoot/conf/server.conf (No such file or directory)", "-d", root.toString());
    }
