...
import static io.questdb.test.tools.TestUtils.printer;
...
public class ServerMainBackupDatabaseTest extends AbstractBootstrapTest {
        ...
        assertMemoryLeak(() -> {
            ...
            try (
                ...
                for (int t = 0; t < N; t++) {
                    ...
                    contexts.add(executionContext(engine));
    ...
    private static void startTableCreator(
        ...
        startThread(createsCompleted, errors, () -> {
            ...
            int numRows = ThreadLocalRandom.current().nextInt(1000, 20000);
    ...
    private static void startTableWriter(
        ...
        startThread(writersCompleted, errors, () -> {
            ...
            while (!createsCompleted.await(TimeUnit.MILLISECONDS.toNanos(10L))) {
            ...
            while (!Thread.currentThread().isInterrupted() && !endWriters.get()) {
                int numRows = ThreadLocalRandom.current().nextInt(1, 100);
