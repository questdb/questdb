...
import io.questdb.cutlass.http.websocket.IlpV4WebSocketProcessor;
import io.questdb.cutlass.http.websocket.IlpV4WebSocketProcessorState;
 ...
 */
public class IlpV4WebSocketProcessorIntegrationTest extends AbstractWebSocketTest {
    ...
    public void testProcessorWithStateCallback() {
        ...
        try {
            IlpV4WebSocketProcessor processor = new IlpV4WebSocketProcessor();
    ...
    public void testRapidMessageProcessing() {
        IlpV4WebSocketProcessorState state = new IlpV4WebSocketProcessorState(256);
        try {
            IlpV4WebSocketProcessor processor = new IlpV4WebSocketProcessor();
            processor.setCallback(new StateAccumulatingCallback(state));
     ...
     */
    private static class StateAccumulatingCallback implements IlpV4WebSocketProcessor.Callback {
        private final IlpV4WebSocketProcessorState state;

        StateAccumulatingCallback(IlpV4WebSocketProcessorState state) {
            this.state = state;
        }
     ...
     */
    private static class ErrorSettingCallback implements IlpV4WebSocketProcessor.Callback {
        private final IlpV4WebSocketProcessorState state;

        ErrorSettingCallback(IlpV4WebSocketProcessorState state) {
            this.state = state;
        }
     ...
     */
    private static class CloseTrackingCallback implements IlpV4WebSocketProcessor.Callback {
     ...
     */
    private static class PingPongTrackingCallback implements IlpV4WebSocketProcessor.Callback {
        int pingCount = 0;
        int pongCount = 0;
