...
public class QwpWebSocketUpgradeProcessorTest extends AbstractWebSocketTest {
    ...
    @Test
    public void testWriteHandshakeResponseBufferTooSmall() throws Exception {
        assertMemoryLeak(() -> {
            Utf8String key = new Utf8String("dGhlIHNhbXBsZSBub25jZQ==");
    ...
    @Test
    public void testWriteHandshakeResponseMultipleKeys() throws Exception {
        assertMemoryLeak(() -> {
            String[] keys = {
    ...
    @Test
    public void testWriteHandshakeResponseSize() throws Exception {
        assertMemoryLeak(() -> {
            Utf8String key = new Utf8String("dGhlIHNhbXBsZSBub25jZQ==");
    ...
    @Test
    public void testWriteHandshakeResponseWithRfc6455TestVector() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testWriteUpgradeRequiredResponse() throws Exception {
        assertMemoryLeak(() -> {
            long bufferSize = 256;
            long buffer = Unsafe.malloc(bufferSize, MemoryTag.NATIVE_DEFAULT);
            try {
