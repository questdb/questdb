...
public class LineTcpReceiverTest extends AbstractLineTcpReceiverTest {
    ...
    public LineTcpReceiverTest(WalMode walMode, int timestampType) {
    ...
    public void setUp() {
        ...
        node1.setProperty(PropertyKey.LINE_TIMESTAMP_DEFAULT_COLUMN_TYPE, timestampType);
        path = new Path();
    }
    ...
    public void testCaseInsensitiveTableName() throws Exception {
        ...
        runInContext((receiver) -> {
            ...
            String expected = timestampType == ColumnType.TIMESTAMP_MICRO ? "out\ttimestamp\n" +
    ...
    public void testColumnTypeStaysTheSameWhileColumnAdded() throws Exception {
        Assume.assumeTrue(timestampType == ColumnType.TIMESTAMP_NANO);
    ...
    public void testCreationAttemptNonPartitionedTableWithWal() throws Exception {
        ...
        runInContext((receiver) -> {
            ...
            String expected = timestampType == ColumnType.TIMESTAMP_MICRO ? "ts\twindspeed\ttimetocycle\n" +
    ...
    public void testDateColumnAcceptsTimestamp() throws Exception {
        ...
        runInContext((receiver) -> {
            ...
            String expected = timestampType == ColumnType.TIMESTAMP_MICRO ? "ts\tdt\n" +
    ...
    public void testDropTable() throws Exception {
        Assume.assumeTrue(walEnabled && timestampType == ColumnType.TIMESTAMP_MICRO);
    ...
    public void testTimestampColumn() throws Exception {
        ...
        runInContext((receiver) -> {
            ...
            String expected = timestampType == ColumnType.TIMESTAMP_MICRO ? "location\ttimestamp\ttemperature\n" +
    ...
    public void testWindowsAccessDenied() throws Exception {
        ...
        runInContext((receiver) -> {
            ...
            String expected = timestampType == ColumnType.TIMESTAMP_MICRO ? "ReceiveTime\tSequenceNumber\tMessageType\tLength\ttest\n" +
    ...
    public void testWithTcpSender() throws Exception {
        runInContext((receiver) -> {
            ...
            String expected = timestampType == ColumnType.TIMESTAMP_MICRO ? "tag1\ttag=2\tполе=3\ttimestamp\n" +
                    "value 1\tзначение 2\t{\"ключ\": \"число\"}\t1970-01-01T00:00:00.000000Z\n" +
                    "value 2\t\t\t1970-01-01T00:00:00.000000Z\n"
