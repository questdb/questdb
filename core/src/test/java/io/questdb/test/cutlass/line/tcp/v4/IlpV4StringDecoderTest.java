...
import io.questdb.cutlass.line.tcp.v4.IlpV4StringDecoder;
import io.questdb.std.MemoryTag;
import io.questdb.std.Unsafe;
import org.junit.Assert;
import org.junit.Test;

public class IlpV4StringDecoderTest {

    // ==================== Empty Column Tests ====================

    @Test
    public void testDecodeEmptyStringColumn() throws IlpV4ParseException {
        IlpV4StringDecoder.ArrayStringSink sink = new IlpV4StringDecoder.ArrayStringSink(0);
        int consumed = IlpV4StringDecoder.INSTANCE.decode(0, 0, 0, false, sink);
    ...
    @Test
    public void testDecodeSingleString() throws IlpV4ParseException {
        String[] values = {"hello"};

        int size = IlpV4StringDecoder.encodedSize(values, null);
        long address = Unsafe.malloc(size, MemoryTag.NATIVE_DEFAULT);
        try {
            long end = IlpV4StringDecoder.encode(address, values, null);
            Assert.assertEquals(size, end - address);

            IlpV4StringDecoder.ArrayStringSink sink = new IlpV4StringDecoder.ArrayStringSink(1);
            int consumed = IlpV4StringDecoder.INSTANCE.decode(address, size, 1, false, sink);
    ...
    @Test
    public void testDecodeMultipleStrings() throws IlpV4ParseException {
        ...
        long address = Unsafe.malloc(size, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4StringDecoder.encode(address, values, null);

            IlpV4StringDecoder.ArrayStringSink sink = new IlpV4StringDecoder.ArrayStringSink(rowCount);
            int consumed = IlpV4StringDecoder.INSTANCE.decode(address, size, rowCount, false, sink);
    ...
    @Test
    public void testDecodeEmptyStrings() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeAllEmptyStrings() throws IlpV4ParseException {
        String[] values = {"", "", ""};
        int rowCount = values.length;
    ...
    @Test
    public void testDecodeUtf8Strings() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeUtf8MultiByte() throws IlpV4ParseException {
        ...
        try {
            ...
            IlpV4StringDecoder.ArrayStringSink sink = new IlpV4StringDecoder.ArrayStringSink(rowCount);
            IlpV4StringDecoder.INSTANCE.decode(address, size, rowCount, false, sink);
    ...
    public void testDecodeWithNulls() throws IlpV4ParseException {
        ...
        int size = IlpV4StringDecoder.encodedSize(encodeValues, nulls);
        long address = Unsafe.malloc(size, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4StringDecoder.encode(address, encodeValues, nulls);

            IlpV4StringDecoder.ArrayStringSink sink = new IlpV4StringDecoder.ArrayStringSink(rowCount);
            int consumed = IlpV4StringDecoder.INSTANCE.decode(address, size, rowCount, true, sink);
    ...
    public void testDecodeAllNulls() throws IlpV4ParseException {
        ...
        int size = IlpV4StringDecoder.encodedSize(values, nulls);
        long address = Unsafe.malloc(size, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4StringDecoder.encode(address, values, nulls);

            IlpV4StringDecoder.ArrayStringSink sink = new IlpV4StringDecoder.ArrayStringSink(rowCount);
            IlpV4StringDecoder.INSTANCE.decode(address, size, rowCount, true, sink);
    ...
    public void testOffsetArrayFirstOffsetMustBeZero() {
        ...
        try {
            ...
            Assert.assertEquals(IlpV4ParseException.ErrorCode.INVALID_OFFSET_ARRAY, e.getErrorCode());
    ...
    @Test
    public void testStringLargeColumn() throws IlpV4ParseException {
        int rowCount = 10000;
    ...
    @Test
    public void testStringMaxLength() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeVarcharSameAsString() throws IlpV4ParseException {
    ...
    public void testEncodeToByteArray() throws IlpV4ParseException {
        ...
        int offset = IlpV4StringDecoder.encode(buf, 0, values, null);
