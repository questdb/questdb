 ...
 */
public class IlpV4WebSocketHttpProcessorTest extends AbstractWebSocketTest {
    ...
    public void testIsWebSocketUpgradeWithValidHeaders() {
        ...
        Assert.assertTrue(IlpV4WebSocketHttpProcessor.isWebSocketUpgradeRequest(header));
    }
    ...
    public void testIsWebSocketUpgradeWithMissingUpgradeHeader() {
        ...
        Assert.assertFalse(IlpV4WebSocketHttpProcessor.isWebSocketUpgradeRequest(header));
    }
    ...
    // These are covered by integration tests (IlpV4WebSocketHandshakeTest, etc.)
    ...
    public void testValidateHandshakeSuccess() {
        ...
        String error = IlpV4WebSocketHttpProcessor.validateHandshake(header);
    ...
    public void testGetWebSocketKey() {
        ...
        Utf8Sequence key = IlpV4WebSocketHttpProcessor.getWebSocketKey(header);
