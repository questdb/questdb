...
import io.questdb.cutlass.line.tcp.v4.IlpV4TimestampDecoder;
import io.questdb.std.MemoryTag;
import io.questdb.std.Unsafe;
import org.junit.Assert;
import org.junit.Test;

public class IlpV4TimestampDecoderTest {

    // ==================== Uncompressed Timestamp Tests ====================

    @Test
    public void testDecodeUncompressedTimestamps() throws IlpV4ParseException {
        ...
        try {
            long end = IlpV4TimestampDecoder.encodeUncompressed(address, timestamps, null);
            ...
            int consumed = IlpV4TimestampDecoder.INSTANCE.decode(address, size, rowCount, false, sink);
    ...
    @Test
    public void testDecodeUncompressedWithNulls() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeZeroRows() throws IlpV4ParseException {
        IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(0);
        int consumed = IlpV4TimestampDecoder.INSTANCE.decode(0, 0, 0, false, sink);
    ...
    @Test
    public void testDecodeGorillaEncodingFlag() throws IlpV4ParseException {
        ...
        long address = Unsafe.malloc(size, MemoryTag.NATIVE_DEFAULT);
        try {
            long end = IlpV4TimestampDecoder.encodeGorilla(address, timestamps, null);
            Assert.assertEquals(size, end - address);

            // Verify encoding flag
            Assert.assertEquals(IlpV4TimestampDecoder.ENCODING_GORILLA, Unsafe.getUnsafe().getByte(address));
    ...
    @Test
    public void testDecodeGorillaTwoTimestamps() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaDeltaZero() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaDeltaSmall() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaDeltaSmallNegative() throws IlpV4ParseException {
        // Negative small DoD
    ...
    @Test
    public void testDecodeGorillaDeltaMedium() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaDeltaMediumNegative() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaDeltaLarge() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaDeltaLargeNegative() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaDeltaHuge() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaMixedBuckets() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaRegularInterval() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaIrregularInterval() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaWithNulls() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaSignedValues() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaBitAlignment() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaLargeColumn() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeGorillaRoundTrip() throws IlpV4ParseException {
    ...
    public void testDecodeIncompleteData() {
        ...
        try {
            IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(5);
            // Only 1 byte but need at least encoding flag + 8 bytes for first timestamp
            Assert.assertThrows(IlpV4ParseException.class, () ->
                    IlpV4TimestampDecoder.INSTANCE.decode(address, 1, 5, false, sink));
        } finally {
    ...
    public void testDecodeInvalidEncodingFlag() {
        ...
        try {
            ...
            IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(1);
            Assert.assertThrows(IlpV4ParseException.class, () ->
                    IlpV4TimestampDecoder.INSTANCE.decode(address, 100, 1, false, sink));
        } finally {
    ...
    public void testDecodeInsufficientDataForFirstTimestamp() {
        ...
        try {
            Unsafe.getUnsafe().putByte(address, IlpV4TimestampDecoder.ENCODING_GORILLA);

            IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(1);
            Assert.assertThrows(IlpV4ParseException.class, () ->
                    IlpV4TimestampDecoder.INSTANCE.decode(address, 5, 1, false, sink));
        } finally {
    ...
    public void testDecodeInsufficientDataForSecondTimestamp() {
        ...
        try {
            ...
            IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(2);
            Assert.assertThrows(IlpV4ParseException.class, () ->
                    IlpV4TimestampDecoder.INSTANCE.decode(address, 12, 2, false, sink));
        } finally {
    ...
    public void testExpectedSize() {
        ...
        Assert.assertEquals(expected, IlpV4TimestampDecoder.INSTANCE.expectedSize(rowCount, false));

        // With nullable
        int bitmapSize = (rowCount + 7) / 8;
        expected = bitmapSize + 1 + rowCount * 8;
        Assert.assertEquals(expected, IlpV4TimestampDecoder.INSTANCE.expectedSize(rowCount, true));
    }
    ...
    public void testCalculateGorillaSize() {
        ...
        long[] timestamps = {1000L, 2000L, 3000L, 4000L, 5000L};
        int size = IlpV4TimestampDecoder.calculateGorillaSize(timestamps, false);
    ...
    private void testGorillaRoundTrip(long[] timestamps, boolean[] nulls) throws IlpV4ParseException {
        int rowCount = timestamps.length;
        boolean nullable = nulls != null;

        // Calculate size and allocate buffer
        int maxSize = IlpV4TimestampDecoder.calculateGorillaSize(timestamps, nullable) + 100; // extra padding
        long address = Unsafe.malloc(maxSize, MemoryTag.NATIVE_DEFAULT);
        try {
            // Encode
            long end = IlpV4TimestampDecoder.encodeGorilla(address, timestamps, nulls);
            int actualSize = (int) (end - address);

            // Decode
            IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(rowCount);
            int consumed = IlpV4TimestampDecoder.INSTANCE.decode(address, actualSize, rowCount, nullable, sink);
