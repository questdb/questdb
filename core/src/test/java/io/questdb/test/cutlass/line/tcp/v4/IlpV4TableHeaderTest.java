...
import io.questdb.cutlass.line.tcp.v4.IlpV4TableHeader;
...
public class IlpV4TableHeaderTest {

    // ==================== Table Name Tests ====================

    @Test
    public void testParseTableName() throws IlpV4ParseException {
    ...
    public void testTableNameEmpty() {
        ...
        int offset = 0;
        offset = IlpV4Varint.encode(buf, offset, 0); // name length = 0
    ...
    @Test
    public void testTableNameMaxLength() throws IlpV4ParseException {
        // Create table name at max length
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < IlpV4Constants.MAX_TABLE_NAME_LENGTH; i++) {
            sb.append('a');
        }
    ...
    public void testTableNameTooLong() {
        ...
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < IlpV4Constants.MAX_TABLE_NAME_LENGTH + 1; i++) {
            sb.append('a');
        }
        String tableName = sb.toString();
        byte[] buf = encodeTableHeader(tableName, 1, 1);
    ...
    @Test
    public void testTableNameUtf8() throws IlpV4ParseException {
    ...
    @Test
    public void testTableNameUnicode() throws IlpV4ParseException {
    ...
    @Test
    public void testRowCountVarint() throws IlpV4ParseException {
    ...
    @Test
    public void testRowCountMax() throws IlpV4ParseException {
    ...
    @Test
    public void testRowCountLarge() throws IlpV4ParseException {
    ...
    @Test
    public void testColumnCountZero() throws IlpV4ParseException {
    ...
    @Test
    public void testColumnCountVarint() throws IlpV4ParseException {
    ...
    @Test
    public void testColumnCountMax() throws IlpV4ParseException {
    ...
    @Test
    public void testParseMultipleTableHeaders() throws IlpV4ParseException {
    ...
    public void testEncodeDecodeRoundTrip() throws IlpV4ParseException {
        IlpV4TableHeader original = new IlpV4TableHeader();
    ...
    private byte[] encodeTableHeader(String tableName, long rowCount, int columnCount) {
        ...
        int size = IlpV4Varint.encodedLength(nameBytes.length) +
                nameBytes.length +
        ...
        IlpV4Varint.encode(buf, offset, columnCount);
