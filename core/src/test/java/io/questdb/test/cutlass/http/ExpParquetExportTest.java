        ...
        getExportTester()
                .run((engine, sqlExecutionContext) -> {
                    engine.execute("CREATE TABLE basic_parquet_test AS (" +
                            ...
                            ")", sqlExecutionContext);
                    testHttpClient.assertGetParquet("/exp", 1232, "basic_parquet_test");
        ...
        getExportTester().withMicrosecondClock(() -> 3000000L)
                .run((engine, sqlExecutionContext) -> {
                    ...
                    engine.execute("CREATE TABLE basic_parquet_test AS (" +
                            ...
                            "FROM long_sequence(5)" +
                            ")", sqlExecutionContext);
                    testHttpClient.assertGetParquet("/exp", 1190, "select * from basic_parquet_test where ts < now()");
                });
    }
                            ...
                            try {
                                try (TestHttpClient client = new TestHttpClient()) {
                                    ...
                                    for (int n = 0; n < requestsPerThread; n++) {
                                        ...
                                        client.assertGetParquet("/exp", 1674, params, null);
                                    }
                                }
                            } catch (Throwable e) {
    ...
    public void testParquetExportBloomFilterColumnsMultiple() throws Exception {
        getExportTester()
                .run((engine, sqlExecutionContext) -> {
                    ...
                    params.clear();
                    params.put("fmt", "parquet");
                    testHttpClient.assertGetParquet("/exp", 128339, params, "SELECT * FROM bloom_multi_test");
                    params.put("bloom_filter_columns", "id,name,value");
                    params.put("bloom_filter_fpp", "0.05");
                    testHttpClient.assertGetParquet("/exp", 177566, params, "SELECT * FROM bloom_multi_test");
                });
    }
    ...
    public void testParquetExportBloomFilterColumnsSingle() throws Exception {
        getExportTester()
                .run((engine, sqlExecutionContext) -> {
                    ...
                    params.clear();
                    params.put("fmt", "parquet");
                    testHttpClient.assertGetParquet("/exp", 81760, params, "SELECT * FROM bloom_single_test");
                    params.put("bloom_filter_columns", "id");
                    testHttpClient.assertGetParquet("/exp", 98169, params, "SELECT * FROM bloom_single_test");
                });
    }
    ...
    public void testParquetExportBloomFilterColumnsWithSpaces() throws Exception {
        getExportTester()
                .run((engine, sqlExecutionContext) -> {
                    ...
                    params.put("fmt", "parquet");
                    params.put("bloom_filter_columns", " id , name , value ");
                    testHttpClient.assertGetParquet("/exp", 19880, params, "bloom_spaces_test");
                    params.put("bloom_filter_columns", "id ,name,value");
                    testHttpClient.assertGetParquet("/exp", 19880, params, "bloom_spaces_test");
                });
    }
    ...
    public void testParquetExportLargeDataset() throws Exception {
        getExportTester()
                .run((engine, sqlExecutionContext) -> {
                    ...
                    testHttpClient.assertGetParquet("/exp", 926543, params, "SELECT * FROM large_export_test");
                });
    }
                            ...
                            try {
                                for (int n = 0; n < requests; n++) {
                                    ...
                                    try (TestHttpClient client = new TestHttpClient()) {
                                        ...
                                        client.assertGetParquet("/exp", 1232, params, null);
                                    } catch (Throwable ex) {
        ...
        TestUtils.assertMemoryLeak(() -> {
            ...
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                try (var httpClient = new TestHttpClient()) {
                    httpClient.assertGetParquet(serverMain.getHttpServerPort(), "/exp", "200", 1232, "basic_parquet_test");
                }
            }
        });
    }
    ...
    public void testParquetExportWithMultipleDataTypes() throws Exception {
        getExportTester()
                .run((engine, sqlExecutionContext) -> {
                    ...
                    testHttpClient.assertGetParquet("/exp", 1970, tableName);
                });
    }
