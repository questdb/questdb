...
import io.questdb.cutlass.ilpv4.protocol.IlpV4SchemaHash;
...
public class IlpV4SchemaHashTest {

    @Test
    public void testEmptySchema() {
        String[] names = {};
        byte[] types = {};
        long hash = IlpV4SchemaHash.computeSchemaHash(names, types);
        // Empty input should produce the same hash consistently
        Assert.assertEquals(hash, IlpV4SchemaHash.computeSchemaHash(names, types));
    }
    ...
    public void testColumnOrderMatters() {
        ...
        long hash1 = IlpV4SchemaHash.computeSchemaHash(names1, types1);
        long hash2 = IlpV4SchemaHash.computeSchemaHash(names2, types2);
    ...
    public void testTypeAffectsHash() {
        ...
        long hash1 = IlpV4SchemaHash.computeSchemaHash(names, types1);
        long hash2 = IlpV4SchemaHash.computeSchemaHash(names, types2);
    ...
    public void testNameAffectsHash() {
        ...
        long hash1 = IlpV4SchemaHash.computeSchemaHash(names1, types);
        long hash2 = IlpV4SchemaHash.computeSchemaHash(names2, types);
    ...
    public void testDeterministic() {
        ...
        long hash1 = IlpV4SchemaHash.computeSchemaHash(names, types);
        long hash2 = IlpV4SchemaHash.computeSchemaHash(names, types);
        long hash3 = IlpV4SchemaHash.computeSchemaHash(names, types);
    ...
    public void testXXHash64KnownValue() {
        ...
        long hash = IlpV4SchemaHash.hash(data);
    ...
    public void testXXHash64LongerString() {
        ...
        long hash1 = IlpV4SchemaHash.hash(data);
        long hash2 = IlpV4SchemaHash.hash(data);
    ...
    public void testXXHash64DirectMemory() {
        ...
        try {
            ...
            long hashFromBytes = IlpV4SchemaHash.hash(data);
            long hashFromMem = IlpV4SchemaHash.hash(addr, data.length);
    ...
    public void testHasherStreaming() {
        ...
        // One-shot
        long oneShot = IlpV4SchemaHash.hash(data);

        // Streaming - byte by byte
        IlpV4SchemaHash.Hasher hasher = new IlpV4SchemaHash.Hasher();
        hasher.reset(0);
        for (byte b : data) {
            hasher.update(b);
        }
    ...
    public void testXXHash64Over32Bytes() {
        ...
        Assert.assertEquals(hash, IlpV4SchemaHash.hash(data));
    }
    ...
    public void testXXHash64WithSeed() {
        ...
        long hash0 = IlpV4SchemaHash.hash(data, 0, data.length, 0);
        long hash1 = IlpV4SchemaHash.hash(data, 0, data.length, 1);
        long hash42 = IlpV4SchemaHash.hash(data, 0, data.length, 42);
