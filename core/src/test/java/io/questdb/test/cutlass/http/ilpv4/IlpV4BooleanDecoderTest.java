...
import io.questdb.cutlass.ilpv4.protocol.IlpV4BooleanDecoder;
...
public class IlpV4BooleanDecoderTest {

    // ==================== Basic Boolean Tests ====================

    @Test
    public void testDecodeAllTrue() throws IlpV4ParseException {
        ...
        try {
            IlpV4BooleanDecoder.encode(address, values, null);

            IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(rowCount);
            int consumed = IlpV4BooleanDecoder.INSTANCE.decode(address, size, rowCount, false, sink);
    ...
    @Test
    public void testDecodeAllFalse() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeMixedValues() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeWithNulls() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeAllNulls() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodePartialByte() throws IlpV4ParseException {
    ...
    @Test
    public void testDecodeSingleValue() throws IlpV4ParseException {
        boolean[] values = {true};
        int rowCount = 1;
    ...
    public void testDecodeEmptyColumn() throws IlpV4ParseException {
        ...
        int consumed = IlpV4BooleanDecoder.INSTANCE.decode(0, 0, 0, false, sink);
    ...
    public void testDecodeInsufficientDataForNullBitmap() {
        ...
        try {
            IlpV4BooleanDecoder.INSTANCE.decode(address, 1, 10, true, sink);
    ...
    public void testDecodeInsufficientDataForValues() {
        IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(16);

        // 16 rows need 2 bytes for value bits, we only provide 1
        long address = Unsafe.malloc(1, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BooleanDecoder.INSTANCE.decode(address, 1, 16, false, sink);
            Assert.fail("Expected exception");
        } catch (IlpV4ParseException e) {
            Assert.assertEquals(IlpV4ParseException.ErrorCode.INSUFFICIENT_DATA, e.getErrorCode());
        } finally {
    ...
    public void testEncodeToByteArray() throws IlpV4ParseException {
        ...
        int offset = IlpV4BooleanDecoder.encode(buf, 0, values, nulls);
        ...
        try {
            ...
            IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(rowCount);
            IlpV4BooleanDecoder.INSTANCE.decode(address, size, rowCount, true, sink);
    ...
    public void testExpectedSize() {
        ...
        Assert.assertEquals(1, IlpV4BooleanDecoder.INSTANCE.expectedSize(1, false));
        Assert.assertEquals(1, IlpV4BooleanDecoder.INSTANCE.expectedSize(8, false));
        Assert.assertEquals(2, IlpV4BooleanDecoder.INSTANCE.expectedSize(9, false));
        Assert.assertEquals(2, IlpV4BooleanDecoder.INSTANCE.expectedSize(16, false));
        Assert.assertEquals(125, IlpV4BooleanDecoder.INSTANCE.expectedSize(1000, false));

        // Nullable: null bitmap + value bitmap
        Assert.assertEquals(2, IlpV4BooleanDecoder.INSTANCE.expectedSize(1, true));
        Assert.assertEquals(2, IlpV4BooleanDecoder.INSTANCE.expectedSize(8, true));
        Assert.assertEquals(4, IlpV4BooleanDecoder.INSTANCE.expectedSize(9, true));
        Assert.assertEquals(4, IlpV4BooleanDecoder.INSTANCE.expectedSize(16, true));
        Assert.assertEquals(250, IlpV4BooleanDecoder.INSTANCE.expectedSize(1000, true));
    }

    // ==================== Bit Order Tests ====================

    @Test
    public void testBitOrderLsbFirst() throws IlpV4ParseException {
        ...
        try {
            ...
            IlpV4ColumnDecoder.ArrayColumnSink sink = new IlpV4ColumnDecoder.ArrayColumnSink(rowCount);
            IlpV4BooleanDecoder.INSTANCE.decode(address, size, rowCount, false, sink);
    ...
    @Test
    public void testBitOrderMsbOfByte() throws IlpV4ParseException {
