...
public class WebSocketConnectionContextTest extends AbstractWebSocketTest {
    ...
    @Test
    public void testBufferCleanupOnClose() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testClearResetsCloseState() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testClearResetsFragmentState() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
    ...
    @Test
    public void testCloseHandshakeClientInitiated() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
                // Client sends close
    ...
    @Test
    public void testCloseHandshakeServerInitiated() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
    ...
    @Test
    public void testCloseWithEmptyPayload() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testContextClear() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
                // First use
    ...
    @Test
    public void testDefaultMaxMessageSize() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
    ...
    @Test
    public void testHasPendingSend() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
    ...
    @Test
    public void testMultiplePingsGenerateMultiplePongs() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testPingDuringClose() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testPongSentImmediatelyAfterPing() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
                Assert.assertFalse(ctx.hasPendingSend());
    ...
    @Test
    public void testReceiveBufferGrowth() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testReceiveCloseAfterCloseSent() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testReceiveDataAfterCloseSent() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
                ctx.initiateClose(WebSocketCloseCode.NORMAL_CLOSURE, "Normal");
    ...
    @Test
    public void testReceiveEmptyFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testReceiveFragmentedMessage() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testReceiveMultipleFramesInOneRead() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
                byte[] frame1 = createMaskedFrame(WebSocketOpcode.BINARY, new byte[]{1, 2});
    ...
    @Test
    public void testReceivePartialFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testReceivePingDuringFragment() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
                // Start fragmented message
    ...
    @Test
    public void testReceivePongFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testReceiveSingleBinaryFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testReceiveSingleTextFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testRejectContinuationWithoutStart() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testRejectNestedFragmentation() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
    ...
    @Test
    public void testRejectOversizeFragmentedMessage() throws Exception {
        assertMemoryLeak(() -> {
            WebSocketConnectionContext ctx = createContext();
            try (ctx) {
    ...
    @Test
    public void testRejectOversizeMessage() throws Exception {
        assertMemoryLeak(() -> {
            WebSocketConnectionContext ctx = createContext();
            try (ctx) {
    ...
    @Test
    public void testRejectReservedOpcode() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                MockWebSocketProcessor processor = new MockWebSocketProcessor();
                // Reserved opcode 3
    ...
    @Test
    public void testSendBinaryFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                byte[] data = {0x01, 0x02, 0x03, 0x04, 0x05};
    ...
    @Test
    public void testSendCloseFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
    ...
    @Test
    public void testSendLargeFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
    ...
    @Test
    public void testSendPingFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
    ...
    @Test
    public void testSendPongFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                byte[] pingData = {0x01, 0x02, 0x03, 0x04};
    ...
    @Test
    public void testSendTextFrame() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
    ...
    @Test
    public void testSetMaxMessageSize() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                ctx.setMaxMessageSize(1024);
    ...
    @Test
    public void testStateTransitionToClosed() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                ctx.initiateClose(WebSocketCloseCode.NORMAL_CLOSURE, "Normal");
                ctx.onCloseFrameReceived(WebSocketCloseCode.NORMAL_CLOSURE);
    ...
    @Test
    public void testStateTransitionToClosing() throws Exception {
        assertMemoryLeak(() -> {
            try (WebSocketConnectionContext ctx = createContext()) {
                ctx.initiateClose(WebSocketCloseCode.NORMAL_CLOSURE, "Normal");
