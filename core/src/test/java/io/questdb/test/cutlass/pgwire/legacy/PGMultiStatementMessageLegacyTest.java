...
import static io.questdb.test.cutlass.pgwire.legacy.BasePGLegacyTest.Mode.EXTENDED_FOR_PREPARED;
import static io.questdb.test.cutlass.pgwire.legacy.BasePGLegacyTest.Mode.SIMPLE;
import static org.junit.Assert.*;

/**
 * Class contains tests of PostgreSQL simple query statements containing multiple commands separated by ';'
 */
public class PGMultiStatementMessageLegacyTest extends BasePGLegacyTest {
