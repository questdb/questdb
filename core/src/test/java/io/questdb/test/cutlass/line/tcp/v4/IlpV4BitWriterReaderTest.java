...
import io.questdb.cutlass.line.tcp.v4.IlpV4BitReader;
import io.questdb.cutlass.line.tcp.v4.IlpV4BitWriter;
...
public class IlpV4BitWriterReaderTest {

    @Test
    public void testWriteReadSingleBit() throws IlpV4ParseException {
    ...
    @Test
    public void testWriteReadMultipleBits() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testWriteReadCrossByteBoundary() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testWriteReadSignedValues() throws IlpV4ParseException {
    ...
    @Test
    public void testBitAlignment() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testFlushPartialByte() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testReadBeyondWritten() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
            ...
            try {
                ...
                Assert.assertEquals(IlpV4ParseException.ErrorCode.BIT_READ_OVERFLOW, e.getErrorCode());
            }
        } finally {
            Unsafe.free(addr, 16, MemoryTag.NATIVE_DEFAULT);
        }
    ...
    @Test
    public void testRoundTripMixedBitWidths() throws IlpV4ParseException {
    ...
    @Test
    public void testWriteRead64Bits() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testWriteLongValue() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testWriteIntValue() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testPeekBit() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testSkipBits() throws IlpV4ParseException {
        long addr = Unsafe.malloc(16, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 16);
    ...
    @Test
    public void testTotalBitsTracking() throws IlpV4ParseException {
        long addr = Unsafe.malloc(64, MemoryTag.NATIVE_DEFAULT);
        try {
            IlpV4BitWriter writer = new IlpV4BitWriter();
            writer.reset(addr, 64);
    ...
    @Test
    public void testRandomRoundTrip() throws IlpV4ParseException {
