    ...
    public void testCharToCharColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_char_char (" +
                        "col CHAR, " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_char_char");
                serverMain.assertSql(
    ...
    public void testDecimalToDecimal128Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dec_dec128 (" +
                        "col DECIMAL(34, 8), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dec_dec128");
                serverMain.assertSql(
    ...
    public void testDecimalToDecimal256Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dec_dec256 (" +
                        "col DECIMAL(64, 16), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dec_dec256");
                serverMain.assertSql(
    ...
    public void testDecimalToDecimal64Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dec_dec64 (" +
                        "col DECIMAL(16, 4), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dec_dec64");
                serverMain.assertSql(
    ...
    public void testDecimalToSmallDecimalColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dec_smdec (" +
                        "col DECIMAL(8, 2), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dec_smdec");
                serverMain.assertSql(
    ...
    public void testDoubleToDecimal128Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dbl_dec128 (" +
                        "col DECIMAL(34, 8), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dbl_dec128");
                serverMain.assertSql(
    ...
    public void testDoubleToDecimal256Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dbl_dec256 (" +
                        "col DECIMAL(64, 16), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dbl_dec256");
                serverMain.assertSql(
    ...
    public void testDoubleToDecimal64Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dbl_dec64 (" +
                        "col DECIMAL(16, 4), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dbl_dec64");
                serverMain.assertSql(
    ...
    public void testDoubleToFloatColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dbl_flt (" +
                        "col FLOAT, " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dbl_flt");
                serverMain.assertSql(
    ...
    public void testDoubleToSmallDecimalColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_dbl_smdec (" +
                        "col DECIMAL(8, 2), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_dbl_smdec");
                serverMain.assertSql(
    ...
    public void testLongToDecimal128Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_long_dec128 (" +
                        "col DECIMAL(34, 8), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_long_dec128");
                serverMain.assertSql(
    ...
    public void testLongToDecimal256Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_long_dec256 (" +
                        "col DECIMAL(64, 16), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_long_dec256");
                serverMain.assertSql(
    ...
    public void testLongToDecimal64Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_long_dec64 (" +
                        "col DECIMAL(16, 4), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_long_dec64");
                serverMain.assertSql(
    ...
    public void testLongToSmallDecimalColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_long_smdec (" +
                        "col DECIMAL(8, 2), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_long_smdec");
                serverMain.assertSql(
    ...
    public void testLongToTimestampColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_long_ts (" +
                        "col TIMESTAMP, " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_long_ts");
                serverMain.assertSql(
    ...
    public void testStringToCharColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_str_char (" +
                        "col CHAR, " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_str_char");
                serverMain.assertSql(
    ...
    public void testStringToDecimal128Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_str_dec128 (" +
                        "col DECIMAL(34, 8), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_str_dec128");
                serverMain.assertSql(
    ...
    public void testStringToDecimal256Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_str_dec256 (" +
                        "col DECIMAL(64, 16), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_str_dec256");
                serverMain.assertSql(
    ...
    public void testStringToDecimal64Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_str_dec64 (" +
                        "col DECIMAL(16, 4), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_str_dec64");
                serverMain.assertSql(
    ...
    public void testStringToGeoHashColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_str_geo (" +
                        "col GEOHASH(4c), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_str_geo");
                serverMain.assertSql(
    ...
    public void testStringToLong256Column() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_str_l256 (" +
                        "col LONG256, " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_str_l256");
                serverMain.assertSql(
    ...
    public void testStringToSmallDecimalColumn() throws Exception {
        TestUtils.assertMemoryLeak(() -> {
            try (final TestServerMain serverMain = startWithEnvVariables(
                ...
                serverMain.execute("CREATE TABLE tc_str_smdec (" +
                        "col DECIMAL(8, 2), " +
                        "ts TIMESTAMP" +
                        ") TIMESTAMP(ts) PARTITION BY DAY WAL");
                ...
                serverMain.awaitTable("tc_str_smdec");
                serverMain.assertSql(
