 ...
 */
public class IlpV4WebSocketProcessorTest extends AbstractWebSocketTest {
     ...
     */
    private static class RecordingCallback implements IlpV4WebSocketProcessor.Callback {
