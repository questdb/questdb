...
public abstract class BasePGLegacyTest extends AbstractCairoTest {
    ...
    public static final long CONN_AWARE_ALL_SANS_Q =
...
//            assertWithPgServer(Mode.SIMPLE, true, runnable, -1, queryTimeout);
        ...
        if ((bits & BasePGLegacyTest.CONN_AWARE_SIMPLE_TEXT) == BasePGLegacyTest.CONN_AWARE_SIMPLE_TEXT) {
...
//            assertWithPgServer(Mode.SIMPLE, false, runnable, -1, queryTimeout);
        ...
        if ((bits & BasePGLegacyTest.CONN_AWARE_EXTENDED_BINARY) == BasePGLegacyTest.CONN_AWARE_EXTENDED_BINARY) {
        ...
        if ((bits & BasePGLegacyTest.CONN_AWARE_EXTENDED_TEXT) == BasePGLegacyTest.CONN_AWARE_EXTENDED_TEXT) {
        ...
        if ((bits & BasePGLegacyTest.CONN_AWARE_EXTENDED_PREPARED_BINARY) == BasePGLegacyTest.CONN_AWARE_EXTENDED_PREPARED_BINARY) {
        ...
        if ((bits & BasePGLegacyTest.CONN_AWARE_EXTENDED_PREPARED_TEXT) == BasePGLegacyTest.CONN_AWARE_EXTENDED_PREPARED_TEXT) {
        ...
        if ((bits & BasePGLegacyTest.CONN_AWARE_EXTENDED_CACHED_BINARY) == BasePGLegacyTest.CONN_AWARE_EXTENDED_CACHED_BINARY) {
        ...
        if ((bits & BasePGLegacyTest.CONN_AWARE_EXTENDED_CACHED_TEXT) == BasePGLegacyTest.CONN_AWARE_EXTENDED_CACHED_TEXT) {
