...
/**
 * Unit tests for IlpV4GorillaEncoder.
 */
public class IlpV4GorillaEncoderUnitTest {

    // ==================== canUseGorilla Tests ====================

    @Test
    public void testCanUseGorilla_emptyArray() {
        Assert.assertTrue(IlpV4GorillaEncoder.canUseGorilla(new long[0], 0));
    }

    @Test
    public void testCanUseGorilla_oneTimestamp() {
        Assert.assertTrue(IlpV4GorillaEncoder.canUseGorilla(new long[]{1000L}, 1));
    }

    @Test
    public void testCanUseGorilla_twoTimestamps() {
        Assert.assertTrue(IlpV4GorillaEncoder.canUseGorilla(new long[]{1000L, 2000L}, 2));
    }
    ...
    public void testCanUseGorilla_constantDelta() {
        ...
        Assert.assertTrue(IlpV4GorillaEncoder.canUseGorilla(timestamps, timestamps.length));
    }
    ...
    public void testCanUseGorilla_largeDoDOutOfRange() {
        ...
        Assert.assertFalse(IlpV4GorillaEncoder.canUseGorilla(timestamps, timestamps.length));
    }
    ...
    public void testCalculateEncodedSize_empty() {
        Assert.assertEquals(0, IlpV4GorillaEncoder.calculateEncodedSize(new long[0], 0));
    }

    @Test
    public void testCalculateEncodedSize_oneTimestamp() {
        Assert.assertEquals(8, IlpV4GorillaEncoder.calculateEncodedSize(new long[]{1000L}, 1));
    }

    @Test
    public void testCalculateEncodedSize_twoTimestamps() {
        Assert.assertEquals(16, IlpV4GorillaEncoder.calculateEncodedSize(new long[]{1000L, 2000L}, 2));
    }
    ...
    public void testCalculateEncodedSize_constantDelta() {
        ...
        int size = IlpV4GorillaEncoder.calculateEncodedSize(timestamps, timestamps.length);
        // Expected: 8 (first) + 8 (second) + ceil(98 bits / 8) bytes = 16 + 13 = 29 bytes
        int expectedBits = (timestamps.length - 2) * 1;
    ...
    public void testCalculateEncodedSize_identicalDeltas() {
        ...
        int size = IlpV4GorillaEncoder.calculateEncodedSize(ts, ts.length);
    ...
    public void testEncodeTimestamps_empty() {
        IlpV4GorillaEncoder encoder = new IlpV4GorillaEncoder();
    ...
    public void testEncodeTimestamps_roundTrip_constantDelta() throws Exception {
        IlpV4GorillaEncoder encoder = new IlpV4GorillaEncoder();
        IlpV4GorillaDecoder decoder = new IlpV4GorillaDecoder();
        ...
        int size = IlpV4GorillaEncoder.calculateEncodedSize(timestamps, timestamps.length) + 16;
    ...
    public void testEncodeTimestamps_roundTrip_largeDataset() throws Exception {
        ...
        int size = IlpV4GorillaEncoder.calculateEncodedSize(timestamps, count) + 100;
        long address = Unsafe.malloc(size, MemoryTag.NATIVE_DEFAULT);
        try {
