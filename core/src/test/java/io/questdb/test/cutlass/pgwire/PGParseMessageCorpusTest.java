...
public class PGParseMessageCorpusTest extends AbstractCairoTest {
    ...
    public void testCorpusReplay() throws Exception {
            ...
            try (PGFuzzHarness harness = new PGFuzzHarness(engine)) {
                ...
                try {
                    replayCount[0] = PGFuzzCorpus.replay(
                            PGParseMessageCorpusTest.class,
                            "/pgwire-corpus",
                            PGParseMessageFuzz::fuzzerTestOneInput
                    );
                } finally {
        ...
        Assert.assertTrue("empty pgwire corpus", replayCount[0] > 0);
    }
}
