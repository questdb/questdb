 ...
 */
public class IlpV4WebSocketServerIntegrationTest extends AbstractWebSocketTest {
    ...
    // ==================== ILP V4 SPECIFIC TESTS ====================

    @Test
    public void testIlpV4BinaryMessageProcessing() throws Exception {
    ...
    @Test
    public void testIlpV4ProcessorCallbackIntegration() throws Exception {
        IlpV4WebSocketProcessor processor = new IlpV4WebSocketProcessor();
        AtomicInteger binaryCount = new AtomicInteger(0);
        AtomicInteger closeCount = new AtomicInteger(0);

        processor.setCallback(new IlpV4WebSocketProcessor.Callback() {
            @Override
