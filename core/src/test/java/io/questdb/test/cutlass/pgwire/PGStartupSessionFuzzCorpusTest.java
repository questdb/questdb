...
public class PGStartupSessionFuzzCorpusTest extends AbstractCairoTest {
    ...
    public void testCorpusReplay() throws Exception {
            ...
            try (PGFuzzHarness harness = new PGFuzzHarness(engine, false)) {
                ...
                try {
                    replayCount[0] = PGFuzzCorpus.replay(
                            PGStartupSessionFuzzCorpusTest.class,
                            "/pgwire-startup-corpus",
                            PGStartupSessionFuzz::fuzzerTestOneInput
                    );
                } finally {
        ...
        Assert.assertTrue("empty pgwire startup corpus", replayCount[0] > 0);
    }
}
