...
/**
 * Test utility methods for QWP null bitmaps. These methods are used only in
 * tests to construct and inspect bitmap data.
 */
public final class QwpNullBitmapTestUtil {

    private QwpNullBitmapTestUtil() {
        // utility class
    }
