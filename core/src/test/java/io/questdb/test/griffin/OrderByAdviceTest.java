...
public class OrderByAdviceTest extends AbstractCairoTest {
    ...
    @Test
    public void testOrderByEmptyStringDoubleQuote() throws Exception {
        ddl("create table x as (select x a from long_sequence(3))");
    ...
    @Test
    public void testOrderByEmptyStringSingleQuote() throws Exception {
        ddl("create table x as (select x a from long_sequence(3))");
