...
public class ModeGroupByFunctionTest extends AbstractCairoTest {
    ...
    public void testModeAllNull() throws Exception {
        assertQuery("select mode(l) as mode_long, mode(s) as mode_string, mode(v) as mode_varchar from tab")
    ...
    public void testModeEmpty() throws Exception {
        assertQuery("select mode(l) as mode_long, mode(s) as mode_string, mode(v) as mode_varchar from tab")
                .ddl("create table tab (l long, s string, v varchar)")
                .noRandomAccess()
                .expectSize()
                .returns("""
                        mode_long\tmode_string\tmode_varchar
    ...
    public void testModeWithGroupBy() throws Exception {
        assertQuery("select trader, mode(symbol) as most_frequent_symbol from trades group by trader order by trader")
    ...
    public void testModeWithMixedDataTypes() throws Exception {
        assertQuery("select mode(l) mode_long, mode(d) mode_double, mode(s) mode_string, mode(sym) mode_symbol, mode(b) mode_boolean from tab")
                .ddl("create table tab as (" +
    ...
    public void testModeWithOrderBy() throws Exception {
        assertQuery("select g, mode(f) from tab group by g order by mode(f) desc")
                .ddl("create table tab as (" +
