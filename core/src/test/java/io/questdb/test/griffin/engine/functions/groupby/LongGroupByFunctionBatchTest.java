...
public class LongGroupByFunctionBatchTest {
    ...
    public void testGetColumnIndexRequiresColumnFunction() {
        Assert.assertEquals(-1, new CountLongGroupByFunction(LongConstant.newInstance(1)).getColumnIndex());
        Assert.assertEquals(-1, new SumLongGroupByFunction(LongConstant.newInstance(1)).getColumnIndex());
        Assert.assertEquals(-1, new MinLongGroupByFunction(LongConstant.newInstance(1)).getColumnIndex());
        Assert.assertEquals(-1, new MaxLongGroupByFunction(LongConstant.newInstance(1)).getColumnIndex());
        Assert.assertEquals(-1, new FirstLongGroupByFunction(LongConstant.newInstance(1)).getColumnIndex());
        Assert.assertEquals(-1, new LastLongGroupByFunction(LongConstant.newInstance(1)).getColumnIndex());
    }
