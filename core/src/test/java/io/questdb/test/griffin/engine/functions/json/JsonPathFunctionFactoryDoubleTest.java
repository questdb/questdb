...
public class JsonPathFunctionFactoryDoubleTest extends AbstractFunctionFactoryTest {
    ...
    public void testDefaultNullJsonValue() throws SqlException {
        callFn(utf8("{\"path\": null}"), utf8(".path"), DEFAULT_VALUE_ON_ERROR, 42.5).andAssertDblNan();
    }

    @Test
    public void testDifferentType() throws SqlException {
        callFn(utf8("{\"path\": \"abc\"}"), utf8(".path")).andAssertDblNan();
        callFn(dirUtf8("{\"path\": \"abc\"}"), dirUtf8(".path")).andAssertDblNan();
    }

    @Test
    public void testEmptyJson() throws SqlException {
        callFn(utf8("{}"), utf8(".path")).andAssertDblNan();
    }
    ...
    public void testNullJsonValue() throws SqlException {
        callFn(utf8("{\"path\": null}"), utf8(".path")).andAssertDblNan();
        callFn(utf8("{\"path\": null}"), dirUtf8(".path")).andAssertDblNan();
        callFn(dirUtf8("{\"path\": null}"), utf8(".path")).andAssertDblNan();
        callFn(dirUtf8("{\"path\": null}"), dirUtf8(".path")).andAssertDblNan();
    }
    ...
    public void testStrictDefaultNullJsonValue() throws SqlException {
        callFn(utf8("{\"path\": null}"), utf8(".path"), FAIL_ON_ERROR, 42.0).andAssertDblNan();
    }
    ...
    public void testStrictNullJson() throws SqlException {
        callFn(utf8(null), utf8(".path"), FAIL_ON_ERROR).andAssertDblNan();
    }

    @Test
    public void testStrictNullJsonValue() throws SqlException {
        callFn(utf8("{\"path\": null}"), utf8(".path"), FAIL_ON_ERROR).andAssertDblNan();
    }
