...
public class DoubleArrayAavgFunctionFactoryTest extends AbstractCairoTest {

    @Test
    public void testAllNullArrays() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "aavg\n\n",
                "SELECT aavg(null::double[], null::double[])",
                null,
                false,
                true
        ));
    ...
    public void testDifferentLengths() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "aavg\n[2.0,3.0,5.0]\n",
                "SELECT aavg(ARRAY[1.0, 2.0], ARRAY[3.0, 4.0, 5.0])",
                null,
                false,
                true
        ));
    ...
    public void testNanElements() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "aavg\n[3.0,2.0]\n",
                "SELECT aavg(ARRAY[3.0, null], ARRAY[null, 2.0])",
                null,
                false,
                true
        ));
    ...
    public void testOneNullArray() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "aavg\n[1.0,2.0]\n",
                "SELECT aavg(null::double[], ARRAY[1.0, 2.0])",
                null,
                false,
                true
        ));
    ...
    public void testThreeArraysSameLength() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "aavg\n[3.0,4.0]\n",
                "SELECT aavg(ARRAY[1.0, 2.0], ARRAY[3.0, 4.0], ARRAY[5.0, 6.0])",
                null,
                false,
                true
        ));
    ...
    public void testTwoArraysSameLength() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "aavg\n[2.0,3.0]\n",
                "SELECT aavg(ARRAY[1.0, 2.0], ARRAY[3.0, 4.0])",
                null,
                false,
                true
        ));
