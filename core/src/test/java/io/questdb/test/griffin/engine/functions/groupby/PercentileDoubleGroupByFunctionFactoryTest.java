...
public class PercentileDoubleGroupByFunctionFactoryTest extends AbstractCairoTest {
    ...
    public void testApprox0thPercentileDoubleValues() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertSql(
                    "percentile\n1.0\n",
                    "select percentile(x, 0) from test"
            );
        });
    }
    ...
    public void testApprox100thPercentileDoubleValues() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertSql(
                    "percentile\n103.9375\n",
                    "select percentile(x, 1.0) from test"
            );
        });
    }
    ...
    public void testApprox50thPercentileDoubleValues() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertSql(
                    "percentile\n51.9375\n",
                    "select percentile(x, 0.5) from test"
            );
        });
    }
    ...
    @Test
    public void testApprox50thPercentileWithPrecision() throws Exception {
        assertMemoryLeak(() -> {
    ...
    public void testApproxPercentilePackedWithPercentileBindVariable() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertSql(
                    "percentile\n5.0\n",
                    "select percentile(x, $1) from test"
            );
        });
    }
    ...
    public void testInvalidPercentile1() throws Exception {
        assertException(
                "select percentile(x::double, 1.1) from long_sequence(1)",
                7,
    ...
    public void testInvalidPercentile2() throws Exception {
        assertException(
                "select percentile(x::double, -1) from long_sequence(1)",
                7,
                "percentile must be between 0.0 and 1.0"
        );
    }
    ...
    public void testInvalidPercentile3() throws Exception {
        assertException(
                "select percentile(x::double, x::double) from long_sequence(1)",
                37,
    ...
    public void testInvalidPercentilePacked1() throws Exception {
        assertException(
                "select percentile(x::double, 1.1, 5) from long_sequence(1)",
                7,
                "percentile must be between 0.0 and 1.0"
        );
    }
    ...
    public void testInvalidPercentilePacked2() throws Exception {
        assertException(
                "select percentile(x::double, -1, 5) from long_sequence(1)",
                7,
                "percentile must be between 0.0 and 1.0"
        );
    }
    ...
    public void testInvalidPercentilePacked3() throws Exception {
        assertException(
                "select percentile(x::double, x::double, 5) from long_sequence(1)",
                37,
                "percentile must be a constant"
        );
    }
    ...
    public void testInvalidPrecision1() throws Exception {
        assertException(
                "select percentile(x::double, 0.5, 6) from long_sequence(1)",
                41,
    ...
    public void testInvalidPrecision2() throws Exception {
        assertException(
                "select percentile(x::double, 0.5, -1) from long_sequence(1)",
                41,
                "precision must be between 0 and 5"
        );
    }
        ...
        assertMemoryLeak(() -> {
            ...
            try {
                assertSql(
                        "percentile\n" +
                                "1.0\n",
                        "select percentile(x, 0.5, 5) from test"
                );
                Assert.fail();
