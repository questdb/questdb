...
public class MaxDoubleGroupByFunctionFactoryTest extends AbstractCairoTest {
    ...
    public void testSampleInterpolateRandomAccessConsistency() throws Exception {
        // Note: "align to first observation" with union all can create buckets before the
        // expected start when the first cursor row doesn't have the minimum timestamp.
        // Use "align to calendar" for consistent behavior with floor division.
        assertQuery(
                """
                        b\tmax\tk
                        PEHN\t0.8445258177211064\t1970-01-03T00:00:00.000000Z
