...
public class UnionAllCastTest extends AbstractCairoTest {
        ...
        public void testDateByte() throws Exception {
                testUnionAll(
                                ...
                                "create table x as (select cast(x as date) a from long_sequence(2))",
                                "create table y as (select cast(x + 2 as byte) b from long_sequence(2))");
        }
        ...
        public void testDateChar() throws Exception {
                testUnionAll(
                                "a\n" +
                                                ...
                                                "1970-01-01T00:00:00.002Z\n",
                                "create table x as (select cast(x as date) a from long_sequence(2))",
                                "create table y as (select cast('2' as char) b from long_sequence(2))",
                                false);
        }
        ...
        public void testDoubleDate() throws Exception {
                testUnionAll(
                                "a\n" +
                                                ...
                                                "10.0\n" +
                                                "20.0\n",
                                "create table x as (select cast(x + 0.5 as double) a from long_sequence(2))",
                                "create table y as (select cast(x * 10 as date) b from long_sequence(2))");
        }
        ...
        public void testDoubleTimestamp() throws Exception {
                testUnionAll(
                                "a\n" +
                                                ...
                                                "20.0\n",
                                "create table x as (select cast(x + 0.5 as double) a from long_sequence(2))",
                                "create table y as (select cast(x * 10 as timestamp) b from long_sequence(2))");
        }
        ...
        public void testFloatDate() throws Exception {
                testUnionAll(
                                "a\n" +
                                                ...
                                                "10.0\n" +
                                                "20.0\n",
                                "create table x as (select cast(x - 0.5 as float) a from long_sequence(2))",
                                "create table y as (select cast(x * 10 as date) b from long_sequence(2))");
        }
        ...
        public void testLongBin() throws Exception {
                assertFailure("create table x as (select rnd_bin(10, 24, 1) a from long_sequence(5))",
                                "create table y as (select rnd_long() b from long_sequence(5))", 0);
        }
        ...
        public void testSymBin() throws Exception {
                assertFailure("create table x as (select rnd_symbol('aa','bb') a from long_sequence(5))",
                                "create table y as (select rnd_bin(10, 24, 1) b from long_sequence(5))", 12);
        }
        ...
        public void testTimestampChar() throws Exception {
                testUnionAll(
                                "a\n" +
                                                ...
                                                "1970-01-01T00:00:00.000002Z\n" +
                                                "1970-01-01T00:00:00.000002Z\n",
                                "create table x as (select cast(x as timestamp) a from long_sequence(2))",
                                "create table y as (select cast('2' as char) b from long_sequence(2))",
                                false);
        }
        ...
        public void testTimestampFloat() throws Exception {
                testUnionAll(
                                "a\n" +
                                                ...
                                                "100.0\n" +
                                                "200.0\n",
                                "create table x as (select cast(x * 10 as timestamp) a from long_sequence(2))",
                                "create table y as (select cast(x * 100 as float) b from long_sequence(2))");
        }
