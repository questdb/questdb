...
public class BoolOrGroupByFunctionFactoryTest extends AbstractCairoTest {
    ...
    public void testBoolOrAllTrue() throws Exception {
        assertQuery("select bool_or(f) from tab")
    ...
    public void testBoolOrSingleFalse() throws Exception {
        assertQuery("select bool_or(f) from tab")
                .ddl("create table tab as (select false as f from long_sequence(1))")
                .noRandomAccess()
                .expectSize()
                .returns("""
                        bool_or
    ...
    public void testBoolOrWithGroupBy() throws Exception {
        assertQuery("select g, bool_or(f) from tab order by g")
                .ddl("create table tab as (" +
    ...
    public void testBoolOrWithExpression() throws Exception {
        ...
        assertQuery("select bool_or(x > 5) from tab")
    ...
    public void testBoolOrWithSampleBy() throws Exception {
        assertQuery("select k, bool_or(f) from tab sample by 1h")
                .ddl("create table tab as (" +
                        "select false as f, " +
    ...
    public void testBoolOrConstantTrue() throws Exception {
        ...
        assertQuery("select bool_or(true) from tab")
    ...
    public void testBoolOrConstantFalse() throws Exception {
        ...
        assertQuery("select bool_or(false) from tab")
                .ddl("create table tab as (select x from long_sequence(5))")
                .expectSize()
                .returns("""
                        bool_or
