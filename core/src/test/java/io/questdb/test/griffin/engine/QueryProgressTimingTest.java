...
public class QueryProgressTimingTest extends AbstractCairoTest {
    ...
    public void testCachedFactoryReopenResetsTimingState() throws Exception {
        assertMemoryLeak(() -> {
            ...
            Assert.assertEquals(Numbers.LONG_NULL, firstTrace.resourceGroupCpuWaitNanos);
            ...
            Assert.assertEquals(Numbers.LONG_NULL, secondTrace.resourceGroupCpuWaitNanos);
    ...
    public void testNoRowsLeavesFirstRowUnset() throws Exception {
        assertMemoryLeak(() -> {
            ...
            Assert.assertEquals(Numbers.LONG_NULL, trace.resourceGroupCpuWaitNanos);
        });
    }
