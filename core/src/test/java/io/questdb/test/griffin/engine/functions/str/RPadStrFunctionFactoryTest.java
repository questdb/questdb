...
import io.questdb.griffin.engine.functions.str.RPadStrVarcharFunctionFactory;
...
public class RPadStrFunctionFactoryTest extends AbstractFunctionFactoryTest {
    static final String SIGNATURE_UTF16 = "rpad(SIS)";
    static final String SIGNATURE_UTF8 = "rpad(ØIØ)";
    ...
    public RPadStrFunctionFactoryTest(boolean utf8) {
        this.utf8 = utf8;
    }
    ...
    public void testRPadStr() throws SqlException {
        callFn("abc", 5, "x").andAssert("abcxx");
        callFn("xyz", 10, "hello").andAssert("xyzhellohe");
        callFn("pqrs", 10, "abc").andAssert("pqrsabcabc");
        callFn("пєрєувєлічєніє", 26, "відіть").andAssert("пєрєувєлічєнієвідітьвідіть");
    }

    @Test
    public void testTrimLeft() throws SqlException {
        callFn("abcdefgh", 5, "abc").andAssert("defgh");
        callFn("photosynthesis", 10, "light").andAssert("osynthesis");
    }
    ...
    protected FunctionFactory getFunctionFactory() {
        if (utf8) {
            return new RPadStrVarcharFunctionFactory();
        }
