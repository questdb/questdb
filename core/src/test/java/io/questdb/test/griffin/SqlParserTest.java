...
public class SqlParserTest extends AbstractSqlParserTest {
    ...
    public void testOrderByWithSampleBy2() throws SqlException {
        ...
        assertQuery(
                "select-group-by a, sum(b) sum from (select-choose [a, b] a, b from (select-group-by [a, sum(b) b, timestamp_floor('10m',t,null,'00:00') t] a, sum(b) b, timestamp_floor('10m',t,null,'00:00') t from (select-choose [t, a, b] a, b, t from (select [t, a, b] from tab) order by t) timestamp (t))) order by a",
    ...
    public void testSampleBy() throws Exception {
        ...
        assertQuery(
                "select-choose x, sum from (select-group-by [x, sum(y) sum, timestamp_floor('2m',timestamp,null,'00:00') timestamp] x, sum(y) sum, timestamp_floor('2m',timestamp,null,'00:00') timestamp from (select [x, y, timestamp] from tab timestamp (timestamp) stride 2m) order by timestamp)",
    ...
    public void testSampleBy2() throws Exception {
        ...
        assertQuery(
                "select-choose x, sum from (select-group-by [x, sum(y) sum, timestamp_floor('2U',timestamp,null,'00:00') timestamp] x, sum(y) sum, timestamp_floor('2U',timestamp,null,'00:00') timestamp from (select [x, y, timestamp] from tab timestamp (timestamp) stride 2U) order by timestamp)",
    ...
    public void testSampleByAliasedColumn() throws SqlException {
        ...
        assertQuery(
                "select-choose b, sum, k, k1 from (select-group-by [b, sum(a) sum, k, k k1, timestamp_floor('3h',timestamp,null,'00:00') timestamp] b, sum(a) sum, k, k k1, timestamp_floor('3h',timestamp,null,'00:00') timestamp from (select [b, a, k, timestamp] from x y timestamp (timestamp) stride 3h) y order by timestamp)",
    ...
    public void testSampleByAlreadySelected() throws Exception {
        ...
        assertQuery(
                "select-group-by timestamp_floor('2m',x,null,'00:00') x, sum(y) sum from (select [x, y] from tab timestamp (x) stride 2m) order by x",
    ...
    public void testSampleByAltTimestamp() throws Exception {
        ...
        assertQuery(
                "select-choose x, sum from (select-group-by [x, sum(y) sum, timestamp_floor('2m',t,null,'00:00') t] x, sum(y) sum, timestamp_floor('2m',t,null,'00:00') t from (select [x, y, t] from tab timestamp (t) stride 2m) order by t)",
    ...
    public void testSampleByFromToBasicSyntax() throws SqlException {
        assertQuery(
                "select-group-by timestamp_floor('5m',ts,'2018-01-01','10:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) where ts >= '2018-01-01' and ts < '2019-01-01' from '2018-01-01' to '2019-01-01' stride 5m) order by ts",
    ...
    public void testSampleByFromToBasicSyntaxWithRewrite() throws SqlException {
        assertQuery(
                "select-group-by timestamp_floor('5m',ts,'2018-01-01','00:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) where ts >= '2018-01-01' and ts < '2019-01-01' from '2018-01-01' to '2019-01-01' stride 5m) order by ts",
    ...
    public void testSampleByFromToJustFromOnItsOwn() throws SqlException {
        assertQuery(
                "select-group-by timestamp_floor('5m',ts,'2018-01-01','10:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) where ts >= '2018-01-01' from '2018-01-01' stride 5m) order by ts",
    ...
    public void testSampleByFromToJustFromOnItsOwnWithRewrite() throws SqlException {
        assertQuery(
                "select-group-by timestamp_floor('5m',ts,'2018','00:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) where ts >= '2018' from '2018' stride 5m) order by ts",
    ...
    public void testSampleByNoKeyOffsetBindVariableRewrite() throws SqlException {
        assertQuery(
                "select-choose avg from (select-group-by [avg(price) avg, timestamp_floor('5m',ts,null,$1) ts] avg(price) avg, timestamp_floor('5m',ts,null,$1) ts from (select [price, ts] from tbl timestamp (ts) stride 5m) order by ts)",
    ...
    public void testSampleByNoKeyOffsetRewrite() throws SqlException {
        assertQuery(
                "select-choose avg from (select-group-by [avg(price) avg, timestamp_floor('5m',ts,null,'01:15') ts] avg(price) avg, timestamp_floor('5m',ts,null,'01:15') ts from (select [price, ts] from tbl timestamp (ts) stride 5m) order by ts)",
    ...
    public void testSampleByNoKeyTimeZoneAndOffsetRewrite() throws SqlException {
        assertQuery(
                "select-choose avg from (select-virtual [avg, to_utc(ts,'Europe/Berlin') ts] avg, to_utc(ts,'Europe/Berlin') ts from (select-group-by [timestamp_floor('5m',to_timezone(ts,'Europe/Berlin'),null,'01:15') ts, avg(price) avg] avg(price) avg, timestamp_floor('5m',to_timezone(ts,'Europe/Berlin'),null,'01:15') ts from (select [ts, price] from tbl timestamp (ts) stride 5m)) timestamp (ts) order by ts)",
    ...
    public void testSampleByNoKeyTimeZoneBindVariableRewrite() throws SqlException {
        assertQuery(
                "select-choose avg from (select-virtual [avg, to_utc(ts,$1) ts] avg, to_utc(ts,$1) ts from (select-group-by [timestamp_floor('5m',to_timezone(ts,$1),null,'00:00') ts, avg(price) avg] avg(price) avg, timestamp_floor('5m',to_timezone(ts,$1),null,'00:00') ts from (select [ts, price] from tbl timestamp (ts) stride 5m)) timestamp (ts) order by ts)",
    ...
    public void testSampleByNoKeyTimeZoneRewrite() throws SqlException {
        assertQuery(
                "select-choose avg from (select-virtual [avg, to_utc(ts,'Europe/Berlin') ts] avg, to_utc(ts,'Europe/Berlin') ts from (select-group-by [timestamp_floor('5m',to_timezone(ts,'Europe/Berlin'),null,'00:00') ts, avg(price) avg] avg(price) avg, timestamp_floor('5m',to_timezone(ts,'Europe/Berlin'),null,'00:00') ts from (select [ts, price] from tbl timestamp (ts) stride 5m)) timestamp (ts) order by ts)",
    ...
    public void testSampleBySelectStar() throws Exception {
        ...
        assertQuery(
                "select-choose column from (select-virtual [avg * 10 column, timestamp] avg * 10 column, timestamp from (select-group-by [avg(usage_user) avg, timestamp_floor('1d',timestamp,null,'00:00') timestamp] avg(usage_user) avg, timestamp_floor('1d',timestamp,null,'00:00') timestamp from (select [usage_user, timestamp] from cpu timestamp (timestamp) stride 1d)) order by timestamp)",
    ...
    public void testSampleByTimeZoneBindVariableRewrite() throws SqlException {
        assertQuery(
                "select-virtual to_utc(ts,$1) ts, avg from (select-group-by [timestamp_floor('5m',to_timezone(ts,$1),null,'00:00') ts, avg(price) avg] timestamp_floor('5m',to_timezone(ts,$1),null,'00:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) stride 5m)) timestamp (ts) order by ts",
    ...
    public void testSampleByTimeZoneRewrite() throws SqlException {
        assertQuery(
                "select-virtual to_utc(ts,'Europe/Berlin') ts, avg from (select-group-by [timestamp_floor('5m',to_timezone(ts,'Europe/Berlin'),null,'00:00') ts, avg(price) avg] timestamp_floor('5m',to_timezone(ts,'Europe/Berlin'),null,'00:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) stride 5m)) timestamp (ts) order by ts",
    ...
    public void testSampleByToOnItsOwn() throws SqlException {
        assertQuery(
                "select-group-by timestamp_floor('5m',ts,null,'10:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) where ts < '2019-01-01' to '2019-01-01' stride 5m) order by ts",
    ...
    public void testSampleByToOnItsOwnWithRewrite() throws SqlException {
        assertQuery(
                "select-group-by timestamp_floor('5m',ts,null,'00:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) where ts < '2019-01-01' to '2019-01-01' stride 5m) order by ts",
    ...
    public void testSampleByUnionAll() throws SqlException {
        assertQuery(
                "select-choose b, sum, k1, k from (select-group-by [b, sum(a) sum, k k1, k, timestamp_floor('3h',timestamp,null,'00:00') timestamp] b, sum(a) sum, k k1, k, timestamp_floor('3h',timestamp,null,'00:00') timestamp from (select [b, a, k, timestamp] from x y timestamp (timestamp) stride 3h) y order by timestamp) union all select-choose b, sum, k1, k from (select-group-by [b, sum(a) sum, k k1, k, timestamp_floor('3h',timestamp,null,'00:00') timestamp] b, sum(a) sum, k k1, k, timestamp_floor('3h',timestamp,null,'00:00') timestamp from (select [b, a, k, timestamp] from x y timestamp (timestamp) stride 3h) y order by timestamp)",
    ...
    public void testSampleByUtcTimeZoneAndZeroOffsetRewrite() throws SqlException {
        ...
        assertQuery(
                "select-group-by timestamp_floor('5m',ts,null,'00:00') ts, avg(price) avg from (select [ts, price] from tbl timestamp (ts) stride 5m) order by ts",
