...
public class JsonPathLongFunctionFactoryTest extends AbstractFunctionFactoryTest {
    @Test
    public void testNullJson() throws SqlException {
        call(utf8(null), utf8(".path")).andAssert(Long.MIN_VALUE);
        call(utf8(null), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testDifferentType() throws SqlException {
        call(utf8("{\"path\": \"abc\"}"), utf8(".path")).andAssert(Long.MIN_VALUE);
        call(dirUtf8("{\"path\": \"abc\"}"), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testEmptyJson() throws SqlException {
        call(utf8("{}"), utf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testNullJsonValue() throws SqlException {
        call(utf8("{\"path\": null}"), utf8(".path")).andAssert(Long.MIN_VALUE);
        call(utf8("{\"path\": null}"), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
        call(dirUtf8("{\"path\": null}"), utf8(".path")).andAssert(Long.MIN_VALUE);
        call(dirUtf8("{\"path\": null}"), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
    }
    ...
    public void test10000() throws SqlException {
        ...
        call(utf8("{\"path\": 10000}"), dirUtf8(".path")).andAssert(10000L);
        call(dirUtf8("{\"path\": 10000}"), utf8(".path")).andAssert(10000L);
        call(dirUtf8("{\"path\": 10000}"), dirUtf8(".path")).andAssert(10000L);
    }
    ...
    public void testUnsigned64Bit() throws SqlException {
        call(utf8("{\"path\": 9999999999999999999}"), utf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testBigNumber() throws SqlException {
        call(utf8("{\"path\": 100000000000000000000000000}"), utf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testFloat() throws SqlException {
        call(dirUtf8("{\"path\": 123.45}"), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
    }
    ...
    protected FunctionFactory getFunctionFactory() {
        return new JsonPathLongFunctionFactory();
    }
}
