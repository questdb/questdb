...
public class ArrayAggDoubleArrayGroupByFunctionFactoryTest extends AbstractCairoTest {
    ...
    public void testAllNullArrays() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("""
                    ...
                    (null)
                    """);
            assertQuery("SELECT array_agg(arr) agg FROM tab")
                    .noLeakCheck()
                    .noRandomAccess()
                    .expectSize()
                    .returns("""
    ...
    public void testGroupByCompoundKey() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            execute("""
                    ...
                    """);
            assertQuery("SELECT region, country, array_agg(arr) agg FROM tab GROUP BY region, country ORDER BY region, country")
                    .noLeakCheck()
                    .expectSize()
                    .returns("""
                            region\tcountry\tagg
    ...
    public void testMixedWithOtherAggregates() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("""
                    ...
                    """);
            assertQuery("SELECT grp, array_agg(arr) agg, avg(val) avg FROM tab ORDER BY grp")
                    .noLeakCheck()
                    .expectSize()
                    .returns("""
                            grp\tagg\tavg
    ...
    public void testNonVanilla1DInput() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            execute("""
                    ...
                    """);
            assertQuery("SELECT array_agg(transpose(m)[1]) agg FROM tab")
                    .noLeakCheck()
                    .noRandomAccess()
                    .expectSize()
                    .returns("""
    ...
    public void testSampleBy() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("""
                    ...
                    """);
            assertQuery("SELECT ts, array_agg(arr) agg FROM tab SAMPLE BY 1h ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .expectSize()
                    .returns("""
    ...
    public void testSampleByFillNone() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, array_agg(arr) agg FROM tab SAMPLE BY 1h FILL(NONE)")
                    .noLeakCheck()
                    .timestamp("ts")
                    .expectSize()
                    .returns("""
    ...
    public void testSampleByFillNull() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("""
                    ...
                    """);
            assertQuery("SELECT ts, array_agg(arr) agg FROM tab SAMPLE BY 1h FILL(NULL)")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testSampleByFillPrev() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("""
                    ...
                    """);
            assertQuery("SELECT ts, array_agg(arr) agg FROM tab SAMPLE BY 2h FILL(PREV)")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testSampleByFirstObservation() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            execute("""
                    ...
                    """);
            assertQuery("SELECT ts, array_agg(arr) agg FROM tab SAMPLE BY 3h ALIGN TO FIRST OBSERVATION")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
