...
public class DoubleArrayAsumFunctionFactoryTest extends AbstractCairoTest {

    @Test
    public void testAllNullArrays() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "asum\n\n",
                "SELECT asum(null::double[], null::double[])",
                null,
                false,
                true
        ));
    ...
    public void testDifferentLengths() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "asum\n[4.0,6.0,5.0]\n",
                "SELECT asum(ARRAY[1.0, 2.0], ARRAY[3.0, 4.0, 5.0])",
                null,
                false,
                true
        ));
    ...
    public void testNanElements() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "asum\n[1.0,2.0]\n",
                "SELECT asum(ARRAY[1.0, null], ARRAY[null, 2.0])",
                null,
                false,
                true
        ));
    ...
    public void testOneNullArray() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "asum\n[1.0,2.0]\n",
                "SELECT asum(null::double[], ARRAY[1.0, 2.0])",
                null,
                false,
                true
        ));
    ...
    public void testThreeArraysSameLength() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "asum\n[9.0,12.0]\n",
                "SELECT asum(ARRAY[1.0, 2.0], ARRAY[3.0, 4.0], ARRAY[5.0, 6.0])",
                null,
                false,
                true
        ));
    ...
    public void testTwoArraysSameLength() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "asum\n[4.0,6.0]\n",
                "SELECT asum(ARRAY[1.0, 2.0], ARRAY[3.0, 4.0])",
                null,
                false,
                true
        ));
