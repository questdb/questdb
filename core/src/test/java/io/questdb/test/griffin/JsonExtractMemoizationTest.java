...
public class JsonExtractMemoizationTest extends AbstractCairoTest {
    ...
    public void testJsonExtractMemoization() throws Exception {
        ...
        // byte
        assertQuery("select json_extract(x, '$.byte')::byte as res, res + 1 from t")
                .withPlan("""
                        VirtualRecord
        ...
        // ipv4
        assertQuery("select json_extract(x, '$.ipv4')::ipv4 as res, res + 1 from t")
                .withPlan("""
                        VirtualRecord
        ...
        // timestamp
        assertQuery("select json_extract(x, '$.ts')::timestamp as res, res + 1 from t")
                .withPlan("""
                        VirtualRecord
                          functions: [memoize(json_extract()),res+1]
                            PageFrame
        ...
        // uuid
        assertQuery("select json_extract(x, '$.uuid')::uuid as res, res res1 from t")
                .withPlan("""
                        VirtualRecord
        ...
        // date
        assertQuery("select json_extract(x, '$.date')::date as res, res + 1 from t")
                .withPlan("""
                        VirtualRecord
                          functions: [memoize(json_extract()),res+1]
                            PageFrame
        ...
        // char
        assertQuery("select json_extract(x, '$.char')::char as res, concat(res, 'r') from t")
                .withPlan("""
                        VirtualRecord
        ...
        // boolean
        assertQuery("select json_extract(x, '$.bool')::boolean as res, res res1 from t")
                .withPlan("""
                        VirtualRecord
        ...
        // float
        assertQuery("select json_extract(x, '$.float')::float as res, res + 1 from t")
                .withPlan("""
                        VirtualRecord
                          functions: [memoize(json_extract()),res+1]
                            PageFrame
        ...
        // long256
        assertQuery("select json_extract(x, '$.long256')::long256 as res, res res1 from t")
                .withPlan("""
                        VirtualRecord
    ...
    public void testJsonExtractMemoizationByte() throws Exception {
        ...
        assertQuery("select json_extract(x, '$.a')::byte as res, res + 1 from t")
                .withPlan("""
                        VirtualRecord
                          functions: [memoize(json_extract()::byte),res+1]
                            PageFrame
                ...
                .returns("""
                        ...
                        10\t11
                        """);
        assertQuery("select json_extract(x, '$.b')::byte as res, res + 1 from t")
                .withPlan("""
                        VirtualRecord
                          functions: [memoize(json_extract()::byte),res+1]
                            PageFrame
