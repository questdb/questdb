...
public class UpdateTest extends AbstractCairoTest {
    ...
    @Test
    public void testConvertColumnAfterUpdate() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            if (rnd.nextBoolean()) {
                insert(" insert into up " +
                        " select timestamp_sequence('2022-02-25', 1000000) ts " +
...
//                           "2022-02-25T10:00:00.000000Z\t2\n" +
//                           "2022-02-25T10:00:01.000000Z\t2\n" +
//                           "2022-02-25T10:00:02.000000Z\t2\n" +
//                           "2022-02-25T10:00:03.000000Z\t2\n" +
//                           "2022-02-25T10:00:04.000000Z\t2\n",
//                    "up"
//            );
        });
    }
