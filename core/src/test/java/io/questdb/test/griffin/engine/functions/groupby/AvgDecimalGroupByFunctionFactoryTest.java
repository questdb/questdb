...
public class AvgDecimalGroupByFunctionFactoryTest extends AbstractCairoTest {
    ...
    public void testAvg() throws Exception {
        assertQuery("select avg(d8) a8, avg(d16) a16, avg(d32) a32, avg(d64) a64, avg(d128) a128, avg(d256) a256 from x")
    ...
    public void testAvgAllNull() throws Exception {
        assertQuery("select avg(x) from (select cast(null as decimal(10,2)) x from long_sequence(1000))")
                .noRandomAccess()
                .expectSize()
                .returns("avg\n\n");
    }
    ...
    public void testAvgOverflow() throws Exception {
        assertQuery("select avg(d) from x")
                .ddl("create table x as (" +
