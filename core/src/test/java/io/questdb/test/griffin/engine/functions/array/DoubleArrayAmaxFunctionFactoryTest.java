...
public class DoubleArrayAmaxFunctionFactoryTest extends AbstractCairoTest {

    @Test
    public void testAllNullArrays() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "amax\n\n",
                "SELECT amax(null::double[], null::double[])",
                null,
                false,
                true
        ));
    ...
    public void testDifferentLengths() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "amax\n[3.0,4.0,5.0]\n",
                "SELECT amax(ARRAY[1.0, 2.0], ARRAY[3.0, 4.0, 5.0])",
                null,
                false,
                true
        ));
    ...
    public void testNanElements() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "amax\n[1.0,2.0]\n",
                "SELECT amax(ARRAY[1.0, null], ARRAY[null, 2.0])",
                null,
                false,
                true
        ));
    ...
    public void testOneNullArray() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "amax\n[1.0,2.0]\n",
                "SELECT amax(null::double[], ARRAY[1.0, 2.0])",
                null,
                false,
                true
        ));
    ...
    public void testThreeArraysSameLength() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "amax\n[3.0,4.0]\n",
                "SELECT amax(ARRAY[1.0, 2.0], ARRAY[3.0, 1.0], ARRAY[2.0, 4.0])",
                null,
                false,
                true
        ));
    ...
    public void testTwoArraysSameLength() throws Exception {
        assertMemoryLeak(() -> assertQueryNoLeakCheck(
                "amax\n[3.0,5.0]\n",
                "SELECT amax(ARRAY[1.0, 5.0], ARRAY[3.0, 2.0])",
                null,
                false,
                true
        ));
