...
public class SqlOptimiserTest extends AbstractSqlParserTest {
    ...
    final String orderByAdviceDml = "INSERT INTO t (s, ts) VALUES" + " ('a', '2023-09-01T00:00:00.000Z')," + " ('a', '2023-09-01T00:10:00.000Z')," + " ('a', '2023-09-01T00:20:00.000Z')," + " ('b', '2023-09-01T00:05:00.000Z')," + " ('b', '2023-09-01T00:15:00.000Z')," + " ('b', '2023-09-01T00:25:00.000Z')," + " ('c', '2023-09-01T01:00:00.000Z')," + " ('c', '2023-09-01T02:00:00.000Z')," + " ('c', '2023-09-01T03:00:00.000Z')";
    ...
    public void testAliasAppearsInFuncArgs1() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertPlan(query, "GroupBy vectorized: true workers: 1\n" + "  keys: [x1]\n" + "  values: [sum(x1)]\n" + "    SelectedRecord\n" + "        DataFrame\n" + "            Row forward scan\n" + "            Frame forward scan on: y\n");
        });
    }
    ...
    public void testAliasAppearsInFuncArgs2() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertPlan(query, "GroupBy vectorized: false\n" + "  keys: [concat,x1]\n" + "  values: [sum(x1)]\n" + "    VirtualRecord\n" + "      functions: [concat([lpad(x1::string,5)]),x1]\n" + "        SelectedRecord\n" + "            DataFrame\n" + "                Row forward scan\n" + "                Frame forward scan on: y\n");
        });
    }
    ...
    public void testAliasAppearsInFuncArgs5() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            ArrayDeque<ExpressionNode> sqlNodeStack = new ArrayDeque<>();
            assert aliasAppearsInFuncArgs(model, "x1", sqlNodeStack);
            assertPlan(query, "GroupBy vectorized: true\n" + "  values: [sum(x1)]\n" + "    SelectedRecord\n" + "        DataFrame\n" + "            Row forward scan\n" + "            Frame forward scan on: y\n");
        });
    }
    ...
    public void testNonprefixedAdviceFromOneTableWithOrderingAlias() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertPlan("select tab1.id, tab1.ts as b\n" + "from tab1 join tab2 on tab1.id = tab2.id\n" + "order by b", "SelectedRecord\n" + "    Hash Join Light\n" + "      condition: tab2.id=tab1.id\n" + "        DataFrame\n" + "            Row forward scan\n" + "            Frame forward scan on: tab1\n" + "        Hash\n" + "            DataFrame\n" + "                Row forward scan\n" + "                Frame forward scan on: tab2\n");
        });
    }
    ...
    public void testNonprefixedAdviceFromTheSameTable() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertPlan("select a, b\n" + "from tab1 join tab2 on tab1.id = tab2.id\n" + "order by a desc " + "limit 10", "Limit lo: 10\n" + "    Sort\n" + "      keys: [a desc]\n" + "        SelectedRecord\n" + "            Hash Join Light\n" + "              condition: tab2.id=tab1.id\n" + "                DataFrame\n" + "                    Row forward scan\n" + "                    Frame forward scan on: tab1\n" + "                Hash\n" + "                    DataFrame\n" + "                        Row forward scan\n" + "                        Frame forward scan on: tab2\n");
        });
    }
    ...
    public void testNonprefixedAdviceFromTheSameTableWithTimestamp() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertPlan("select a, b\n" + "from tab1 join tab2 on tab1.id = tab2.id\n" + "order by a desc, ts " + "limit 10", "SelectedRecord\n" + "    Limit lo: 10\n" + "        Sort\n" + "          keys: [a desc, ts]\n" + "            SelectedRecord\n" + "                Hash Join Light\n" + "                  condition: tab2.id=tab1.id\n" + "                    DataFrame\n" + "                        Row forward scan\n" + "                        Frame forward scan on: tab1\n" + "                    Hash\n" + "                        DataFrame\n" + "                            Row forward scan\n" + "                            Frame forward scan on: tab2\n");
        });
    }
    ...
    public void testOrderByAdviceWithMultipleJoinsAndFilters() throws Exception {
        assertMemoryLeak(() -> {
            ...
            insert("insert into WorkflowEventAction (CreateDate, WorkflowEventId, ActionTypeId, Message) values" + " ('2016-01-01T00:00:00Z', to_uuid(1, 1), 13, '2')");
