    ...
    public void testCastExplains() throws Exception {
        assertMemoryLeak(
                () -> {
                    ...
                    assertQuery("WITH data AS (SELECT 123::short AS value) SELECT cast(value as DECIMAL(5, 2)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 123::short AS value) SELECT cast(value as DECIMAL(5, 0)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 123::short AS value) SELECT cast(value as DECIMAL(26, 0)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 123::short AS value) SELECT cast(value as DECIMAL(55, 0)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("SELECT cast(1::short as DECIMAL(5, 2))")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                                      functions: [1.00]
