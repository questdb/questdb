...
public class SampleByFillPrevTest extends AbstractCairoTest {
    ...
    public void testFillPrevAcceptPrevToSelfPrev() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, sum(a) AS a, sum(b) AS b FROM t SAMPLE BY 1h FILL(PREV(b), PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevAllNumericTypes() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, first(f), first(c), first(d8), first(d16), first(d32), first(d64) " +
    ...
    public void testFillPrevBoolean() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, first(v) v FROM t SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevCastMultiKey() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, x::STRING k, first(v) FROM t SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevConcatMultiKey() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, concat(a, b) k, first(v) FROM t SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
        ...
        assertMemoryLeak(() -> {
            ...
            execute("""
                    INSERT INTO t VALUES
                        ('Lon', 'don', 10.0, '2024-01-01T00:00:00.000000Z'),
                        ('Par', 'is', 20.0, '2024-01-01T02:00:00.000000Z')""");
            assertQuery("SELECT ts, a || b k, first(v) FROM t SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevCrossColumnArrayDimsMismatch() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "cannot fill target column of type DOUBLE[][]");
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "source type DOUBLE[]");
        });
    }
    ...
    public void testFillPrevCrossColumnBadAlias() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, sum(val) AS s FROM x SAMPLE BY 1h FILL(PREV(nonexistent)) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(55, "column not found");
        });
    }
    ...
    public void testFillPrevCrossColumnBroadcastRejection() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevLiteralPos, "FILL(PREV(a)) cannot be broadcast across aggregates");
        });
    }
    ...
    public void testFillPrevCrossColumnDecimalPrecisionMismatch() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "cannot fill target column of type DECIMAL(18,6)");
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "source type DECIMAL(10,2)");
        });
    }
    ...
    public void testFillPrevCrossColumnDecimalScaleMismatch() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "cannot fill target column of type DECIMAL(10,4)");
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "source type DECIMAL(10,2)");
        });
    ...
    public void testFillPrevCrossColumnGeoHashWidthMismatch() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "cannot fill target column of type GEOHASH(18b)");
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "source type GEOHASH(17b)");
        });
    }
    ...
    public void testFillPrevCrossColumnIntervalUnitMismatchUnreachable() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, interval(loA, hiA) kA, interval(loB, hiB) kB, first(v) fv FROM t " +
    ...
    public void testFillPrevCrossColumnKeyed() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, key, sum(val) AS s, sum(ival::DOUBLE) AS a " +
    ...
    public void testFillPrevCrossColumnNoPrevYet() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, sum(val) AS s, sum(ival::DOUBLE) AS a " +
                    "FROM x " +
    ...
    public void testFillPrevCrossColumnRejectsSymbolSource() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, k, sum(val) AS s, last(mirror) AS m " +
                    "FROM x SAMPLE BY 1h FILL(PREV, PREV(k)) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(83, "FILL(PREV(k)) is not supported on SYMBOL columns");
        });
    }
    ...
    public void testFillPrevCrossColumnStringSource() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, first(s) AS s1, first(s2) AS tag " +
    ...
    public void testFillPrevCrossColumnTimestampUnitMismatch() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(prevArgPos, "source type TIMESTAMP cannot fill target column of type TIMESTAMP_NS");
        });
    }
    ...
    public void testFillPrevCrossColumnVarcharSource() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            execute("INSERT INTO x VALUES " +
                    "('alpha', 'X', 1.0, '2024-01-01T00:00:00.000000Z')," +
                    "('beta',  'Y', 3.0, '2024-01-01T02:00:00.000000Z')");
            assertQuery("SELECT ts, first(v) AS v1, first(v2) AS tag " +
    ...
    public void testFillPrevDecimal128Keyed() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, sym, first(d) FROM x SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevDstBerlinSpringForwardDayStride() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT sum(val) s, ts FROM x " +
    ...
    public void testFillPrevGeoHash() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, first(g1), first(g2), first(g4), first(g8) " +
    ...
    public void testFillPrevGeoHashKeyed() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, city, first(g) FROM geo_weather " +
                    "SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
    ...
    public void testFillPrevGeoNoPrevYet() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, city, first(g1), first(g2), first(g4), first(g8) " +
                    "FROM t " +
                    "SAMPLE BY 1h FROM '2024-01-01T20:00:00.000000Z' TO '2024-01-02T00:00:00.000000Z' " +
    ...
    public void testFillPrevInterval() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, interval(lo, hi) k, first(v) FROM t SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevKeyedArray() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, k, first(v) FROM x SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevKeyedCte() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("WITH sq AS (SELECT ts, city, avg(temp) AS a FROM weather SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR) " +
                    "SELECT * FROM sq")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
    ...
    public void testFillPrevKeyedHighCardinalityCorrectness() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT count(*) c, sum(fv) s, min(fv) mn, max(fv) mx FROM (" +
    ...
    public void testFillPrevKeyedIndependent() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("INSERT INTO weather VALUES " +
                    ...
                    "('Paris', 21.0, '2024-01-01T01:00:00.000000Z')," +
                    "('London', 12.0, '2024-01-01T02:00:00.000000Z')");
            assertQuery("SELECT ts, city, avg(temp) FROM weather SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevLong128Fallback() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, first(val) FROM t SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(11, "there is no matching function `first` with the argument types");
        });
    }
    ...
    public void testFillPrevLong256Keyed() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, sym, sum(h) FROM x SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevLong256NoPrevYet() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, sum(h) FROM x " +
    ...
    public void testFillPrevMixedWithSymbolKeyed() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, key, sum(val), first(sym) FROM x SAMPLE BY 1h FILL(PREV, NULL) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevMultiUnitStride() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, first(val) fv FROM t SAMPLE BY 3h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevNegativeTimestamps() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, first(v) FROM t " +
    ...
    public void testFillPrevNonKeyed() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT sum(val), ts FROM x SAMPLE BY 1h FILL(PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevOffsetBindVariable() throws Exception {
        ...
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, avg(value) FROM test SAMPLE BY 1d FILL(PREV) ALIGN TO CALENDAR WITH OFFSET $1")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
    ...
    public void testFillPrevRejectBindVar() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, avg(v) FROM t SAMPLE BY 1h FILL(PREV($1)) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(43, "PREV argument must be a single column name");
        });
    }
    ...
    public void testFillPrevRejectConstantSource() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(sql.indexOf("PREV(a)"), "FILL(PREV) cannot reference a column that is itself filled with a constant");
        });
    }
    ...
    public void testFillPrevRejectFuncArg() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("INSERT INTO t VALUES " +
                    "(1.0, '2024-01-01T00:00:00.000000Z')," +
                    "(3.0, '2024-01-01T02:00:00.000000Z')");
            assertQuery("SELECT ts, sum(a) FROM t SAMPLE BY 1h FILL(PREV(abs(a))) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(43, "PREV argument must be a single column name");
        });
    }
    ...
    public void testFillPrevRejectMultiArg() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("INSERT INTO t VALUES " +
                    "(1.0, 10.0, '2024-01-01T00:00:00.000000Z')," +
                    "(3.0, 30.0, '2024-01-01T02:00:00.000000Z')");
            assertQuery("SELECT ts, sum(a) a, sum(b) b FROM t SAMPLE BY 1h FILL(PREV(a, b)) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(55, "PREV argument must be a single column name");
        });
    }
    ...
    public void testFillPrevRejectMutualChain() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("INSERT INTO t VALUES " +
                    "(1.0, 10.0, '2024-01-01T00:00:00.000000Z')," +
                    "(3.0, 30.0, '2024-01-01T02:00:00.000000Z')");
            assertQuery("SELECT ts, sum(a) a, sum(b) b FROM t SAMPLE BY 1h FILL(PREV(b), PREV(a)) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(55, "FILL(PREV) chains are not supported");
        });
    }
    ...
    public void testFillPrevRejectNoArg() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery(sql)
                    .noLeakCheck()
                    .fails(sql.indexOf("PREV("), "PREV argument must be a single column name");
        });
    }
    ...
    public void testFillPrevRejectThreeHopChain() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, sum(a) a, sum(b) b, sum(c) c FROM t SAMPLE BY 1h FILL(PREV(b), PREV(c), PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(65, "FILL(PREV) chains are not supported");
        });
    }
    ...
    public void testFillPrevRejectTimestamp() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("INSERT INTO t VALUES " +
                    "(1.0, '2024-01-01T00:00:00.000000Z')," +
                    "(3.0, '2024-01-01T02:00:00.000000Z')");
            assertQuery("SELECT ts, avg(v) FROM t SAMPLE BY 1h FILL(PREV(ts)) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(48, "PREV cannot reference the designated timestamp column");
        });
    }
    ...
    public void testFillPrevRejectTypeMismatch() throws Exception {
        assertMemoryLeak(() -> {
            ...
            execute("INSERT INTO t VALUES " +
                    "(1.0, 10, '2024-01-01T00:00:00.000000Z')," +
                    "(3.0, 30, '2024-01-01T02:00:00.000000Z')");
            assertQuery("SELECT ts, first(i) AS i, sum(d) AS d FROM t SAMPLE BY 1h FILL(PREV(d), PREV) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .fails(68, "cannot fill target column of type");
        });
    }
    ...
    public void testFillPrevSelfAlias() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, sum(a) AS a FROM t SAMPLE BY 1h FILL(PREV(a)) ALIGN TO CALENDAR")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
            ...
            for (String strategy : strategies) {
                ...
                assertMemoryLeak(() -> {
                    ...
                    execute("INSERT INTO t VALUES " +
                            ...
                            "('2024-01-01T02:00:00.000000Z', 'A', 3.0, 30.0), " +
                            "('2024-01-01T03:00:00.000000Z', 'B', 4.0, 40.0)");
                    assertQuery("SELECT ts, k, sum(a) AS a, sum(b) AS b FROM t " +
    ...
    public void testFillPrevWithCalendarOffset() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("SELECT ts, avg(value) FROM test SAMPLE BY 1d FILL(PREV) ALIGN TO CALENDAR WITH OFFSET '10:00'")
                    .noLeakCheck()
                    .timestamp("ts")
                    .noRandomAccess()
                    .returns("""
