...
public class ApproxCountDistinctLongGroupByFunctionFactoryTest extends AbstractCairoTest {
    ...
    public void testConstant() throws Exception {
        assertQuery(
                "a\tapprox_count_distinct\n" +
                        ...
                        "b\t1\n" +
                        "c\t1\n",
                "select a, approx_count_distinct(42L) from x",
    ...
    public void testExpression() throws Exception {
        ...
        assertQuery(
                expected,
                "select a, approx_count_distinct(s * 42) from x",
        ...
        assertSql(expected, "select a, approx_count_distinct(s) from x");
    }
    ...
    public void testGroupKeyed() throws Exception {
        assertQuery(
                "a\tapprox_count_distinct\n" +
                        ...
                        "d\t4\n" +
                        "b\t1\n",
                "select a, approx_count_distinct(s) from x",
    ...
    public void testNullConstant() throws Exception {
        assertQuery(
                "a\tapprox_count_distinct\n" +
                        ...
                        "b\t0\n" +
                        "c\t0\n",
                "select a, approx_count_distinct(cast(null as LONG)) from x",
                "create table x as (select * from (select rnd_symbol('a','b','c') a from long_sequence(20)))",
                null,
                true,
                true
