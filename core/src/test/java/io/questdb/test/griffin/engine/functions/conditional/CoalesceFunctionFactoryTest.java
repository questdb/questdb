...
public class CoalesceFunctionFactoryTest extends AbstractGriffinTest {
    ...
    public void testIPv4Args() throws Exception {
        assertQuery(
                "c1\tc2\ta\tb\tx\n" +
                        "54.98.173.21\t54.98.173.21\tnull\t54.98.173.21\t1.1.96.238\n" +
                        "54.132.76.40\t54.132.76.40\tnull\t54.132.76.40\t1.1.250.138\n" +
                        "3.7.4.15\t3.7.4.15\t3.7.4.15\tnull\t1.1.20.236\n" +
                        "54.62.93.114\t54.62.93.114\tnull\t54.62.93.114\t1.1.132.196\n" +
                        "3.7.4.252\t3.7.4.252\t3.7.4.252\t54.22.249.199\tnull\n",
                "select coalesce(a, b, x) c1, coalesce(a, b) c2, a, b, x\n" +
                        "from test",
