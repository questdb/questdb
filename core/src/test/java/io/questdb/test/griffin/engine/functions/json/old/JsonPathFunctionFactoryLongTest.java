...
public class JsonPathFunctionFactoryLongTest {}
...
public class JsonPathFunctionFactoryLongTest extends AbstractFunctionFactoryTest {
    ...
    public void test10000() throws SqlException {
        callFn(utf8("{\"path\": 10000}"), utf8(".path")).andAssert(10000L);
        callFn(utf8("{\"path\": 10000}"), dirUtf8(".path")).andAssert(10000L);
        callFn(dirUtf8("{\"path\": 10000}"), utf8(".path")).andAssert(10000L);
        callFn(dirUtf8("{\"path\": 10000}"), dirUtf8(".path")).andAssert(10000L);
    }

    @Test
    public void testBigNumber() throws SqlException {
        callFn(utf8("{\"path\": 100000000000000000000000000}"), utf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testDefaultDifferentType() throws SqlException {
        callFn(utf8("{\"path\": \"abc\"}"), utf8(".path"), DEFAULT_VALUE_ON_ERROR, 42L).andAssert(42L);
    }

    @Test
    public void testDefaultNullJsonValue() throws SqlException {
        callFn(utf8("{\"path\": null}"), utf8(".path"), DEFAULT_VALUE_ON_ERROR, 42L).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testDifferentType() throws SqlException {
        callFn(utf8("{\"path\": \"abc\"}"), utf8(".path")).andAssert(Long.MIN_VALUE);
        callFn(dirUtf8("{\"path\": \"abc\"}"), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testEmptyJson() throws SqlException {
        callFn(utf8("{}"), utf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testFloat() throws SqlException {
        callFn(dirUtf8("{\"path\": 123.45}"), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testInString() throws SqlException {
        callFn(utf8("{\"path\": \"123\"}"), utf8(".path")).andAssert(123L);
    }
    ...
    public void testNullJsonValue() throws SqlException {
        callFn(utf8("{\"path\": null}"), utf8(".path")).andAssert(Long.MIN_VALUE);
        callFn(utf8("{\"path\": null}"), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
        callFn(dirUtf8("{\"path\": null}"), utf8(".path")).andAssert(Long.MIN_VALUE);
        callFn(dirUtf8("{\"path\": null}"), dirUtf8(".path")).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testOne() throws SqlException {
        callFn(utf8("{\"path\": 1}"), utf8(".path")).andAssert(1L);
    }

    @Test
    public void testStrict10000() throws SqlException {
        callFn(utf8("{\"path\": 10000}"), utf8(".path"), FAIL_ON_ERROR).andAssert(10000L);
    }
    ...
    public void testStrictDefaultDifferentType() throws SqlException {
        final CairoException exc = Assert.assertThrows(
                CairoException.class,
                () -> callFn(utf8("{\"path\": \"abc\"}"), utf8(".path"), FAIL_ON_ERROR, 42L));
        TestUtils.assertContains(exc.getMessage(), "json_path(.., '.path'): INCORRECT_TYPE:");
    }

    @Test
    public void testStrictDefaultNullJsonValue() throws SqlException {
        callFn(utf8("{\"path\": null}"), utf8(".path"), FAIL_ON_ERROR, 42L).andAssert(Long.MIN_VALUE);
    }
    ...
    public void testStrictNegative() throws SqlException {
        callFn(utf8("{\"path\": -123\n}"), utf8(".path"), FAIL_ON_ERROR).andAssert(-123L);
    }

    @Test
    public void testStrictNullJson() throws SqlException {
        callFn(utf8(null), utf8(".path"), FAIL_ON_ERROR).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testStrictNullJsonValue() throws SqlException {
        callFn(utf8("{\"path\": null}"), utf8(".path"), FAIL_ON_ERROR).andAssert(Long.MIN_VALUE);
    }

    @Test
    public void testStrictOne() throws SqlException {
        callFn(utf8("{\"path\": 1}"), utf8(".path"), FAIL_ON_ERROR).andAssert(1L);
    }

    @Test
    public void testStrictOobNeg() throws SqlException {
        // -(2^63) -1: The first neg number outside the 64-bit range.
        final CairoException exc = Assert.assertThrows(
                CairoException.class,
                () -> callFn(utf8("{\"path\": -9223372036854775809\n}"), utf8(".path"), FAIL_ON_ERROR)
        );
        TestUtils.assertContains(exc.getMessage(), "json_path(.., '.path'): INCORRECT_TYPE");
    }
    ...
    public void testStrictOobPos() throws SqlException {
        // 2^63: The first pos number that is outside the 64-bit range.
        final CairoException exc = Assert.assertThrows(
                CairoException.class,
                () -> callFn(utf8("{\"path\": 9223372036854775808\n}"), utf8(".path"), FAIL_ON_ERROR)
        );
        TestUtils.assertContains(exc.getMessage(), "json_path(.., '.path'): INCORRECT_TYPE");
    }
    ...
    public void testStrictZero() throws SqlException {
        callFn(utf8("{\"path\": 0}"), utf8(".path"), FAIL_ON_ERROR).andAssert(0L);
    }

    @Test
    public void testUnsigned64Bit() throws SqlException {
        callFn(utf8("{\"path\": 9999999999999999999}"), utf8(".path")).andAssert(Long.MIN_VALUE);
    }
        ...
        assertMemoryLeak(() -> {
            assertSql(
                    "json_path\n" +
                            ...
                            "2\n" +
                            "2\n",
                    "select json_path(path, '.path', " + ColumnType.LONG + ") from x"
            );
        });
    }
    ...
    public void testZero() throws SqlException {
        callFn(utf8("{\"path\": 0}"), utf8(".path")).andAssert(0L);
    }
