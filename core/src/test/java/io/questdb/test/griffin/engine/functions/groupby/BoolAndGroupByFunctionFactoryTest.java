...
public class BoolAndGroupByFunctionFactoryTest extends AbstractCairoTest {
    ...
    public void testBoolAndAllTrue() throws Exception {
        assertQuery("select bool_and(f) from tab")
    ...
    public void testBoolAndWithGroupBy() throws Exception {
        assertQuery("select g, bool_and(f) from tab order by g")
                .ddl("create table tab as (" +
    ...
    public void testBoolAndWithExpression() throws Exception {
        ...
        assertQuery("select bool_and(x > 0) from tab")
                .ddl("create table tab as (select x - 5 as x from long_sequence(10))")
                .noRandomAccess()
                .expectSize()
                .returns("""
                        bool_and
    ...
    public void testBoolAndWithSampleBy() throws Exception {
        assertQuery("select k, bool_and(f) from tab sample by 1h")
                .ddl("create table tab as (" +
                        "select true as f, " +
    ...
    public void testBoolAndConstantTrue() throws Exception {
        ...
        assertQuery("select bool_and(true) from tab")
    ...
    public void testBoolAndConstantFalse() throws Exception {
        ...
        assertQuery("select bool_and(false) from tab")
                .ddl("create table tab as (select x from long_sequence(5))")
                .expectSize()
                .returns("""
                        bool_and
