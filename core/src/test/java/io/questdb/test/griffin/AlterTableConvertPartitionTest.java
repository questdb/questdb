...
public class AlterTableConvertPartitionTest extends AbstractCairoTest {
    ...
    public void testConvertPartitionsWithColTopsSelect() throws Exception {
        assertMemoryLeak(TestFilesFacadeImpl.INSTANCE, () -> {
            ...
            ddl("alter table " + tableName + " add column a int");
            insert("insert into " + tableName + " values(5, '2024-11-05T00:00:00.000000Z', 5)");
            insert("insert into " + tableName + " values(6, '2024-11-06T00:00:00.000000Z', 6)");
            insert("insert into " + tableName + " values(7, '2024-11-07T00:00:00.000000Z', 7)");
