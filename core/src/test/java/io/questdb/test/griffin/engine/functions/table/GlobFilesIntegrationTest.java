...
public class GlobFilesIntegrationTest extends AbstractCairoTest {
    ...
    public void testFilesOrderByDiskSizeDescLimit() throws Exception {
        assertMemoryLeak(() -> {
            assertSql(
                    ...
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') order by diskSize desc, path limit 3"
            );
        });
    }

    /**
     * Test files() with ORDER BY lastModified and LIMIT.
     * SELECT * FROM files('/root') ORDER BY lastModified LIMIT 2
     */
    @Test
    public void testFilesOrderByModifiedTimeLimit() throws Exception {
        assertMemoryLeak(() -> {
            assertSql(
                    ...
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') order by lastModified, path limit 2"
            );
        });
    }
    ...
    public void testFilesOrderByMultipleColumnsLimit() throws Exception {
        assertMemoryLeak(() -> {
            assertSql(
                    ...
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') order by diskSize, path limit 4"
            );
        });
    }
        ...
        assertMemoryLeak(() -> {
            assertSql(
                    "path\tdiskSize\tdiskSizeHuman\tlastModified\n" +
                            "data" + File.separator + "file1.parquet\t256\t256.0 B\t1970-04-26T17:46:40.256Z\n" +
                            "data" + File.separator + "file2.parquet\t256\t256.0 B\t1970-04-26T17:46:40.256Z\n",
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') order by path limit 2"
            );
        });
    }
    ...
    public void testGlobFilterCaseSensitive() throws Exception {
        assertMemoryLeak(() -> {
            assertSql(
                    "path\tdiskSize\tdiskSizeHuman\tlastModified\n",
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') where glob(path, '*.PARQUET') order by path"
            );
        });
    }
        ...
        assertMemoryLeak(() -> {
            assertSql(
                    "path\tdiskSize\tdiskSizeHuman\tlastModified\n" +
                            "test.csv\t15076\t14.7 KiB\t1970-04-26T17:46:55.076Z\n" +
                            "reports" + File.separator + "monthly_report.csv\t15076\t14.7 KiB\t1970-04-26T17:46:55.076Z\n",
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') where glob(path, '*.csv') order by path desc limit 2"
            );
        });
    }
    ...
    public void testGlobFilterSqlOnly() throws Exception {
        assertMemoryLeak(() -> {
            assertSql(
                    "path\tdiskSize\tdiskSizeHuman\tlastModified\n" +
                            "temp" + File.separator + "backup.sql\t45\t45.0 B\t1970-04-26T17:46:40.045Z\n",
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') where glob(path, '*.sql') order by path"
            );
        });
    }
        ...
        assertMemoryLeak(() -> {
            assertSql(
                    "path\tdiskSize\tdiskSizeHuman\tlastModified\n" +
                            "data" + File.separator + "file1.parquet\t256\t256.0 B\t1970-04-26T17:46:40.256Z\n" +
                            "data" + File.separator + "file2.parquet\t256\t256.0 B\t1970-04-26T17:46:40.256Z\n",
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') where glob(path, '*.parquet') order by path limit 2"
            );
        });
    }
        ...
        assertMemoryLeak(() -> {
            assertSql(
                    "path\tdiskSize\tdiskSizeHuman\tlastModified\n" +
                            ...
                            "reports" + File.separator + "monthly_report.csv\t15076\t14.7 KiB\t1970-04-26T17:46:55.076Z\n" +
                            "test.csv\t15076\t14.7 KiB\t1970-04-26T17:46:55.076Z\n",
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') where glob(path, '*.csv') order by path"
            );
        });
    }
        ...
        assertMemoryLeak(() -> {
            assertSql(
                    "path\tdiskSize\tdiskSizeHuman\tlastModified\n" +
                            ...
                            "data" + File.separator + "file2.parquet\t256\t256.0 B\t1970-04-26T17:46:40.256Z\n" +
                            "data" + File.separator + "nested" + File.separator + "deep_file.parquet\t256\t256.0 B\t1970-04-26T17:46:40.256Z\n",
                    "select path, diskSize, diskSizeHuman, lastModified from files('" + inputRoot + "') where glob(path, 'data/*') order by path limit 3"
            );
        });
    }
