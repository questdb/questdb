    ...
    public void testCastExplains() throws Exception {
        assertMemoryLeak(
                () -> {
                    ...
                    assertQuery("WITH data AS (SELECT 123L AS value) SELECT cast(value as DECIMAL(5, 2)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 123L AS value) SELECT cast(value as DECIMAL(5, 0)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("SELECT cast(1L as DECIMAL(5, 2))")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                                      functions: [1.00]
    ...
    public void testCastExplainsForDifferentDecimalTypes() throws Exception {
        assertMemoryLeak(
                () -> {
                    ...
                    assertQuery("WITH data AS (SELECT 99L AS value) SELECT cast(value as DECIMAL(2)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 9999L AS value) SELECT cast(value as DECIMAL(4)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 999999999L AS value) SELECT cast(value as DECIMAL(9)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 999999999999999999L AS value) SELECT cast(value as DECIMAL(18)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 9223372036854775807L AS value) SELECT cast(value as DECIMAL(19)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 9223372036854775807L AS value) SELECT cast(value as DECIMAL(40)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 9L AS value) SELECT cast(value as DECIMAL(2,1)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 99L AS value) SELECT cast(value as DECIMAL(4,2)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 999999L AS value) SELECT cast(value as DECIMAL(9,3)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 999999999999L AS value) SELECT cast(value as DECIMAL(18,6)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 92233720368547758L AS value) SELECT cast(value as DECIMAL(19,2)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("WITH data AS (SELECT 92233720368547758L AS value) SELECT cast(value as DECIMAL(40,10)) FROM data")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                    ...
                    assertQuery("SELECT cast(9L as DECIMAL(2,1))")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
                                      functions: [9.0]
                    ...
                    assertQuery("SELECT cast(999999L as DECIMAL(9,3))")
                            .noLeakCheck()
                            .assertsPlan("""
                                    VirtualRecord
