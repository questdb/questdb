...
public class OrderByDescRowSkippingTest extends AbstractCairoTest {
    ...
    public void test2partitionsSelectFirstN() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select l from tab order by ts desc limit 3")
                    .expectSize()
                    .returns("l\n10\n9\n8\n");
        });
    }
    ...
    public void test2partitionsSelectMiddleNfromBothDirections() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select l from tab order by ts desc limit 4,-4")
                    .expectSize()
                    .returns("l\n6\n5\n");
        });
    }
    ...
    public void test2partitionsSelectMiddleNfromEnd() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select l from tab order by ts desc limit -8,-5")
                    .expectSize()
                    .returns("l\n8\n7\n6\n");
        });
    }
    ...
    public void test2partitionsSelectMiddleNfromStart() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select l from tab order by ts desc limit 5,8")
                    .expectSize()
                    .returns("l\n5\n4\n3\n");
        });
    }
    ...
    public void test2partitionsSelectNbeforeStartReturnsEmptyResult() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertEmpty("select l from tab order by ts desc limit -11,-15");
        });
    }
    ...
    public void test2partitionsSelectNintersectingEnd() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select l from tab order by ts desc limit 8,12")
                    .expectSize()
                    .returns("l\n2\n1\n");
        });
    }
    ...
    public void test2partitionsSelectNintersectingStart() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select l from tab order by ts desc limit -12,-8")
                    .expectSize()
                    .returns("l\n10\n9\n");
        });
    }
    ...
    public void testEmptyTableSelect_allReturnsNoRows() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertEmpty("select l from tab order by ts desc");
        });
    }
    ...
    public void testNoDesignatedTsTableSelectFirstNwithSameLoHireturnsNoRows() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertEmpty("select l from tab order by ts desc limit 8,8");
        });
    }
    ...
    public void testNoDesignatedTsTableSelectNbeyondEndReturnsEmptyResult() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertEmpty("select l from tab order by ts desc limit 11,12");
        });
    }
    ...
    public void testNoDesignatedTsTableWithDuplicatesSelectMiddleNfromBothDirections() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select l from tab order by ts desc limit 9,-9")
                    .expectSize()
                    .returns("l\n6\n5\n");
        });
    }
    ...
    public void testNoDesignatedTsTableWithDuplicatesSelectNbeforeStartReturnsEmptyResult() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertEmpty("select l from tab order by ts desc limit -25,-21");
        });
    }
    ...
    public void testNoDesignatedTsTableWithDuplicatesSelectNbeyondEndReturnsEmptyResult() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertEmpty("select l from tab order by ts desc limit 21,22");
        });
    }
    ...
    public void testPartitionPerRowSelectFirstNwithDifferentCaseInOrderBy() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select record_type from trips order by created_ON desc limit 5")
                    .expectSize()
                    .returns("record_type\n10\n9\n8\n7\n6\n");
        });
    }
    ...
    public void testPartitionPerRowSelectFirstNwithDifferentCaseInSelectAndOrderBy() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select record_Type, CREATED_on from trips order by created_ON desc limit 5")
                    .noLeakCheck()
                    .ddl(null)
                    .timestampDesc("CREATED_on")
                    .expectSize()
                    .returns("record_Type\tCREATED_on\n" + DATA);
        });
    }
    ...
    public void testPartitionPerRowSelectFirstNwithDifferentCaseInSelectAndOrderByWithAliasV2() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQuery("select record_Type, CREATED_ON cre_on from trips order by created_on desc limit 5")
                    .noLeakCheck()
                    .ddl(null)
                    .timestampDesc("cre_on")
                    .expectSize()
    ...
    private RecordCursorFactory prepareFactory(TableReader reader) {
        ...
        return new PageFrameRecordCursorFactory(
                ...
                metadata,
                new FullPartitionFrameCursorFactory(reader.getTableToken(), reader.getMetadataVersion(), TableUtils.ANY_TABLE_VERSION, GenericRecordMetadata.copyOfNew(metadata), PartitionFrameCursorFactory.ORDER_DESC, null, 0, false),
