...
public class DivDecimalFunctionFactoryTest extends AbstractTest {
    ...
    public void testDivDecimal128Simple() {
        ...
        createFunctionAndAssert(args, 0, 0, 0, 30000, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 4)); // 3.0000
    }
    ...
    public void testDivDecimal128WithDifferentScales() {
        ...
        createFunctionAndAssert(args, 0, 0, 0, 4000, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 3)); // 4.000
    }
    ...
    public void testDivDecimal128WithRemainder() {
        ...
        createFunctionAndAssert(args, 0, 0, 0, 3333, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 4));
    }
    ...
    public void testDivDecimal256MaxPrecision() {
        ...
        createFunctionAndAssert(args, 0, 0, 0, 3, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 0));
    }
    ...
    public void testDivDecimal256Negative() {
        ...
        createFunctionAndAssert(args, -1, -1, -1, -5, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 0)); // -5
    }
    ...
    public void testDivDecimal256WithRounding() {
        ...
        createFunctionAndAssert(args, 0, 0, 0, 6148914691236517205L, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 0));
    }
    ...
    public void testDivDecimal8Simple() {
        ...
        createFunctionAndAssert(args, 0, 0, 0, 300, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 2)); // 3.00
    }
    ...
    public void testDivDecimal8WithDifferentScales() {
        ...
        createFunctionAndAssert(args, 0, 0, 0, 400, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 3)); // 0.400
    }
    ...
    public void testDivMixedDecimalTypes() {
        ...
        args.add(new Decimal128Constant(0, 200, ColumnType.getDecimalType(20, 2))); // 2.00
        createFunctionAndAssert(args, 0, 0, 0, 50000, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 4)); // 5.0000

        args.clear();
        args.add(new Decimal256Constant(0, 0, 0, 1200, ColumnType.getDecimalType(40, 2))); // 12.00
        args.add(new Decimal64Constant(300, ColumnType.getDecimalType(10, 2))); // 3.00
        createFunctionAndAssert(args, 0, 0, 0, 40000, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 4)); // 4.0000
    }
    ...
    public void testDivWithPrecisionScaling() {
        ...
        createFunctionAndAssert(args, 0, 0, 0, 1230, ColumnType.getDecimalType(Decimals.MAX_PRECISION, 3));
    }
