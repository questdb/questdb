...
public class PrefixedPgClassFunctionFactoryTest extends AbstractCairoTest {
    ...
    @Test
    public void testPgClassRelkindForViewKinds() throws Exception {
        // PG tooling (psql's \d, JDBC DatabaseMetaData) keys on relkind: a
        // materialized view must report 'm', views and live views 'v', and a
        // plain table 'r'.
        assertMemoryLeak(() -> {
