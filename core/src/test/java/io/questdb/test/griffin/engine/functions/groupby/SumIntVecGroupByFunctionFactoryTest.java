...
public class SumIntVecGroupByFunctionFactoryTest extends AbstractCairoTest {
    ...
    public void testAllNullThenOne() throws Exception {
        assertQuery("sum\n" +
                        "NaN\n", "select sum(f) from tab", "create table tab as (select cast(null as int) f from long_sequence(33))", null, "insert into tab select 4567866 from long_sequence(1)", "sum\n" +
                        "4567866\n", false, true, false);
    }
