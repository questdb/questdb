...
public class WorkerWakeControllerTest {
    ...
    @Test
    public void testCursorWrapsFromPartialLastWord() {
        assertCursorWrapsFromPartialLastWord(65);
        assertCursorWrapsFromPartialLastWord(129);
    }

    @Test
    public void testPreferredMissFallsBackAcrossBitmapWords() {
    ...
    @Test
    public void testWakeCursorContinuesAcrossSignedOverflow() {
    ...
    @Test
    public void testWakeOneAndSelfUnregisterReconcileCount() {
