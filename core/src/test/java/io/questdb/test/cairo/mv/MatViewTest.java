...
public class MatViewTest extends AbstractCairoTest {
    ...
    public void testAlterSymbolCapacity() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-01-01T01:01:01.842574Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\t\tvalid\t1\t1\t2024-01-01T01:01:01.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
    ...
    public void testBaseTableRename() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-10-24T17:22:09.842574Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\t\tvalid\t1\t1\t2024-10-24T17:22:09.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-10-24T18:00:00.000000Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\t[-105]: table does not exist [table=base_price]\tinvalid\t1\t-1\t2024-10-24T17:22:09.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-10-24T19:00:00.000000Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\tbase table is not a WAL table\tinvalid\t1\t-1\t2024-10-24T17:22:09.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
    ...
    public void testBaseTableSwappedWithRename() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-10-24T17:22:09.842574Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~3\t\tvalid\t1\t1\t2024-10-24T17:22:09.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-10-24T18:00:00.000000Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~3\ttable rename operation\tinvalid\t1\t1\t2024-10-24T17:22:09.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
    ...
    public void testFullRefresh() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-01-01T01:01:01.842574Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\tdrop column operation\tinvalid\t1\t2\t2024-01-01T01:01:01.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-01-01T01:01:01.842574Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\t\tvalid\t2\t2\t2024-01-01T01:01:01.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
    ...
    public void testFullRefreshDroppedBaseColumn() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-01-01T01:01:01.842574Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\t[7]: Invalid column: sym\tinvalid\t-1\t2\t2024-01-01T01:01:01.842574Z\n",
                    "materialized_views",
                    null,
                    false
            );
    ...
    public void testFullRefreshFail1() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2001-01-01T01:01:01.000000Z\tselect sym, last(price) as price, ts from base_price where npe() sample by 1h\tprice_1h~2\t[-1]: unexpected filter error\tinvalid\t-1\t1\t2001-01-01T01:01:01.000000Z\n",
                    "materialized_views",
                    null,
                    false
            );
    ...
    public void testFullRefreshFail2() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2001-01-01T01:01:01.000000Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\t\tvalid\t1\t1\t2001-01-01T01:01:01.000000Z\n",
                    "materialized_views",
                    null,
                    false
            );
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2001-01-01T01:01:01.000000Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\tdrop column operation\tinvalid\t1\t2\t2001-01-01T01:01:01.000000Z\n",
                    "materialized_views",
                    null,
                    false
            );
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2001-01-01T01:01:01.000000Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\t[17]: Invalid column: price\tinvalid\t-1\t2\t2001-01-01T01:01:01.000000Z\n",
                    "materialized_views",
                    null,
                    false
            );
    ...
    public void testTimestampGetsRefreshedOnInvalidation() throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2020-01-01T01:01:01.000000Z\tselect sym, last(price) as price, ts from base_price sample by 1d\tprice_1h~2\tbase table is dropped or renamed\tinvalid\t1\t-1\t2020-01-01T01:01:01.000000Z\n",
                    "materialized_views",
                    null,
                    false
            );
    ...
    private void testBaseTableRenameAndThenRenameBack(boolean drainWalQueue) throws Exception {
        assertMemoryLeak(() -> {
            ...
            assertQueryNoLeakCheck(
                    "view_name\trefresh_type\tbase_table_name\tlast_refresh_finished_timestamp\tview_sql\tview_table_dir_name\tinvalidation_reason\tview_status\trefresh_base_table_txn\tbase_table_txn\tlast_refresh_started_timestamp\n" +
                            "price_1h\tincremental\tbase_price\t2024-10-24T19:00:00.000000Z\tselect sym, last(price) as price, ts from base_price sample by 1h\tprice_1h~2\ttable rename operation\tinvalid\t1\t3\t2024-10-24T19:00:00.000000Z\n",
                    "materialized_views",
                    null,
                    false
            );
