...
public class TxnWaiterIntegrationTest {
    ...
    @Test
    public void testCancelledWaiterThrowsOnResume() throws InterruptedException {
    ...
    @Test
    public void testSuspendResumeDrivenBySeqTxnTrackerAdvance() throws InterruptedException {
        SeqTxnTracker tracker = new SeqTxnTracker(configuration());
        tracker.initTxns(1, 5, false);
    ...
    @Test
    public void testTxnWaiterResetAllowsRefire() {
    ...
    @Test
    public void testPooledContinuationMultiTaskSameThread() {
    ...
    @Test
    public void testDeadlineTriggersCancellation() throws InterruptedException {
        SeqTxnTracker tracker = new SeqTxnTracker(configuration());
        tracker.initTxns(1, 5, false);
    ...
    @Test
    public void testSuspendResumeDrivenBySuspendState() throws InterruptedException {
        SeqTxnTracker tracker = new SeqTxnTracker(configuration());
        tracker.initTxns(1, 5, false);
