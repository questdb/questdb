...
public class MetadataCacheTest extends AbstractCairoTest {
    private static final String xMetaStringSansHeader = """
            ...
            \t\tCairoColumn [name=b, position=4, type=BOOLEAN, isDedupKey=false, isDesignated=false, isSymbolTableStatic=true, symbolCached=false, symbolCapacity=0, isIndexed=false, isNotNull=true, indexBlockCapacity=0, parquetEncoding=Default, parquetCompression=Default, writerIndex=4]
            ...
            \t\tCairoColumn [name=f, position=8, type=SHORT, isDedupKey=false, isDesignated=false, isSymbolTableStatic=true, symbolCached=false, symbolCapacity=0, isIndexed=false, isNotNull=true, indexBlockCapacity=0, parquetEncoding=Default, parquetCompression=Default, writerIndex=8]
            ...
            \t\tCairoColumn [name=l, position=13, type=BYTE, isDedupKey=false, isDesignated=false, isSymbolTableStatic=true, symbolCached=false, symbolCapacity=0, isIndexed=false, isNotNull=true, indexBlockCapacity=0, parquetEncoding=Default, parquetCompression=Default, writerIndex=13]
