...
public class MemoryCARWSpillableTest extends AbstractCairoTest {
    ...
    public void testBinSequenceOnEdge() {
        ...
        long pageSize = 32;
        try (MemoryARW mem = new MemoryCARWSpillable(pageSize, Integer.MAX_VALUE, 5 * pageSize, Path.getThreadLocal(root))) {
    ...
    public void testBoolRnd() {
        Rnd rnd = new Rnd();
        try (MemoryARW mem = new MemoryCARWSpillable(11, Integer.MAX_VALUE, 5*11, Path.getThreadLocal(root))) {
            int n = 120;
            long o = 0;
    ...
    public void testBulkCopy() {
        int N = 1000;
        try (MemoryARW mem = new MemoryCARWSpillable(128, Integer.MAX_VALUE, 5*128, Path.getThreadLocal(root))) {
            for (int i = 0; i < N; i++) {
    ...
    public void testByte() {
        try (MemoryARW mem = new MemoryCARWSpillable(11, Integer.MAX_VALUE, 5*128, Path.getThreadLocal(root))) {
            int n = 120;
    ...
    public void testChar() {
        try (MemoryARW mem = new MemoryCARWSpillable(7, Integer.MAX_VALUE, 5*7, Path.getThreadLocal(root))) {
            char n = 999;
            long o = 0;
            for (char i = n; i > 0; i--) {
                mem.putChar(i);
    ...
    public void testDeadCodeForUtf8() {
        try (MemoryARW mem = new MemoryCARWSpillable(256, 1, 5*256, Path.getThreadLocal(root))) {
            try {
    ...
    public void testEvenPageSize() {
        try (MemoryARW mem = new MemoryCARWSpillable(32, Integer.MAX_VALUE, 5*32, Path.getThreadLocal(root))) {
            assertStrings(mem);
        }
    }
    ...
    public void testFloatCompatibility() {
        long pageSize = 64;
        try (MemoryARW mem = new MemoryCARWSpillable(pageSize, Integer.MAX_VALUE, 5*64, Path.getThreadLocal(root))) {
            mem.putFloat(1024f);
            mem.putFloat(2048f);
    ...
    public void testLong256() {
        try (MemoryARW mem = new MemoryCARWSpillable(256, Integer.MAX_VALUE, 5*256, Path.getThreadLocal(root))) {
    ...
    public void testMaxPages() {
        ...
        int maxPages = 3;
        int sz = 256 * 3;
        try (MemoryARW mem = new MemoryCARWSpillable(pageSize, maxPages, 5*pageSize, Path.getThreadLocal(root))) {
    ...
    public void testNullBin() {
        try (MemoryARW mem = new MemoryCARWSpillable(1024, Integer.MAX_VALUE, 5*1024, Path.getThreadLocal(root))) {
            testNullBin0(mem);
        }
    }
    ...
    public void testSmallEven() {
        try (MemoryARW mem = new MemoryCARWSpillable(2, Integer.MAX_VALUE, 5*2, Path.getThreadLocal(root))) {
            assertStrings(mem);
        }
    }
    ...
    public void testStableResize() {
        ...
        try (MemoryCARWSpillable mem = new MemoryCARWSpillable(pageSize, Integer.MAX_VALUE, 5*pageSize, Path.getThreadLocal(root))) {
            Assert.assertEquals(0, mem.size());
    ...
    public void testTruncate() {
        ...
        final int sz = 256 * 3;
        try (MemoryARW mem = new MemoryCARWSpillable(pageSize, maxPages, 2*pageSize, Path.getThreadLocal(root))) {
            for (int i = 0; i < sz; i++) {
    ...
    static void testBinSequence0(long mem1Size, long mem2Size) {
        ...
        try (MemoryARW mem = new MemoryCARWSpillable(mem1Size, Integer.MAX_VALUE, 5*mem1Size, Path.getThreadLocal(root))) {
            Assert.assertEquals(0, mem.size());
            ...
            try (MemoryARW mem2 = new MemoryCARWSpillable(mem2Size, Integer.MAX_VALUE, 5*mem2Size, Path.getThreadLocal(root))) {
