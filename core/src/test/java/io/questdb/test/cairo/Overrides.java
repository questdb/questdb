...
public class Overrides {
    ...
    private static void resetToDefaultTestProperties(Properties properties) {
        ...
        properties.setProperty(PropertyKey.CAIRO_PARTITION_TOP_WAL_ENABLED.getPropertyPath(), "true");
        properties.setProperty(PropertyKey.CAIRO_PARTITION_TOP_NON_WAL_ENABLED.getPropertyPath(), "true");
