...
import static io.questdb.test.cairo.wal.WalWriterTestUtils.*;
import static org.junit.Assert.*;

public class WalColFirstWriterTest extends AbstractCairoTest {
    ...
    public void testAddColumnRollsUncommittedRowsToNewSegment() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName1, 0, 1)) {
                ...
                Assert.assertEquals(WalTxnType.COL_FIRST_DATA, eventCursor.getType());

                final WalEventCursor.ColFirstDataInfo dataInfo = eventCursor.getColFirstDataInfo();
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName2, 0, 1)) {
                assertEquals(3, reader.getColumnCount());
                ...
                assertTrue(eventCursor.hasNext());
                assertEquals(0, eventCursor.getTxn());
                assertEquals(WalTxnType.COL_FIRST_DATA, eventCursor.getType());
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName1, 1, 1)) {
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName2, 1, 1)) {
                assertEquals(4, reader.getColumnCount());
                assertEquals(walName2, reader.getWalName());
                assertEquals(tableToken.getTableName(), reader.getTableName());
                assertEquals(1, reader.size());
    ...
    public void testAddingColumnClosesSegment() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalColFirstWriter walWriter = engine.getWalColFirstWriter(tableToken)) {
            ...
            TableModel model = defaultModel(tableToken.getTableName());
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 0, 1)) {
                assertEquals(3, reader.getColumnCount());
            ...
            model.col("c", ColumnType.INT);
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 1, 1)) {
                assertEquals(4, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableToken.getTableName(), reader.getTableName());
                assertEquals(1, reader.size());
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 2, 1)) {
    ...
    public void testAddingColumnOverlapping() throws Exception {
        assertMemoryLeak(() -> {
            ...
            TableModel model = defaultModel(tableToken.getTableName());
            model.col("c", ColumnType.INT);
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName1, 0, 0)) {
                assertEquals(4, reader.getColumnCount());
                assertEquals(walName1, reader.getWalName());
                assertEquals(tableToken.getTableName(), reader.getTableName());
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName2, 0, 0)) {
                assertEquals(5, reader.getColumnCount());
                assertEquals(walName2, reader.getWalName());
                assertEquals(tableToken.getTableName(), reader.getTableName());
                assertEquals(0, reader.size());
    ...
    public void testAddingDuplicateColumn() throws Exception {
        assertMemoryLeak(() -> {
            ...
            model.col("c", ColumnType.INT);
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 1, 2)) {
                assertEquals(4, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                ...
                WalEventCursor.ColFirstDataInfo dataInfo = eventCursor.getColFirstDataInfo();
                assertEquals(0, dataInfo.getStartRowID());
                assertEquals(1, dataInfo.getEndRowID());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                ...
                dataInfo = eventCursor.getColFirstDataInfo();
            ...
            try {
                TestUtils.getWalColFirstReader(configuration, tableToken, walName, 2, 1);
    ...
    @Test
    public void testCancelRowDoesNotStartNewSegment() throws Exception {
        assertMemoryLeak(() -> {
            final String tableName = testName.getMethodName();
            TableToken tableToken = createTable(testName.getMethodName());
            ...
            TableModel model = defaultModel(tableName);
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 0, 3)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
    ...
    public void testCommit() throws Exception {
        assertMemoryLeak(() -> {
            ...
            TableModel model = defaultModel(tableName);
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 0, 44)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 1, 7)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
        ...
        assertMemoryLeak(() -> {
            ...
            for (Map.Entry<Integer, AtomicInteger> counterEntry : counters.entrySet()) {
                ...
                for (int i = 0; i < count; i++) {
                    try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 2 * i, numOfRows)) {
                    ...
                    try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 2 * i + 1, 0)) {
                        assertEquals(3, reader.getRealColumnCount());
                        assertEquals(walName, reader.getWalName());
                        assertEquals(tableName, reader.getTableName());
                        assertEquals(0, reader.size());
        ...
        assertMemoryLeak(() -> {
            ...
            for (Map.Entry<Integer, AtomicInteger> counterEntry : counters.entrySet()) {
                ...
                for (int segmentId = 0; segmentId < count * numOfSegments; segmentId++) {
                    try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, segmentId, maxRowCount)) {
                        assertEquals(3, reader.getColumnCount());
                        assertEquals(walName, reader.getWalName());
                        assertEquals(tableName, reader.getTableName());
    ...
    public void testMaxLagTxnCount() throws Exception {
        // TODO set col-first wal writer here
        ...
        assertMemoryLeak(() -> {
            ...
            try {
                ...
                try (WalColFirstWriter walWriter = engine.getWalColFirstWriter(tableToken)) {
                    ...
                    assertEquals("WalColFirstWriter{name=" + walName + ", table=" + tableName + "}", walWriter.toString());
                    walWriter.commit();
                }

                try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 0, rowsToInsertTotal)) {
                    ...
                    while (cursor.hasNext()) {
                        ...
                        prepareBinPayload(pointer, i);
                        BinarySequence actualBs = record.getBin(16);
                        TestUtils.assertEquals(binSeq.of(pointer, i), actualBs, actualBs.length());
                        prepareBinPayload(pointer, i + 1);
                        actualBs = record.getBin(17);
                        TestUtils.assertEquals(binSeq.of(pointer, i + 1), actualBs, actualBs.length());
                        ...
                        assertEquals("WalColFirstRecord [recordIndex=" + i + "]", testSink.toString());
                        try {
                            cursor.getRecordB();
    ...
    public void testRemovingColumnClosesSegment() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try {
                TestUtils.getWalColFirstReader(configuration, tableToken, walName, 1, 0);
    ...
    public void testRemovingNonExistentColumn() throws Exception {
        assertMemoryLeak(() -> {
            ...
            TableModel model = defaultModel(tableName);
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 0, 2)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                assertEquals(2, reader.size());
    ...
    public void testSameWalAfterEngineCleared() throws Exception {
        assertMemoryLeak(() -> {
            ...
            TableModel model = defaultModel(tableName);
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, wal1Name, 0, 44)) {
                assertEquals(3, reader.getColumnCount());
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, wal1Name, 1, 7)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(wal1Name, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                assertEquals(7, reader.size());
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, wal2Name, 0, 34)) {
                assertEquals(3, reader.getColumnCount());
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, wal2Name, 1, 7)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(wal2Name, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                assertEquals(7, reader.size());
    ...
    public void testSymbolWal() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 0, 10L)) {
                assertEquals(5, reader.getColumnCount());
                ...
                assertEmptySymbolDiff(dataInfo.nextSymbolMapDiff(), 2);
    ...
    public void testWalEvenReaderConcurrentReadWrite() throws Exception {
        ...
        assertMemoryLeak(ff, () -> {
            ...
            WalColFirstWriter walWriter = engine.getWalColFirstWriter(tableToken);
            TableWriter.Row row = walWriter.newRow(0);
            row.putInt(0, 1);
            row.append();
    ...
    public void testWalWritersUnknownTable() throws Exception {
        assertMemoryLeak(() -> {
            ...
            tableToken = createTable(model);
            try (WalColFirstWriter ignored = engine.getWalColFirstWriter(tableToken)) {
                Assert.fail();
            } catch (CairoException e) {
    ...
    private static void assertColumnMetadata(TableModel expected, WalColFirstReader reader) {
    ...
    private static TableToken createTable(String tableName) {
    ...
    private void testDesignatedTimestampIncludesSegmentRowNumber(int[] timestampOffsets, boolean expectedOutOfOrder) throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalColFirstReader reader = TestUtils.getWalColFirstReader(configuration, tableToken, walName, 0, 3)) {
                ...
                assertEquals(0, record.getRowId());
                assertEquals(0, ((WalColFirstRecord) record).getDesignatedTimestampRowId(2));
                assertTrue(cursor.hasNext());
                assertEquals(17, record.getByte(0));
                assertNull(record.getStrA(1));
                assertEquals(ts + timestampOffsets[0], record.getTimestamp(2));
                assertEquals(1, record.getRowId());
                assertEquals(1, ((WalColFirstRecord) record).getDesignatedTimestampRowId(2));
                assertTrue(cursor.hasNext());
                assertEquals(0, record.getByte(0));
                assertNull(record.getStrA(1));
                assertEquals(ts + timestampOffsets[1], record.getTimestamp(2));
                assertEquals(2, record.getRowId());
                assertEquals(2, ((WalColFirstRecord) record).getDesignatedTimestampRowId(2));
                assertFalse(cursor.hasNext());
    ...
    private void testRolloverSegmentSize(
            int colType,
            boolean colNeedsIndex,
            long bytesPerRow,
            long additionalBytesPerTxn,
            Consumer<TableWriter.Row> valueInserter
    ) throws Exception {
        try {
            assertMemoryLeak(() -> {
                final String tableName = testName.getMethodName();
