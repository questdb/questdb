        ...
        assertMemoryLeak(() -> {
            try (Path path = new Path()) {
                ...
                try (BlockFileWriter writer = new BlockFileWriter(configuration.getFilesFacade(), configuration.getCommitMode())) {
                    ...
                    block = writer.append();
                    MatViewState.appendTs(matViewState.getLastRefreshFinishedTimestamp(), block);
                ...
                try (BlockFileReader reader = new BlockFileReader(configuration)) {
                    ...
                    assertEquals(matViewState.getLastRefreshFinishedTimestamp(), actualState.getLastRefreshTimestamp());
