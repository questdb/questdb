...
public class WalRowFirstWriterTest extends AbstractCairoTest {
    ...
    public void testAddColumnRollsUncommittedRowsToNewSegment() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstWriter walWriter1 = engine.getWalRowFirstWriter(tableToken)) {
                try (WalRowFirstWriter walWriter2 = engine.getWalRowFirstWriter(tableToken)) {
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName1, 0, 1)) {
                ...
                final WalRowFirstCursor cursor = reader.getCursor();
                final WalRowFirstRecord record = cursor.getRecord();
                assertTrue(cursor.hasNext());
                assertEquals(1, record.getByte(0));
                assertFalse(record.hasColumnValue(3));
                ...
                Assert.assertEquals(WalTxnType.ROW_FIRST_DATA, eventCursor.getType());

                final WalEventCursor.RowFirstDataInfo dataInfo = eventCursor.getRowFirstDataInfo();
                assertEquals(0, dataInfo.getStartRowID());
                assertEquals(1, dataInfo.getEndRowID());
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(29, dataInfo.getEndOffset());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName2, 0, 1)) {
                assertEquals(3, reader.getColumnCount());
                ...
                assertTrue(eventCursor.hasNext());
                assertEquals(0, eventCursor.getTxn());
                assertEquals(WalTxnType.ROW_FIRST_DATA, eventCursor.getType());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName1, 1, 1)) {
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName2, 1, 1)) {
                assertEquals(4, reader.getColumnCount());
                assertEquals(walName2, reader.getWalName());
                assertEquals(tableToken.getTableName(), reader.getTableName());
                assertEquals(1, reader.size());
    ...
    public void testAddingColumnClosesSegment() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstWriter walWriter = engine.getWalRowFirstWriter(tableToken)) {
            ...
            TableModel model = defaultModel(tableToken.getTableName());
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, 1)) {
                assertEquals(3, reader.getColumnCount());
            ...
            model.col("c", ColumnType.INT);
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 1, 1)) {
                assertEquals(4, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableToken.getTableName(), reader.getTableName());
                assertEquals(1, reader.size());
                ...
                assertTrue(cursor.hasNext());
                assertEquals(10, record.getByte(0));
                assertFalse(record.hasColumnValue(1));
                assertEquals(42, record.getInt(3));
                assertEquals(0, record.getRowId());
                assertFalse(cursor.hasNext());
                ...
                assertEquals(1, dataInfo.getEndRowID());
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(37, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 2, 1)) {
                ...
                assertEquals(1, dataInfo.getEndRowID());
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(35, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
    ...
    public void testAddingColumnOverlapping() throws Exception {
        assertMemoryLeak(() -> {
            ...
            TableModel model = defaultModel(tableToken.getTableName());
            model.col("c", ColumnType.INT);
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName1, 0, 0)) {
                assertEquals(4, reader.getColumnCount());
                assertEquals(walName1, reader.getWalName());
                assertEquals(tableToken.getTableName(), reader.getTableName());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName2, 0, 0)) {
                assertEquals(5, reader.getColumnCount());
                assertEquals(walName2, reader.getWalName());
                assertEquals(tableToken.getTableName(), reader.getTableName());
                assertEquals(0, reader.size());
    ...
    public void testAddingColumnOverlappingAndAddRow() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName1, 0, 1)) {
                ...
                assertTrue(cursor.hasNext());
                assertEquals(1, record.getByte(0));
                TestUtils.assertEquals("foobar", record.getStrA(1));
                assertEquals(0, record.getRowId());
                assertFalse(cursor.hasNext());
                ...
                assertEquals(1, dataInfo.getEndRowID());
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(49, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
    ...
    public void testAddingDuplicateColumn() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, 1)) {
                ...
                assertTrue(cursor.hasNext());
                assertEquals(1, record.getByte(0));
                TestUtils.assertEquals("фубар", record.getStrA(1));
                assertEquals(0, record.getRowId());
                assertFalse(cursor.hasNext());
                ...
                assertEquals(1, dataInfo.getEndRowID());
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(47, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
            ...
            model.col("c", ColumnType.INT);
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 1, 2)) {
                assertEquals(4, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                ...
                assertEquals(10, record.getByte(0));
                assertFalse(record.hasColumnValue(1));
                assertEquals(1, record.getInt(3));
                assertEquals(0, record.getRowId());
                assertTrue(cursor.hasNext());
                assertEquals(100, record.getByte(0));
                assertFalse(record.hasColumnValue(1));
                assertEquals(2, record.getInt(3));
                ...
                dataInfo = eventCursor.getRowFirstDataInfo();
                assertEquals(1, dataInfo.getStartRowID());
                assertEquals(2, dataInfo.getEndRowID());
                assertEquals(37, dataInfo.getStartOffset());
                assertEquals(74, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
            ...
            try {
                TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 2, 1);
    ...
    public void testCancelRowDoesNotStartNewSegment() throws Exception {
        assertMemoryLeak(() -> {
            ...
            TableModel model = defaultModel(tableName);
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, 3)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
            ...
            try (Path path = new Path().of(configuration.getRoot())) {
                ...
                assertWalFileExist(path, tableToken, walName, 0, TableUtils.WAL_SEGMENT_FILE_NAME);
            }
        });
    }
    ...
    public void testCommit() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstWriter walWriter = engine.getWalRowFirstWriter(tableToken)) {
                ...
                walWriter.commit();
                walWriter.commit(); // should not create new txn, this is no-op
                walWriter.commit(); // should not create new txn, this is no-op
                for (int i = 0; i < 20; i++) {
                    TableWriter.Row row = walWriter.newRow(0);
                    row.putByte(0, (byte) i);
            ...
            TableModel model = defaultModel(tableName);
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, 44)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                ...
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(522, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
                ...
                assertEquals(522, dataInfo.getStartOffset());
                assertEquals(696, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
                ...
                assertEquals(696, dataInfo.getStartOffset());
                assertEquals(1276, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 1, 7)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                ...
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(203, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
        ...
        assertMemoryLeak(() -> {
            ...
            for (Map.Entry<Integer, AtomicInteger> counterEntry : counters.entrySet()) {
                ...
                for (int i = 0; i < count; i++) {
                    try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 2 * i, numOfRows)) {
                        ...
                        assertEquals(0, dataInfo.getStartOffset());
                        assertEquals(519, dataInfo.getEndOffset());
                        assertEquals(0, dataInfo.getMinTimestamp());
                        assertEquals(0, dataInfo.getMaxTimestamp());
                        assertFalse(dataInfo.isOutOfOrder());
                    ...
                    try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 2 * i + 1, 0)) {
                        assertEquals(3, reader.getRealColumnCount());
                        assertEquals(walName, reader.getWalName());
                        assertEquals(tableName, reader.getTableName());
                        assertEquals(0, reader.size());
                    ...
                    try (Path path = new Path().of(configuration.getRoot())) {
                        ...
                        assertWalFileExist(path, tableToken, walName, 1, TableUtils.WAL_SEGMENT_FILE_NAME);
                    }
                }
            }
        ...
        assertMemoryLeak(() -> {
            ...
            for (Map.Entry<Integer, AtomicInteger> counterEntry : counters.entrySet()) {
                ...
                for (int segmentId = 0; segmentId < count * numOfSegments; segmentId++) {
                    try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, segmentId, maxRowCount)) {
                        assertEquals(3, reader.getColumnCount());
                        assertEquals(walName, reader.getWalName());
                        assertEquals(tableName, reader.getTableName());
                        ...
                        assertEquals(0, dataInfo.getStartOffset());
                        assertEquals(20000, dataInfo.getEndOffset());
                        assertEquals(0, dataInfo.getMinTimestamp());
                        assertEquals(0, dataInfo.getMaxTimestamp());
                        assertFalse(dataInfo.isOutOfOrder());
                    ...
                    try (Path path = new Path().of(configuration.getRoot())) {
                        ...
                        assertWalFileExist(path, tableToken, walName, segmentId, TableUtils.WAL_SEGMENT_FILE_NAME);
                    }
                }
            }
    ...
    public void testLargeSegmentRollover() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstWriter walWriter = engine.getWalRowFirstWriter(tableToken)) {
                final WalWriterTestUtils.RowInserter ins = new WalWriterTestUtils.RowInserter() {
                    private long count;
        ...
        assertMemoryLeak(() -> {
            ...
            try {
                ...
                try (WalRowFirstWriter walWriter = engine.getWalRowFirstWriter(tableToken)) {
                    ...
                    assertEquals("WalRowFirstWriter{name=" + walName + ", table=" + tableName + "}", walWriter.toString());
                    walWriter.commit();
                }

                try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, rowsToInsertTotal)) {
                    ...
                    while (cursor.hasNext()) {
                        ...
                        assertEquals("WalRowFirstRecord [rowIndex=" + i + "]", testSink.toString());
                        try {
                            cursor.getRecordB();
    ...
    public void testRemovingColumnClosesSegment() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try {
                TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 1, 0);
    ...
    public void testRemovingNonExistentColumn() throws Exception {
        assertMemoryLeak(() -> {
            ...
            TableModel model = defaultModel(tableName);
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, 2)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(walName, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                assertEquals(2, reader.size());
                ...
                assertEquals(1, dataInfo.getStartRowID());
                assertEquals(2, dataInfo.getEndRowID());
                assertEquals(29, dataInfo.getStartOffset());
                assertEquals(58, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
    ...
    public void testRemovingSymbolColumn() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, 1)) {
                ...
                assertEquals(1, dataInfo.getEndRowID());
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(48, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 1, 1)) {
                ...
                assertEquals(1, dataInfo.getEndRowID());
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(40, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                SymbolMapDiff symbolMapDiff = dataInfo.nextSymbolMapDiff();
    ...
    public void testRolloverSegmentSizeInt() throws Exception {
        // Size of all columns per row: 8 bytes for column indexes, 4 bytes for row delimiter, 4 bytes for INT, 16 bytes for timestamp (8 bytes index + 8 bytes timestamp).
        final long bytesPerRow = 8 + 4 + 4 + 16;
        final AtomicInteger value = new AtomicInteger();
        testRolloverSegmentSize(ColumnType.INT, bytesPerRow, 0, (row) -> row.putInt(0, value.getAndIncrement()));
    }
    ...
    public void testRolloverSegmentSizeStr() throws Exception {
        ...
        //   * 8 bytes for column indexes.
        //   * 4 bytes for row delimiter.
        //   * 4 bytes for the string header.
        //   * 6 bytes string payload (because utf-16).
        //   * 16 bytes for timestamp (8 bytes index + 8 bytes timestamp).
        final long bytesPerRow = 8 + 4 + 4 + 6 + 16;
        final AtomicInteger value = new AtomicInteger();
        testRolloverSegmentSize(ColumnType.STRING, bytesPerRow, 0, (row) -> {
    ...
    public void testRolloverSegmentSizeSymbol() throws Exception {
        ...
        final AtomicInteger value = new AtomicInteger();
        testRolloverSegmentSize(ColumnType.SYMBOL, bytesPerRow, additionalBytesPerTxn, (row) -> {
            final String formatted = String.format("%03d", value.getAndIncrement());
    ...
    public void testSameWalAfterEngineCleared() throws Exception {
        assertMemoryLeak(() -> {
            ...
            TableModel model = defaultModel(tableName);
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, wal1Name, 0, 44)) {
                assertEquals(3, reader.getColumnCount());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, wal1Name, 1, 7)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(wal1Name, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                assertEquals(7, reader.size());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, wal2Name, 0, 34)) {
                assertEquals(3, reader.getColumnCount());
                ...
                assertEquals(696, dataInfo.getStartOffset());
                assertEquals(986, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
                assertNull(dataInfo.nextSymbolMapDiff());
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, wal2Name, 1, 7)) {
                assertEquals(3, reader.getColumnCount());
                assertEquals(wal2Name, reader.getWalName());
                assertEquals(tableName, reader.getTableName());
                assertEquals(7, reader.size());
    ...
    public void testSymbolWal() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, 10L)) {
                assertEquals(5, reader.getColumnCount());
                ...
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(530, dataInfo.getEndOffset());
                assertEquals(0, dataInfo.getMinTimestamp());
                assertEquals(0, dataInfo.getMaxTimestamp());
                assertFalse(dataInfo.isOutOfOrder());
    ...
    public void testWalEvenReaderConcurrentReadWrite() throws Exception {
        ...
        assertMemoryLeak(ff, () -> {
            ...
            WalRowFirstWriter walWriter = engine.getWalRowFirstWriter(tableToken);
            TableWriter.Row row = walWriter.newRow(0);
            row.putInt(0, 1);
            row.append();
    ...
    public void testWalWritersUnknownTable() throws Exception {
        assertMemoryLeak(() -> {
            ...
            tableToken = createTable(model);
            try (WalRowFirstWriter ignored = engine.getWalRowFirstWriter(tableToken)) {
                Assert.fail();
            } catch (CairoException e) {
                TestUtils.assertContains(e.getFlyweightMessage(), "table is dropped");
    ...
    private void assertColumnMetadata(TableModel expected, WalRowFirstReader reader) {
    ...
    private void testDesignatedTimestampIncludesSegmentRowNumber(int[] timestampOffsets, boolean expectedOutOfOrder) throws Exception {
        assertMemoryLeak(() -> {
            ...
            try (WalRowFirstReader reader = TestUtils.getWalRowFirstReader(configuration, tableToken, walName, 0, 3)) {
                ...
                assertEquals(0, record.getRowId());
                assertEquals(0, record.getDesignatedTimestampRowId(2));
                assertTrue(cursor.hasNext());
                assertEquals(17, record.getByte(0));
                assertFalse(record.hasColumnValue(1));
                assertEquals(ts + timestampOffsets[0], record.getTimestamp(2));
                assertEquals(1, record.getRowId());
                assertEquals(1, record.getDesignatedTimestampRowId(2));
                assertTrue(cursor.hasNext());
                assertFalse(record.hasColumnValue(0));
                assertFalse(record.hasColumnValue(1));
                assertEquals(ts + timestampOffsets[1], record.getTimestamp(2));
                assertEquals(2, record.getRowId());
                assertEquals(2, record.getDesignatedTimestampRowId(2));
                assertFalse(cursor.hasNext());
                ...
                assertEquals(0, dataInfo.getStartOffset());
                assertEquals(82, dataInfo.getEndOffset());
