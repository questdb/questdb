...
public class GeoHashesTest {
    ...
    public void testGeoHashTypeName() {
        String expected = "GEOHASH(1b) -> 16842766 (1)\n" +
                "GEOHASH(2b) -> 16908302 (2)\n" +
                "GEOHASH(3b) -> 16973838 (3)\n" +
                "GEOHASH(4b) -> 17039374 (4)\n" +
                "GEOHASH(1c) -> 17104910 (5)\n" +
                "GEOHASH(6b) -> 17170446 (6)\n" +
                "GEOHASH(7b) -> 17235982 (7)\n" +
                "GEOHASH(8b) -> 17301519 (8)\n" +
                "GEOHASH(9b) -> 17367055 (9)\n" +
                "GEOHASH(2c) -> 17432591 (10)\n" +
                "GEOHASH(11b) -> 17498127 (11)\n" +
                "GEOHASH(12b) -> 17563663 (12)\n" +
                "GEOHASH(13b) -> 17629199 (13)\n" +
                "GEOHASH(14b) -> 17694735 (14)\n" +
                "GEOHASH(3c) -> 17760271 (15)\n" +
                "GEOHASH(16b) -> 17825808 (16)\n" +
                "GEOHASH(17b) -> 17891344 (17)\n" +
                "GEOHASH(18b) -> 17956880 (18)\n" +
                "GEOHASH(19b) -> 18022416 (19)\n" +
                "GEOHASH(4c) -> 18087952 (20)\n" +
                "GEOHASH(21b) -> 18153488 (21)\n" +
                "GEOHASH(22b) -> 18219024 (22)\n" +
                "GEOHASH(23b) -> 18284560 (23)\n" +
                "GEOHASH(24b) -> 18350096 (24)\n" +
                "GEOHASH(5c) -> 18415632 (25)\n" +
                "GEOHASH(26b) -> 18481168 (26)\n" +
                "GEOHASH(27b) -> 18546704 (27)\n" +
                "GEOHASH(28b) -> 18612240 (28)\n" +
                "GEOHASH(29b) -> 18677776 (29)\n" +
                "GEOHASH(6c) -> 18743312 (30)\n" +
                "GEOHASH(31b) -> 18808848 (31)\n" +
                "GEOHASH(32b) -> 18874385 (32)\n" +
                "GEOHASH(33b) -> 18939921 (33)\n" +
                "GEOHASH(34b) -> 19005457 (34)\n" +
                "GEOHASH(7c) -> 19070993 (35)\n" +
                "GEOHASH(36b) -> 19136529 (36)\n" +
                "GEOHASH(37b) -> 19202065 (37)\n" +
                "GEOHASH(38b) -> 19267601 (38)\n" +
                "GEOHASH(39b) -> 19333137 (39)\n" +
                "GEOHASH(8c) -> 19398673 (40)\n" +
                "GEOHASH(41b) -> 19464209 (41)\n" +
                "GEOHASH(42b) -> 19529745 (42)\n" +
                "GEOHASH(43b) -> 19595281 (43)\n" +
                "GEOHASH(44b) -> 19660817 (44)\n" +
                "GEOHASH(9c) -> 19726353 (45)\n" +
                "GEOHASH(46b) -> 19791889 (46)\n" +
                "GEOHASH(47b) -> 19857425 (47)\n" +
                "GEOHASH(48b) -> 19922961 (48)\n" +
                "GEOHASH(49b) -> 19988497 (49)\n" +
                "GEOHASH(10c) -> 20054033 (50)\n" +
                "GEOHASH(51b) -> 20119569 (51)\n" +
                "GEOHASH(52b) -> 20185105 (52)\n" +
                "GEOHASH(53b) -> 20250641 (53)\n" +
                "GEOHASH(54b) -> 20316177 (54)\n" +
                "GEOHASH(11c) -> 20381713 (55)\n" +
                "GEOHASH(56b) -> 20447249 (56)\n" +
                "GEOHASH(57b) -> 20512785 (57)\n" +
                "GEOHASH(58b) -> 20578321 (58)\n" +
                "GEOHASH(59b) -> 20643857 (59)\n" +
                "GEOHASH(12c) -> 20709393 (60)\n";
