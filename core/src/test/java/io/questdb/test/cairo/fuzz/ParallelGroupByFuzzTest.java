    ...
    public void testParallelGroupByArrayFirst() throws Exception {
        ...
        testParallelGroupByArray(
                "SELECT first(darr), key FROM tab order by key", "first\tkey\n" +
                        "[[null],[null],[0.9687423276940171]]\tk0\n" +
                        "[[0.12966659791573354]]\tk1\n" +
                        "[[0.20447441837877756,null,null],[null,0.9856290845874263,null],[0.5093827001617407,0.11427984775756228,0.5243722859289777]]\tk2\n" +
                        "[[0.7261136209823622,0.4224356661645131],[null,0.3100545983862456],[0.1985581797355932,0.33608255572515877]]\tk3\n" +
                        "[[0.021651819007252326,null,null],[0.15786635599554755,null,null]]\tk4\n"
        );
    }
