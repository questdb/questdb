    ...
    public void testParallelGroupByArrayFirst() throws Exception {
        ...
        testParallelGroupByArray(
                "SELECT first(darr), key FROM tab order by key", "first\tkey\n" +
                        "[[NaN,NaN,NaN],[NaN,0.7883065830055033,NaN]]\tk0\n" +
                        "[[NaN,0.20447441837877756],[NaN,NaN]]\tk1\n" +
                        "[[0.3491070363730514,0.7611029514995744],[0.4217768841969397,NaN],[0.7261136209823622,0.4224356661645131]]\tk2\n" +
                        "[[NaN,0.33608255572515877],[0.690540444367637,NaN]]\tk3\n" +
                        "[[NaN,NaN],[0.12503042190293423,NaN]]\tk4\n"
        );
    }
