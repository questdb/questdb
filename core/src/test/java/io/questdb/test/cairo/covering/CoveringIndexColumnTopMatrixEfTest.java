...
/**
 * The column-top matrix over the ef row-id encoding, i.e. POSTING_EF. It matters most for
 ...
 */
public class CoveringIndexColumnTopMatrixEfTest extends CoveringIndexColumnTopMatrixTest {
    @BeforeClass
