...
public class CairoEngineCompleteInitTest extends AbstractCairoTest {
    ...
    @Test
    public void testBackCompatCtorRunsCompleteInit() {
    ...
    @Test
    public void testCompleteInitPopulatesFields() {
    ...
    @Test
    public void testCtorWithCompleteInitFalseLeavesFieldsNull() {
        try (CairoEngine e = new CairoEngine(configuration, false)) {
    ...
    @Test
    public void testDataIdOpenInBothCtors() {
