...
public class CharSequenceSortedListTest {
    ...
    public void testCopy() {
        ...
        assertEquals(listCopy.get(0), listUnderTest.get(0));
        assertEquals(listCopy.get(1), listUnderTest.get(1));
        assertEquals(listCopy.get(2), listUnderTest.get(2));
        assertEquals(listCopy.get(3), listUnderTest.get(3));
        assertEquals(listCopy.get(4), listUnderTest.get(4));
        assertEquals(listCopy.get(5), listUnderTest.get(5));
        assertEquals(listCopy.get(6), listUnderTest.get(6));
        assertEquals(listCopy.get(7), listUnderTest.get(7));
