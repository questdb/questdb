...
public class TimestampsTest {
    ...
    public void testAddDaysPrevEpoch() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("1888-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.addDays(micros, 24));
        TestUtils.assertEquals("1888-06-05T23:45:51.045Z", sink);
    }

    @Test
    public void testAddMonths() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2008-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.addMonths(micros, -10));
    ...
    public void testAddYears() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("1988-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.addYears(micros, 10));
        TestUtils.assertEquals("1998-05-12T23:45:51.045Z", sink);
    }

    @Test
    public void testAddYears3() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2014-01-01T00:00:00.000Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.addYears(micros, 1));
        TestUtils.assertEquals("2015-01-01T00:00:00.000Z", sink);
    }

    @Test
    public void testAddYearsNonLeapToLeap() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2015-01-01T00:00:00.000Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.addYears(micros, 1));
    ...
    public void testCeilDD() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2008-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.ceilDD(micros));
    ...
    public void testCeilHH() throws Exception {
        final long micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.789Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.ceilHH(micros));
    ...
    public void testCeilMI() throws Exception {
        ...
        MicrosFormatUtils.appendDateTime(sink, Timestamps.ceilMI(micros));
    ...
    public void testCeilMM() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2008-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.ceilMM(micros));
    ...
    public void testCeilMS() throws Exception {
        final long micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.108872Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.ceilMS(micros));
    ...
    public void testCeilSS() throws Exception {
        final long micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.789Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.ceilSS(micros));
        TestUtils.assertEquals("2021-09-09T22:44:57.000Z", sink);
    }

    @Test
    public void testCeilWW() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2024-01-02T23:59:59.999Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.ceilWW(micros));
    ...
    public void testCeilYYYY() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2008-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.ceilYYYY(micros));
    ...
    public void testFloorDD() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2008-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorDD(micros));
    ...
    public void testFloorHH() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2008-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorHH(micros));
        TestUtils.assertEquals("2008-05-12T23:00:00.000Z", sink);
    }

    @Test
    public void testFloorMI() throws Exception {
        final long micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.784123Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMI(micros));
    ...
    public void testFloorMM() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2008-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMM(micros));
    ...
    public void testFloorMMEpoch() throws Exception {
        sink.clear();
        long micros = MicrosFormatUtils.parseTimestamp("1970-10-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMM(micros, 3));
        TestUtils.assertEquals("1970-09-01T00:00:00.000Z", sink);
        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("1970-02-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMM(micros, 3));
        TestUtils.assertEquals("1970-01-01T00:00:00.000Z", sink);
        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("1969-11-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMM(micros, 3));
        TestUtils.assertEquals("1970-01-01T00:00:00.000Z", sink);
        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("1969-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMM(micros, 3));
    ...
    public void testFloorMS() throws Exception {
        final long micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.784123Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMS(micros));
    ...
    public void testFloorSS() throws Exception {
        final long micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.789Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorSS(micros));
        TestUtils.assertEquals("2021-09-09T22:44:56.000Z", sink);
    }

    @Test
    public void testFloorWW() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2025-01-02T23:59:59.999Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorWW(micros));
    ...
    public void testFloorWithStride() throws Exception {
        ...
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorWW(micros, 2));
        ...
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorDD(micros, 12));
        TestUtils.assertEquals("2021-09-06T00:00:00.000Z", sink);

        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.784123Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorHH(micros, 5));
        TestUtils.assertEquals("2021-09-09T19:00:00.000Z", sink);

        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.784123Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMI(micros, 73));
        TestUtils.assertEquals("2021-09-09T22:18:00.000Z", sink);

        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.789Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorSS(micros, 40));
        TestUtils.assertEquals("2021-09-09T22:44:40.000Z", sink);

        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("2021-09-09T22:44:56.784123Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorMS(micros, 225));
    ...
    public void testFloorYYYY() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("2008-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorYYYY(micros));
        TestUtils.assertEquals("2008-01-01T00:00:00.000Z", sink);
    }

    @Test
    public void testFloorYYYYEpoch() throws Exception {
        long micros = MicrosFormatUtils.parseTimestamp("1975-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorYYYY(micros, 3));
        TestUtils.assertEquals("1973-01-01T00:00:00.000Z", sink);

        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("1975-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorYYYY(micros, 3));
        TestUtils.assertEquals("1973-01-01T00:00:00.000Z", sink);

        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("1970-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorYYYY(micros, 3));
        TestUtils.assertEquals("1970-01-01T00:00:00.000Z", sink);

        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("1968-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorYYYY(micros, 3));
        TestUtils.assertEquals("1970-01-01T00:00:00.000Z", sink);

        sink.clear();
        micros = MicrosFormatUtils.parseTimestamp("1967-05-12T23:45:51.045Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.floorYYYY(micros, 3));
    ...
    public void testNExtOrSameDow3() throws Exception {
        // thursday
        long micros = MicrosFormatUtils.parseTimestamp("2017-04-06T00:00:00.000Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.nextOrSameDayOfWeek(micros, 4));
    ...
    public void testNextDSTFixed() throws NumericException {
        ...
        final long ts = rules.getNextDST(MicrosFormatUtils.parseUTCTimestamp("2021-02-10T01:00:00.000000Z"));
    ...
    public void testNextDSTHistory() throws NumericException {
        ...
        final long ts = rules.getNextDST(MicrosFormatUtils.parseUTCTimestamp("1991-09-20T01:00:00.000000Z"));
    ...
    public void testNextDSTHistoryLast() throws NumericException {
        ...
        final long ts = rules.getNextDST(MicrosFormatUtils.parseUTCTimestamp("1997-10-26T01:00:00.000000Z"));
    ...
    public void testNextDSTRulesAfterFirst() throws NumericException {
        ...
        final long ts = rules.getNextDST(MicrosFormatUtils.parseUTCTimestamp("2021-07-03T01:00:00.000000Z"));
    ...
    public void testNextDSTRulesAfterLast() throws NumericException {
        ...
        final long ts = rules.getNextDST(MicrosFormatUtils.parseUTCTimestamp("2021-10-31T01:00:00.000000Z"));
    ...
    public void testNextOrSameDow1() throws Exception {
        // thursday
        long micros = MicrosFormatUtils.parseTimestamp("2017-04-06T00:00:00.000Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.nextOrSameDayOfWeek(micros, 3));
    ...
    public void testNextOrSameDow2() throws Exception {
        // thursday
        long micros = MicrosFormatUtils.parseTimestamp("2017-04-06T00:00:00.000Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.nextOrSameDayOfWeek(micros, 6));
    ...
    public void testParseTimestampNotNullLocale() {
        try {
            ...
            MicrosFormatUtils.parseUTCTimestamp("2020-01-10T15:00:01.000143Zz");
            Assert.fail();
    ...
    public void testPreviousOrSameDow1() throws Exception {
        // thursday
        long micros = MicrosFormatUtils.parseTimestamp("2017-04-06T00:00:00.000Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.previousOrSameDayOfWeek(micros, 3));
    ...
    public void testPreviousOrSameDow2() throws Exception {
        // thursday
        long micros = MicrosFormatUtils.parseTimestamp("2017-04-06T00:00:00.000Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.previousOrSameDayOfWeek(micros, 6));
    ...
    public void testPreviousOrSameDow3() throws Exception {
        // thursday
        long micros = MicrosFormatUtils.parseTimestamp("2017-04-06T00:00:00.000Z");
        MicrosFormatUtils.appendDateTime(sink, Timestamps.previousOrSameDayOfWeek(micros, 4));
        TestUtils.assertEquals("2017-04-06T00:00:00.000Z", sink);
    }
