    ...
    public void testOverflow() {
        ...
        try (Path p = new Path()) {
            TestUtils.assertEquals(
                    "" + FileSystems.getDefault().getSeparator() + "xyz",
                    p.of(b).concat("xyz").$()
            );
