...
fn encode_int32_dispatch(
    ...
    match (encoding, column_tag) {
        ...
        (Encoding::RleDictionary, Byte) => {
            if pt.field_info.repetition == Repetition::Required {
                rle_dictionary::encode_int_notnull::<i8, i32, false>(
                    columns,
                    first_partition_start,
                    last_partition_end,
                    pt,
                ...
                rle_dictionary::encode_int_nullable::<i8, i32, false>(
                    columns,
                    first_partition_start,
                    last_partition_end,
                    pt,
        ...
        (Encoding::RleDictionary, Short) => {
            if pt.field_info.repetition == Repetition::Required {
                rle_dictionary::encode_int_notnull::<i16, i32, false>(
                    columns,
                    first_partition_start,
                    last_partition_end,
                    pt,
                ...
                rle_dictionary::encode_int_nullable::<i16, i32, false>(
                    columns,
                    first_partition_start,
                    last_partition_end,
                    pt,
        ...
        (Encoding::RleDictionary, Char) => {
            if pt.field_info.repetition == Repetition::Required {
                rle_dictionary::encode_int_notnull::<u16, i32, false>(
                    columns,
                    first_partition_start,
                    last_partition_end,
                    pt,
                ...
                rle_dictionary::encode_int_nullable::<u16, i32, false>(
                    columns,
                    first_partition_start,
                    last_partition_end,
                    pt,
